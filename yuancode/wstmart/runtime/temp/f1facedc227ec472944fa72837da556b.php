      ...
      <div class='intro'>
          ...
          <div class='summary'>
             ...
             <div class='item'>
               ...
               <div class='dd'>
		        <?php $__FOR_START_25435__=0;$__FOR_END_25435__=$goods['scores']['totalScores'];for($i=$__FOR_START_25435__;$i < $__FOR_END_25435__;$i+=1){ ?>
					<img src="__STATIC__/plugins/raty/img/star-on.png">
				<?php } $__FOR_START_6208__=1;$__FOR_END_6208__=6-$goods['scores']['totalScores'];for($i=$__FOR_START_6208__;$i < $__FOR_END_6208__;$i+=1){ ?>
