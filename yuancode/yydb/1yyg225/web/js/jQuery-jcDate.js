...
;(function($){
	$.fn.jcDate = function(options) {
		...
		return this.each(function() {
			if($("#jcDate").length == 0){
				$("body").prepend("<div id='jcDate'><input type='hidden' value='' id='dateHideText' /><div id='jcDateTt'><a id='d_prev'></a><div><span></span><b>年</b><samp></samp><b>月</b></div><a id='d_next'></a></div><dl id='jcYeas'></dl><dl id='jcMonth'></dl><div id='jcDayWrap'><dl id='jcDayCon'></dl><div id='jcDateMax'><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul></div><div id='jcDateBtn'><div id='jcTimeWrap'><input type='text' value='' /><label>:</label><input type='text' value='' /></div></div></div></div>");
			};
			...
			function submitDate(){
				...
				//$("img.dateVisited").prev("input.xfjl1").val(dateInfo);
				closeDate();
			};
			...
			function closeDate(){
				$("img.dateVisited").removeClass("dateVisited");
