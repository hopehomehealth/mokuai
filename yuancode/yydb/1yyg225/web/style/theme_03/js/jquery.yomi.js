...
$.fn.yomi=function(){
	...
	createdom =function(dom){
		...
		$(_DOM).append("<div class='yomi'><p class='yomiday'></p><span class='y_day'>:</span><p class='yomihour'></p><span class='y_hour'>:</span><p class='yomimin'></p><span class='y_min'>:</span><p class='yomisec'></p></div>")
		reflash();
