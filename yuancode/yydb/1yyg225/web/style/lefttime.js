...
function clock(key,type,skin)
{
    ...
    if(skin==1){
        ...
        if(DifferDay) sTime += "<b>"+DifferDay+"</b><h>天</h>";
        if(DifferHour) sTime += "<b>"+DifferHour+"</b><h>时</h>";
        if(DifferSecond) sTime += "<b>"+DifferSecond+"</b><h>分</h>";
        sTime += "<b>"+DifferMinute+"</b><h>秒</h>";
    }
