...
function onload_leftTime_jx(key,diff_time,skin){
    ...
    /*if(diff_time>60){
    	//间隔1分钟重新刷新时间
        timeID_t_jx[key] = window.setInterval(function(){$.get('/yunbuy/getLeftTime/'+key,'',function(data){
            diff_time = data;
