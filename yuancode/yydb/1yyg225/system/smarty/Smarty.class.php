...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function display($page, $cache_id = null, $compile_id = null, $parent = null) {
        ...
        if(!$this->templateExists($page)){
            //非默认模板不存在时调取默认模板
            if(defined('CUR_SKIN') && CUR_SKIN != 'cn'){
                $this->setTemplateDir(AppDir.'views/cn');
                $this->setCompileDir(AppDir.'views_c/cn');
                $this->setCacheDir(AppDir.'cache/cn');
            }else{
        ...
        if($lowxp->is_wechat){
            ...
            $signPackage = $lowxp->wxapi->getSignPackage();
            $lowxp->smarty->assign('signPackage',$signPackage);
        }
