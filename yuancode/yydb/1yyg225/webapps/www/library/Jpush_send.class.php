<?php
class Jpush_send{
        private $app_key = 'e7d2f627ebb8d1bea239e695';        //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = '374464d8b949f2b92ea65c56';    //主密码
        ...
        public function send_pub($receive,$content,$extras,$m_time='3600'){
           
            $m_time = '86400';//离线保留时间
            
            $message="";//存储推送状态
            $result = $this->push($receive,$content,$extras,$m_time);
            if($result){
        ...
        public function push($receiver='all',$content='',$extras=array(),$m_time='86400'){
