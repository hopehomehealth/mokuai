...
class tenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        //记录支付订单号
        insert_order_sn($order['log_id'], array('order_no'=>$sp_billno));
        ...
        $button  = '<form action="https://www.tenpay.com/cgi-bin/v1.0/pay_gate.cgi">';
        ...
        $button  .= '<input type="submit" class="payBtn" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
    ...
    function respond()
    {
        ...
        else
        {
            ...
            if($data['error'] > 0){ return false; }
                ...
                //记录第三方订单号
                insert_order_sn($log_id, array('transaction_id'=>$transaction_id));
            }
            return true;
        }
    }
