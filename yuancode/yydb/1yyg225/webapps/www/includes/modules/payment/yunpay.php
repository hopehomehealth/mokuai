...
$payment_lang = AppDir . 'includes/languages/payment/yunpay.php';
...
class yunpay
{
    ...
    function get_code($order, $payment)
    {
		...
		include(AppDir."includes/modules/payment/yunpay/yun_md5.function.php");
		
		 //商户订单号
        $out_trade_no = $order_no;//商户网站订单系统中唯一订单号，必填
