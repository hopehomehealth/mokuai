<?php /* Smarty version Smarty-3.1.13, created on 2016-12-05 16:15:03
         compiled from "/data/01/html/1yyg225/webapps/www/views/manage/yunbuy/edit_gobuy.html" */ ?>
<?php /*%%SmartyHeaderCode:147742359458452207242457-17311520%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e52e8e29f774715ef4dab38cea7926cdf1954e49' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/manage/yunbuy/edit_gobuy.html',
      1 => 1468926724,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147742359458452207242457-17311520',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_584522072efe55_00486931',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584522072efe55_00486931')) {function content_584522072efe55_00486931($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('../public_btn.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" />
        ...
        <tr>
            ...
            <td class="td-input">
                <input type="text" class="form-i w140" name="post[need_num]" value="<?php if ($_smarty_tpl->tpl_vars['row']->value['buy_id']){?><?php echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value['need_num'])===null||$tmp==='' ? 0 : $tmp);?>
<?php }else{ ?>999<?php }?>" />
            </td>
        </tr>
