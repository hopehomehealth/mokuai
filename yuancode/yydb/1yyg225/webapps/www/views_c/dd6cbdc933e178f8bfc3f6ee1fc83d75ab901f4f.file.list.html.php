...
    </form>    <?php if ($_smarty_tpl->tpl_vars['data']->value){?>    <div class="tips">        采购成本：        <b class="c-red"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['oldprice'])===null||$tmp==='' ? 0 : $tmp);?>
</b>        <span class="form-tip">（订单设置的采购价）</span>        商品成本：        <b class="c-red"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['price'])===null||$tmp==='' ? 0 : $tmp);?>
</b>        <span class="form-tip">（商品设置的原价）</span>        订单支付（不含第三方支付）：        <b class="c-red"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['order_price'])===null||$tmp==='' ? 0 : $tmp);?>
</b>        第三方支付：        <b class="c-red"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['money_paid'])===null||$tmp==='' ? 0 : $tmp);?>
...
" style="width:70px" /></td>                <td class="bdr" style="line-height: 1.5;">                    <div class="oi-name"><a href="<?php echo $_smarty_tpl->tpl_vars['m']->value['goods_url'];?>
