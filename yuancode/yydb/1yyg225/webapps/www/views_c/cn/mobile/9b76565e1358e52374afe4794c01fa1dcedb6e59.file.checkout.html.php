<?php /* Smarty version Smarty-3.1.13, created on 2017-01-12 16:09:07
         compiled from "/data/01/html/1yyg225/webapps/www/views/cn/mobile/yunbuy/checkout.html" */ ?>
<?php /*%%SmartyHeaderCode:9721821785850f3f19fa676-53254495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b76565e1358e52374afe4794c01fa1dcedb6e59' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/cn/mobile/yunbuy/checkout.html',
      1 => 1484103638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9721821785850f3f19fa676-53254495',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5850f3f1af51c2_43135647',
  'variables' => 
  array (
    'data' => 0,
    'm' => 0,
...
<?php if ($_valid && !is_callable('content_5850f3f1af51c2_43135647')) {function content_5850f3f1af51c2_43135647($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['header'])) {$_smarty_tpl->tpl_vars['header'] = clone $_smarty_tpl->tpl_vars['header'];
...
?>
        ...
        <div class="order-option">
            <dl class="checkBar">
                <dt class="color01" style="margin-bottom: 5px;">下单备注：<?php echo $_smarty_tpl->tpl_vars['m']->value['goods_name'];?>
（<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_go_buy'];?>
商品）</dt>
                <dd><textarea name="goods_info_<?php echo $_smarty_tpl->tpl_vars['m']->value['id'];?>
" style="width: 95%;padding:5px;border-color:#ccc;"><?php echo $_smarty_tpl->tpl_vars['m']->value['tips'];?>
</textarea></dd>
            </dl>
        </div>
        <?php }?>
...
不足，点击领<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
        ...
        <?php }else{ ?>
        <button class="ap-button" type="submit" onclick="return submitCheck()">确 认 支 付</button>
        <?php }?>
    </div>
</div>
</form>
