<?php /* Smarty version Smarty-3.1.13, created on 2016-12-10 13:25:54
         compiled from "/data/01/html/1yyg225/webapps/www/views/cn/member/db.html" */ ?>
<?php /*%%SmartyHeaderCode:138992053584b91e2d68a46-63034549%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '623102d021898d6888675883034bba5eff55eea7' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/cn/member/db.html',
      1 => 1481177921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '138992053584b91e2d68a46-63034549',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_584b91e300f960_28371748',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584b91e300f960_28371748')) {function content_584b91e300f960_28371748($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/data/01/html/1yyg225/system/smarty/plugins/modifier.date_format.php';
...
?order" <?php if (isset($_GET['order'])){?>class="dq"<?php }?>>未付款</a>
                ...
                <div class="dq-ts">
                    我的参与提醒： 即将揭晓<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
<a href="<?php echo url('/member/db');?>
?type=1" class="color01 fwb">（<?php echo $_smarty_tpl->tpl_vars['total']->value['wait'];?>
）</a> 进行中的<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
<a href="<?php echo url('/member/db');?>
?type=2" class="color01 fwb">（<?php echo $_smarty_tpl->tpl_vars['total']->value['ing'];?>
）</a> 已揭晓<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
<a href="<?php echo url('/member/db');?>
...
">
                ...
                <div class="dq-tab-t">
                    <table>
                        <tr>
                            <th style="width:116px;"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
图片</th>
                            <th style="width:450px;"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
名称</th>
                            <th style="width:80px;"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
状态</th>
...
" /></div>
                            ...
                            <td style="width:450px;">
                                <div class="dq-jd">
                                    <?php if ($_smarty_tpl->tpl_vars['m']->value['type']==2){?><span class="type-free">霸王餐区</span> <?php }?><a href="<?php echo $_smarty_tpl->tpl_vars['m']->value['url'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['m']->value['qishu_name'];?>
...
人次）<br/>
                            ...
                            <td style="width:80px;">
                                ...
                                <span class="color01">已<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_winning'];?>
</span>
...
人次 <?php if ($_smarty_tpl->tpl_vars['m']->value['multi']>1){?><br/><span class="color01">参与<?php echo $_smarty_tpl->tpl_vars['m']->value['multi'];?>
期</span><?php }?></td>
                            <td>
                                <ul>
...
图片</th>
                            <th style="width:450px;"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_price'];?>
名称</th>
                            <th style="width:120px;"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
状态</th>
                            <th>参与人次</th>
                        </tr>
                    </table>
...
?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
时间：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['r']->value['add_time'],'Y-m-d H:i:s');?>
        </th>
                                    <th nowrap>
                                        <span class="color01">
