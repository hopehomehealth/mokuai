<?php /* Smarty version Smarty-3.1.13, created on 2016-12-09 05:00:44
         compiled from "/data/01/html/1yyg225/webapps/www/views/cn/content/tiyan.html" */ ?>
<?php /*%%SmartyHeaderCode:10873663145847d1b0d0aed9-75923167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a76b3e5af8f1c8360c3580d6f47d6fd3e527a495' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/cn/content/tiyan.html',
      1 => 1481177860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10873663145847d1b0d0aed9-75923167',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5847d1b0e98253_94153907',
  'variables' => 
  array (
    'tagAdw' => 0,
    'tagAds' => 0,
...
<?php if ($_valid && !is_callable('content_5847d1b0e98253_94153907')) {function content_5847d1b0e98253_94153907($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/data/01/html/1yyg225/system/smarty/plugins/modifier.truncate.php';
    ...
    <div class="container" style="position:relative;margin-top:-180px;height:250px;">
        ...
        <div class="txt txt_ty">
            <dl style="background: #ffdb0b;color:#000;">
                <dt style="color: #e53f47"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
体验公告</dt>
                <dd>
...
">体验更多精彩宝贝，搬回家.....</a></div>
    ...
    <div class="tright">
        <dl>
            <dt>做任务，赚<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
</dt>
            <dd>
                <h4>任务<i>1</i>：语音认证</h4>

                <div class="d0">( 每个用户限领一次 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b>1</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_db_points'];?>
...
" class="color02">“语音认证”</a>后，即可领取。 </div>
            ...
            <dd>
                ...
                <div class="d0">( 每个用户限领一次 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['isPhoto'];?>
...
" class="color02">“上传头像”</a>即可领取。</div>
            ...
            <dd>
                ...
                <div class="d0">( 每个用户限领一次 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['isIdcard'];?>
</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_db_points'];?>
<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_bonus'];?>
...
" class="color02">“实名认证”</a>审核后，即可领取。 </div>
            ...
            <dd>
                ...
                <div class="d0">( 每个用户限领一次 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['isMail'];?>
</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_db_points'];?>
<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_bonus'];?>
...
" class="color02">“账户安全”</a>，点击认证邮箱通过后，即可领取。 </div>
            ...
            <dd>
                <h4>任务<i>5</i>：邀请赚<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
</h4>
                <div class="d2">
                    【任务说明】邀请第1位送5<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，第2位送10<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，第3位送15<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，第4位送20<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，第5位起送25<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，推荐多多，领取多多。
                    <span>
...
" class="hy-btn">立即邀请</a>
            ...
            <dd>
                <h4>任务<i>6</i>：签到送<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
</h4>

                <div class="d0">( 每个用户每天限领一次 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['signin_jl'];?>
</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
...
" class="hy-btn">立即签到</a>
                ...
                <div class="d2">【任务说明】每日签到免费得<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
，语音认证后第一次签到可获得20<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
（未语音认证仅前5天领取<?php echo $_smarty_tpl->tpl_vars['site_config']->value['signin_jl'];?>
<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
）！</div>
            </dd>
            <dd>
                <h4>任务<i>7</i>：<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
达人</h4>

                <div class="d0">( 不限次数 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['isDaren'];?>
</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
                ...
                <div class="d2">【任务说明】参与人次（不含体验拍和免费<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
商品）参与次数每超过50次后获50个<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
！</div>
            </dd>
            <dd>
                <h4>任务<i>8</i>：<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
达人</h4>

                <div class="d0">( 不限次数 )</div>
                <div class="d1">【任务<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_jiangli'];?>
】<b><?php echo $_smarty_tpl->tpl_vars['site_config']->value['isJpDaren'];?>
</b> <?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
                ...
                <div class="d2">【任务说明】参与<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
商品数（不含体验拍和免费<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_yun'];?>
商品）每超过50次后获50个<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
！</div>
            </dd>
        </dl>
        <dl class="dl2">
