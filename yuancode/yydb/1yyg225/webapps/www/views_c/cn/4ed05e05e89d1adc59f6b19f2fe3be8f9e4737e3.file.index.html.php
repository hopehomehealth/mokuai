<?php /* Smarty version Smarty-3.1.13, created on 2015-12-16 17:49:55
         compiled from "F:\WWW\1yyg225\webapps\www\views\cn\index.html" */ ?>
<?php /*%%SmartyHeaderCode:10473565d5896270556-32938006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ed05e05e89d1adc59f6b19f2fe3be8f9e4737e3' => 
    array (
      0 => 'F:\\WWW\\1yyg225\\webapps\\www\\views\\cn\\index.html',
      1 => 1450259393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10473565d5896270556-32938006',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_565d5896843445_84119529',
  'variables' => 
  array (
    'yuncat' => 0,
    'key' => 0,
...
<?php if ($_valid && !is_callable('content_565d5896843445_84119529')) {function content_565d5896843445_84119529($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'F:\\WWW\\1yyg225\\system\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_truncate')) include 'F:\\WWW\\1yyg225\\system\\smarty\\plugins\\modifier.truncate.php';
...
<?php }else{ ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['zz'][0][0]->_callViewFunc(array('mod'=>'fileurl','source'=>$_smarty_tpl->tpl_vars['m']->value['imgurl_src'],'width'=>200,'height'=>150,'type'=>0),$_smarty_tpl);?>
<?php }?>"></a><span></span></div>
...
期)<?php echo $_smarty_tpl->tpl_vars['m']->value['title'];?>
                    ...
                    <p class="num">价值：<?php echo $_smarty_tpl->tpl_vars['m']->value['need_num'];?>
 <span class="pay_points">拍币</span><span class="color01">(免费拍)</span></p>
                    <div class="progressBar">
                        <p class="progressBar-wrap">
                            <span style="width:<?php echo $_smarty_tpl->tpl_vars['m']->value['jindu'];?>
%"></span>
...
期)<?php echo $_smarty_tpl->tpl_vars['m']->value['title'];?>
                    ...
                    <p class="num">价值：￥<?php if ($_smarty_tpl->tpl_vars['m']->value['custom_price']>0){?><?php echo $_smarty_tpl->tpl_vars['m']->value['custom_price'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['m']->value['goods_price'];?>
<?php }?></p>
                    <div class="progressBar">
                        <p class="progressBar-wrap">
                            <span style="width:<?php echo $_smarty_tpl->tpl_vars['m']->value['jindu'];?>
...
" target="_blank" title="做任务，赚拍币">拍币</a></em></i>
                        <?php }?>
                    </p>
                    <?php }else{ ?>
                    ...
                    <p class="tip"><?php if ($_smarty_tpl->tpl_vars['auction']->value['cat_type']=='tiyan'){?><span class="color01">体验</span><?php }?>中奖率：<?php echo $_smarty_tpl->tpl_vars['auction']->value['win'];?>
