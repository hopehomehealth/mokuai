<?php /* Smarty version Smarty-3.1.13, created on 2016-12-19 17:56:51
         compiled from "/data/01/html/1yyg225/webapps/www/views/cn/order/check.html" */ ?>
<?php /*%%SmartyHeaderCode:14946853525857aee397eeb4-65736761%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2719b71765a10b4a180aa33836db0a5a63d55d6a' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/cn/order/check.html',
      1 => 1481177860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14946853525857aee397eeb4-65736761',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5857aee3af3494_87665043',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5857aee3af3494_87665043')) {function content_5857aee3af3494_87665043($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
余额：<em><?php echo $_smarty_tpl->tpl_vars['member']->value['pay_points'];?>
        ...
        <div class="m-cart-submit">
            <button class="w-button w-button-main w-button-xl" id="pro-view-10" type="submit"><span><?php if ($_SESSION['extension_code']!=3){?>确认支付<?php }else{ ?>确认<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_lingjiang'];?>
<?php }?></span></button>
        </div>
        <?php if ($_SESSION['extension_code']!=3){?>
        <div class="w-payTips">
