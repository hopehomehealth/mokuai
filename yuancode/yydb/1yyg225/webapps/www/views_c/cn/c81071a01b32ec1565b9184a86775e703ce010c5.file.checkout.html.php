<?php /* Smarty version Smarty-3.1.13, created on 2016-05-30 13:29:33
         compiled from "D:\test1yyg3.lnest.com\webapps\www\views\cn\yunbuy\checkout.html" */ ?>
<?php /*%%SmartyHeaderCode:9725661001f789775-59376813%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c81071a01b32ec1565b9184a86775e703ce010c5' => 
    array (
      0 => 'D:\\test1yyg3.lnest.com\\webapps\\www\\views\\cn\\yunbuy\\checkout.html',
      1 => 1464586114,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9725661001f789775-59376813',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5661001f9bc940_02645593',
  'variables' => 
  array (
    'disabled_sub' => 0,
    'data' => 0,
...
<?php if ($_valid && !is_callable('content_5661001f9bc940_02645593')) {function content_5661001f9bc940_02645593($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" id="checkoutFrom" method="post" <?php if ($_smarty_tpl->tpl_vars['disabled_sub']->value){?>onsubmit="return submitCheck();" target="_blank"<?php }?>>
...
：<span class="color01"><?php echo count($_smarty_tpl->tpl_vars['bonus']->value['list']);?>
 ...
 价值： <em><?php echo $_smarty_tpl->tpl_vars['bonus']->value['money'];?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['site_config']->value['pay_discount_status']==1){?><span style="color:rgba(229, 64, 72, 1);">（买网盘送云购币）</span><?php }?>
                            </label>
                        </div>
                        <?php }?>
                        <div class="option">
...
（即1次抽奖机会），可联系客服在线开通，支付的款项将无法退回。</p>
                        </div>
                        <div>
                            <div class="w-pay">
...
不足，点击领<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
                ...
                <?php }else{ ?>
                <button type="submit" class="w-button w-button-main w-button-xl" id="pro-view-10"><span>确认支付</span></button>
                <?php }?>
            </div>
