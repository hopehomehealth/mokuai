<?php /* Smarty version Smarty-3.1.13, created on 2015-11-28 19:21:46
         compiled from "H:\projects\web\lnest02\1yyg\webapps\www\views\cn\member\menu.html" */ ?>
<?php /*%%SmartyHeaderCode:1198656598e4ac92a56-14174192%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adc652a1220c4981873cf6746f15f2a53521463f' => 
    array (
      0 => 'H:\\projects\\web\\lnest02\\1yyg\\webapps\\www\\views\\cn\\member\\menu.html',
      1 => 1433935362,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1198656598e4ac92a56-14174192',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56598e4ae4c037_54178486',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56598e4ae4c037_54178486')) {function content_56598e4ae4c037_54178486($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'H:\\projects\\web\\lnest02\\1yyg\\system\\smarty\\plugins\\modifier.truncate.php';
...
" title="点击验证邮箱"><img src="/style/images/hy-ico3.png" /></a>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['member']->value['is_voice']){?>
            <a title="语音验证已通过"><img src="/style/images/voice.gif" /></a>
            <?php }else{ ?>
            <a href="<?php echo url('/member/verifyvoice#m');?>
" title="点击验证语音"><img src="/style/images/voice2.gif" /></a>
            <?php }?>
        </div>
        <div class="mb10">
...
" class="zc-a">邀请得现金奖励</a>
            ...
            <tr>
                <td colspan="5" style="padding-top:10px;font-size: 12px;font-weight: bold;color: #000;">
                    限时优惠：2015年7月1号前，首次兑换夺宝币，10元送抵用券10元，100元送抵用券15元
                </td>
            </tr>
            </tbody>
        </table>
...
<div class="fn-left hy-l">
    ...
    <div class="hy-lnav">
        <h3 class="fn-clear"><span></span>我的夺宝</h3>
        <ul>
...
">中奖记录</a></li>
        ...
        <h3 class="fn-clear"><span></span>我的竞拍</h3>
        <ul class="fn-clear">
