<?php /* Smarty version Smarty-3.1.13, created on 2015-12-02 17:48:46
         compiled from "E:\projects\web\lnest\1yyg225\webapps\www\views\cn\auction\view.html" */ ?>
<?php /*%%SmartyHeaderCode:7978565ebd986722f8-96802624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1cc4e4b166154ba20d850f76e5649505cbccb532' => 
    array (
      0 => 'E:\\projects\\web\\lnest\\1yyg225\\webapps\\www\\views\\cn\\auction\\view.html',
      1 => 1449049724,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7978565ebd986722f8-96802624',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_565ebd988ac880_17642008',
  'variables' => 
  array (
    'data' => 0,
    'tagPics' => 0,
...
<?php if ($_valid && !is_callable('content_565ebd988ac880_17642008')) {function content_565ebd988ac880_17642008($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" class="color02" target="_blank"><?php echo $_smarty_tpl->tpl_vars['data']->value['row']['desc'][0];?>
            ...
            <p>竞拍<a _title="为保证公平公正竟拍" class="layerTip">保证金</a>：<span class="color01"><?php echo price_format($_smarty_tpl->tpl_vars['data']->value['row']['deposit']);?>
</span> <span class="color04">（参加本竞拍需暂时缴纳的保证金）（<span class="color01">获奖者直接使用此保证金支付部分款项；未获奖者竞拍结束后将退还到您的帐户余额</span>）</span></p>
            <?php }?>
            <p>竞拍模式：<span class="color01"><?php if ($_smarty_tpl->tpl_vars['data']->value['row']['type']==0){?>中奖<?php }else{ ?>竞拍+中奖<?php }?></span> <span class="color04">（<?php if ($_smarty_tpl->tpl_vars['data']->value['row']['type']==0){?>本竞拍为中奖模式，只有一次出价机会<?php if ($_smarty_tpl->tpl_vars['data']->value['row']['typenum']>0){?>，参与人数超过<span class="color01"><?php echo $_smarty_tpl->tpl_vars['data']->value['row']['typenum'];?>
</span>人，最高出价者将获得商品<?php }?><?php }else{ ?>本竞拍最高出价者竞拍成功，同时首次出价者还有一次中奖机会<?php }?>）</span></p>
            <p>开奖处理：<span class="color04">工作日每天下午3:00-4:00，系统计算当天14点前所有首次出价结果</span></p>
            <p>中奖人数：<?php echo $_smarty_tpl->tpl_vars['data']->value['codCount'];?>
...
<?php }else{ ?>0<?php }?> <span class="color04">（<?php if ($_smarty_tpl->tpl_vars['data']->value['row']['winnum']<0){?>本竞拍中奖人数不限数量<?php }elseif($_smarty_tpl->tpl_vars['data']->value['row']['winnum']>0){?>本竞拍最大中奖数为前<?php echo $_smarty_tpl->tpl_vars['data']->value['row']['winnum'];?>
位中奖者<?php }else{ ?>本竞拍未设置中奖<?php }?>）</span></p>
            <?php if ($_smarty_tpl->tpl_vars['data']->value['row']['painum']>0){?>
            <p><a href="<?php echo url('/content/index/78');?>
">拍币</a>限额：<?php echo $_smarty_tpl->tpl_vars['data']->value['row']['painum'];?>
 <span class="color04">（若您竞拍成功或中奖，下单时最多可使用拍币的数量）</span></p>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['data']->value['row']['paib']){?>
            <p>扣除<a href="<?php echo url('/content/index/78');?>
">拍币</a>：<?php echo $_smarty_tpl->tpl_vars['data']->value['row']['paib'];?>
 <span class="color04">（本商品首次出价即扣相应拍币数，拍币不足则无法出价）</span></p>
            <?php }?>
...
" class="color02" target="_blank">领拍币</a>】 <?php }?>中奖率：<span class="color01"><?php echo $_smarty_tpl->tpl_vars['data']->value['row']['win'];?>
%</span> ，已有<span class="color01" id="BidCount"><?php echo $_smarty_tpl->tpl_vars['data']->value['row']['bid_user_count'];?>
    ...
    <div class="fn-clear jp-sptab" id="tab">
        <ul class="fn-left">
            ...
            <li onclick="load_cod()">中奖名单</li>
        </ul>
        <div class="fn-left">
            <a href="<?php echo url('/content/html/winrules');?>
" target="_blank">中奖规则</a>
...
" target="_blank">常见问题</a>
    ...
    <div class="jp-spxq fn-clear">
        <div class="nr1 sp-txt">
            ...
            <div class="special">重要说明：奖品获得者拥有 <?php echo $_smarty_tpl->tpl_vars['data']->value['row']['title'];?>
 10年免费使用权</div>
            <?php }?>
        </div>
