<?php /* Smarty version Smarty-3.1.13, created on 2016-12-10 00:56:30
         compiled from "/data/01/html/1yyg225/webapps/www/views/cn/member/index.html" */ ?>
<?php /*%%SmartyHeaderCode:892363510584ae23e47cff5-37343086%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c036436c54d7964de19358a051ccef2192e181b2' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/cn/member/index.html',
      1 => 1470031446,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '892363510584ae23e47cff5-37343086',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_584ae23e65c711_88069037',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584ae23e65c711_88069037')) {function content_584ae23e65c711_88069037($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/data/01/html/1yyg225/system/smarty/plugins/modifier.date_format.php';
...
<?php }?>，</p>
                            <p>参与：<b class="color01"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['m']->value['buy_num'])===null||$tmp==='' ? 0 : $tmp);?>
</b> <?php if ($_smarty_tpl->tpl_vars['m']->value['type']==1){?>人次<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
<?php }?>，</p>
                            <p>剩余：<b class="color01"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['m']->value['end_num'])===null||$tmp==='' ? 0 : $tmp);?>
</b> <?php if ($_smarty_tpl->tpl_vars['m']->value['type']==1){?>人次<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
<?php }?></p>
