<?php /* Smarty version Smarty-3.1.13, created on 2015-11-28 19:18:17
         compiled from "H:\projects\web\lnest02\1yyg\webapps\www\views\cn\yunbuy\checkout.html" */ ?>
<?php /*%%SmartyHeaderCode:1165956598d79c5a091-33489645%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a892bd4f0cd79df9585f775cd17091871fb687ff' => 
    array (
      0 => 'H:\\projects\\web\\lnest02\\1yyg\\webapps\\www\\views\\cn\\yunbuy\\checkout.html',
      1 => 1427780718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1165956598d79c5a091-33489645',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56598d79db0108_81848806',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56598d79db0108_81848806')) {function content_56598d79db0108_81848806($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php if ($_POST['free']==1){?>?free<?php }?>" style="font-size: 14px;">返回清单修改</a>
                    ...
                    <div class="m-cart-order-options">
                        <?php if ($_smarty_tpl->tpl_vars['is_share']->value&&1==2){?>
                        <div class="option">
                        ...
                        <div class="option">
                            <?php if ($_POST['free']!=1){?>
                            <label class="w-checkbox w-checkbox-disabled"><input type="checkbox" value="1" name="balance_pay" checked disabled="disabled"> <span data-pro="text" style="color:#000;font-weight:bold;">剩余夺宝币：<span class="color01"><?php echo $_smarty_tpl->tpl_vars['member']->value['db_points'];?>
                ...
                <div class="m-cart-order-pay f-clear" style="padding-bottom: 0;">
                    <div class="pay_online">
                        <div class="tips" style="padding:10px 20px 5px;">
                        ...
                        <div data-pro="paySelector">
                            <div class="w-pay" id="pro-view-2">
                                ...
                                <div class="w-pay-selector" data-pro="selector">
                                    <?php  $_smarty_tpl->tpl_vars['m'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['m']->_loop = false;
...
?>
                                    <div class="w-pay-type w-pay-type-3 <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['payment']['iteration']==1){?>w-pay-selected<?php }?>"><input type="hidden" name="pay_id" value="<?php echo $_smarty_tpl->tpl_vars['m']->value['pay_id'];?>
" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['payment']['iteration']==1){?>checked<?php }?>><?php echo $_smarty_tpl->tpl_vars['m']->value['pay_name'];?>
</div>
                                    <?php } ?>
                                </div>
                            </div>
            ...
            <div class="m-cart-submit" data-pro="submit">
                ...
                <?php }else{ ?>
                <a style="float:right;color:#fff;" href="/member/recchage" class="w-button w-button-main w-button-xl"><span>夺宝币或余额不足，点击充值</span></a>
                <?php }?>
                <?php }else{ ?>
                <button onclick="$('#checkoutFrom').submit()" class="w-button w-button-main w-button-xl <?php if ($_smarty_tpl->tpl_vars['disabled_sub']->value){?>w-button-disabled<?php }?>" <?php if ($_smarty_tpl->tpl_vars['disabled_sub']->value){?>disabled="disabled"<?php }?> id="pro-view-10"><span>确认支付</span></button>
                <?php }?>
            </div>
