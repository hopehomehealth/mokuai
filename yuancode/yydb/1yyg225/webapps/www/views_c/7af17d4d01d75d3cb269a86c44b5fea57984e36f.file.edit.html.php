<?php /* Smarty version Smarty-3.1.13, created on 2016-12-20 15:07:19
         compiled from "/data/01/html/1yyg225/webapps/www/views/manage/auction/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:13693833225858d8a713c531-84313997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7af17d4d01d75d3cb269a86c44b5fea57984e36f' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/manage/auction/edit.html',
      1 => 1456367948,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13693833225858d8a713c531-84313997',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5858d8a726a7d8_49604104',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5858d8a726a7d8_49604104')) {function content_5858d8a726a7d8_49604104($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/data/01/html/1yyg225/system/smarty/plugins/modifier.date_format.php';
...
<?php }?>" />
    ...
    <tbody>
        ...
        <tr>
            <td class="td-label"><label><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
类型：<span class="c-red">*</span></label></td>
            <td class="td-input">
...
" />
                <div class="form-tip">留空时取<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
商品名称</div>
            </td>
        </tr>
...
" />
        ...
        <tr>
            <td class="td-label"><label><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
时间：<span class="c-red">*</span></label></td>
            <td class="td-input">
...
" type="text" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd 11:00', minDate:'#F{ $dp.$D(\'start_time\') }' })" readonly />
        ...
        <tr class="table-h3">
            <td colspan="2"><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
参数</td>
        </tr>
...
" />
        ...
        <tr>
            <td class="td-label"><label><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_baozheng'];?>
：</label></td>
            <td class="td-input">
...
" />
                <span class="form-tip">支付时最多可使用的<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
数</span>
            </td>
        </tr>

        <tr>
            <td class="td-label"><label>扣除<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
：</label></td>
            <td class="td-input">
                <input type="text" class="form-i w140" name="post[paib]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value['paib'])===null||$tmp==='' ? 0 : $tmp);?>
" />
                <span class="form-tip">首次出价需要扣除的<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay_points'];?>
</span>
            </td>
        </tr>

        <tr>
            <td class="td-label"><label>最大<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_winning'];?>
人数：</label></td>
            <td class="td-input">
...
" />
        ...
        <tr>
            <td class="td-label"><label>设置<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_winning'];?>
率：</label></td>
            <td class="td-input">
        ...
        <tr>
            ...
            <td class="td-input">
                <select name="post[type]">
                    <option value="0" <?php if ($_smarty_tpl->tpl_vars['row']->value['type']=='0'){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_winning'];?>
模式</option>
                    <option value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['type']=='1'){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['L']->value['unit_winning'];?>
...
" />
                <span class="form-tip">达到此人数自动转<?php echo $_smarty_tpl->tpl_vars['L']->value['unit_pay'];?>
，大于0时有效</span>
            </td>
        </tr>
