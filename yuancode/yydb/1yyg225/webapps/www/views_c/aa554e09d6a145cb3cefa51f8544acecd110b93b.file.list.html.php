<?php /* Smarty version Smarty-3.1.13, created on 2016-12-08 14:31:14
         compiled from "/data/01/html/1yyg225/webapps/www/views/manage/goods/list.html" */ ?>
<?php /*%%SmartyHeaderCode:166130640658451fe88010c8-69866963%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa554e09d6a145cb3cefa51f8544acecd110b93b' => 
    array (
      0 => '/data/01/html/1yyg225/webapps/www/views/manage/goods/list.html',
      1 => 1481177921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '166130640658451fe88010c8-69866963',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_58451fe887fd44_71211376',
  'variables' => 
  array (
    'k' => 0,
    'business_power' => 0,
...
<?php if ($_valid && !is_callable('content_58451fe887fd44_71211376')) {function content_58451fe887fd44_71211376($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('../public_btn.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" type="text">
        ...
        <?php if ($_smarty_tpl->tpl_vars['virtual_power']->value==1){?>
        <select name="virtual">
            <option value="">商品类型</option>
            <option value="99" <?php if ($_smarty_tpl->tpl_vars['virtual']->value==99){?> selected<?php }?>>实体商品</option>
            <option value="1" <?php if ($_smarty_tpl->tpl_vars['virtual']->value==2){?> selected<?php }?>>虚拟商品</option>
        </select>
        <?php }?>
...
','goods','is_sale')" class="c-red" title="当前未审核状态">未审核</a>
        ...
        <td class="opera" align='center' nowrap>
            <?php if ($_smarty_tpl->tpl_vars['virtual_power']->value==1&&$_smarty_tpl->tpl_vars['m']->value['virtual']==1){?>
            <a href='#!virtual/index?goods_id=<?php echo $_smarty_tpl->tpl_vars['m']->value['id'];?>
' class='iconfont icon-a' title='管理虚拟卡'>&#xe65a;</a>
            <?php }?>
