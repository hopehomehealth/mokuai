<?php /* Smarty version Smarty-3.1.13, created on 2015-12-02 17:33:05
         compiled from "E:\projects\web\lnest\1yyg225\webapps\www\views\manage\auction\list_log.html" */ ?>
<?php /*%%SmartyHeaderCode:16434565ebad1590e96-51667595%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ecfc6b98f22b832ba804be40a023c12d221c00b' => 
    array (
      0 => 'E:\\projects\\web\\lnest\\1yyg225\\webapps\\www\\views\\manage\\auction\\list_log.html',
      1 => 1425549510,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16434565ebad1590e96-51667595',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565ebad16f84e0_69335275',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565ebad16f84e0_69335275')) {function content_565ebad16f84e0_69335275($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\projects\\web\\lnest\\1yyg225\\system\\smarty\\plugins\\modifier.date_format.php';
...
<div class="html-box">
    <div class="f-unit clear">
        <form class="cond-form" action="#!auction/log" onsubmit="return xForm.submit(this)">
            <div class="clear">
                <select name="k" id="k">
                    <option value="act_id" <?php if ($_smarty_tpl->tpl_vars['k']->value=='act_id'){?>selected<?php }?>>竞拍商品ID</option>
...
" <?php if ($_smarty_tpl->tpl_vars['status']->value==@constant('OKWIN')){?>selected<?php }?>>已中奖，未领取</option>
                    <option value="<?php echo @constant('FINWIN');?>
" <?php if ($_smarty_tpl->tpl_vars['status']->value==@constant('FINWIN')){?>selected<?php }?>>已中奖，已领取</option>
...
" <?php if ($_smarty_tpl->tpl_vars['status']->value==@constant('NOWIN')){?>selected<?php }?>>未中奖</option>
...
<?php }else{ ?><b class="c-orange"><?php echo $_smarty_tpl->tpl_vars['m']->value['deposit'];?>
                ...
                <td align="center">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['m']->value['status']==@constant('NOWIN')){?><span class="c-disable">未中奖</span>
...
','auction_log','fdis','log_id')" title="点击设为永不失效" class="c-disable">已失效</a>
                    ...
                    <a href="javascript:;" onclick="main.chang_status('<?php echo $_smarty_tpl->tpl_vars['m']->value['log_id'];?>
','auction_log','fdis','log_id')" title="<?php if ($_smarty_tpl->tpl_vars['m']->value['fdis']==1){?>点击设为开奖7天后失效<?php }else{ ?>点击设为永不失效<?php }?>" class="c-red">已中奖</a>
