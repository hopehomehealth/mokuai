...
-- Script date 2017/12/22 19:03:37
...
-- Table aaaa.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table aaaa.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table aaaa.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table aaaa.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table aaaa.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table aaaa.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table aaaa.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table aaaa.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table aaaa.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table aaaa.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table aaaa.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table aaaa.ns_account_withdraw_user_records does not contain any data (it is empty)
...
-- Table aaaa.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table aaaa.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table aaaa.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table aaaa.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table aaaa.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table aaaa.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table aaaa.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table aaaa.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table aaaa.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table aaaa.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table aaaa.ns_gift_grant_records does not contain any data (it is empty)
...
-- Table aaaa.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table aaaa.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table aaaa.ns_goods_brand does not contain any data (it is empty)
...
-- Table aaaa.ns_goods_comment does not contain any data (it is empty)
...
-- Table aaaa.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table aaaa.ns_goods_group does not contain any data (it is empty)
...
-- Table aaaa.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table aaaa.ns_goods_sku_picture_delete does not contain any data (it is empty)
...
-- Table aaaa.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table aaaa.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table aaaa.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table aaaa.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table aaaa.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table aaaa.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table aaaa.ns_member_gift does not contain any data (it is empty)
...
-- Table aaaa.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_notice
--

-- Table aaaa.ns_notice does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table aaaa.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table aaaa.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table aaaa.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table aaaa.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table aaaa.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table aaaa.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table aaaa.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table aaaa.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table aaaa.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table aaaa.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund_account_records
--

-- Table aaaa.ns_order_refund_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table aaaa.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table aaaa.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table aaaa.ns_pickup_point does not contain any data (it is empty)
...
-- Table aaaa.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table aaaa.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table aaaa.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table aaaa.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table aaaa.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table aaaa.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table aaaa.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table aaaa.ns_promotion_discount_goods does not contain any data (it is empty)
...
-- Table aaaa.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table aaaa.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table aaaa.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table aaaa.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table aaaa.ns_promotion_mansong_rule does not contain any data (it is empty)
...
-- Table aaaa.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table aaaa.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table aaaa.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table aaaa.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table aaaa.ns_shop_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_navigation
--

-- Table aaaa.ns_shop_navigation does not contain any data (it is empty)
...
(5, '促销专区', '/goods/promotionZone', 1, 1, 1500717235);

-- 
-- Dumping data for table ns_shop_order_account_records
--

-- Table aaaa.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table aaaa.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods
--

-- Table aaaa.ns_virtual_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods_group
--

-- Table aaaa.ns_virtual_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods_type
--

-- Table aaaa.ns_virtual_goods_type does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table aaaa.sys_addons does not contain any data (it is empty)
...
-- Table aaaa.sys_custom_template does not contain any data (it is empty)
...
-- Table aaaa.sys_instance_type does not contain any data (it is empty)
...
-- Table aaaa.sys_notice_records does not contain any data (it is empty)

-- 
-- Dumping data for table sys_notice_template
--

-- Table aaaa.sys_notice_template does not contain any data (it is empty)
...
-- Table aaaa.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table aaaa.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table aaaa.sys_version_patch does not contain any data (it is empty)
...
-- Table aaaa.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table aaaa.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table aaaa.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table aaaa.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table aaaa.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table aaaa.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table aaaa.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table aaaa.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table aaaa.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table aaaa.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table aaaa.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table aaaa.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table aaaa.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table aaaa.sys_wexin_onekeysubscribe does not contain any data (it is empty)
