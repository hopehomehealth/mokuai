<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"template/adminblue\Config\customPseudoStaticRule.html";i:1512013747;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/addRoutingRules'); ?>';">添加路由规则</button>
</div>
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/customPseudoStaticRule'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/config/delete_url_route'); ?>",
					data : { "routeid" : routeid.toString() },
					success : function(data) {
						if (data["code"] > 0) {
							showMessage('success', data["message"], "<?php echo __URL('ADMIN_MAIN/config/customPseudoStaticRule'); ?>");
						}else{
...
function CheckAll(event){
	if($(event).is(":checked")){
		$(".table-class tbody tr input[name='sub']").not(":disabled").prop("checked",true);
	}else{
		$(".table-class tbody tr input[name='sub']").not(":disabled").prop("checked",false);
	}
}
//批量删除
