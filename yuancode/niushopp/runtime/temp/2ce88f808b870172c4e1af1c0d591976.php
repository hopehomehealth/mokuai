<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Upgrade\onlineUpdateList.html";i:1508411953;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<form action="<?php echo __URL('ADMIN_MAIN/upgrade/upgradePatch'); ?>" method="post" id="fpForm">
...
function LoadingPages() {
	var user_name = '<?php echo $devolution_user_name; ?>';
	var password = '<?php echo $devolution_password; ?>';
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/upgrade/onlineupdatelist'); ?>",
		data : {
			"user_name" : user_name, 
			"password" : password
		},
...
function upPatch(){
	...
	if(is_backup == 1){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/upgrade/database_backup'); ?>",
			dataType : "json",
			beforeSend: function () {
			...
			success : function(data) {
				...
				if(data['code']==0){
					...
					$.ajax({
						type : "post",
						url : "<?php echo __URL('ADMIN_MAIN/upgrade/upversionpatch'); ?>",
						data : {
