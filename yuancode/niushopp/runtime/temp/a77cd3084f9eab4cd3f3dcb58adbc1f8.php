<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Goods\goodsComment.html";i:1510652716;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		...
		<th style="line-height:33px;">
			...
			评价类型：
			<select id="explain_type" class="select-common w100">
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td class="td-14">';
					html += '<input value="'+data['data'][i]['id']+'" name="sub" type="checkbox" style="margin-left:15px;"></td>';
					...
					html += '<span style="margin-right:5px;width:60px;float:left;"><img src="'+ __IMG(data["data"][i]["goods_image"])+'"></span>';
