<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Goods\goodsCategoryList.html";i:1512008311;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): if( count($category_list)==0 ) : echo "" ;else: foreach($category_list as $key=>$v1): ?>
			<tr class="pid_0" style="height: 30px;">
				<td>
					...
					<a href="javascript:;" onclick="tab_switch(<?php echo $v1['category_id']; ?>)" class="tab_jia_<?php echo $v1['category_id']; ?>" style="display: block;"><i class="fa fa-plus-circle"></i></a>
					<a href="javascript:;" onclick="tab_switch(<?php echo $v1['category_id']; ?>)" class="tab_jian_<?php echo $v1['category_id']; ?>" style="display: none;"><i class="fa fa-minus-circle"></i></a>
					<?php endif; ?>
				</td>
				<td style="text-align: center;"><input type="number" class="sort input-common" fieldid="<?php echo $v1['category_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>" size="1"></td>
				<td><input class="input-common" type="text" fieldid="<?php echo $v1['category_id']; ?>" fieldname="category_name" value="<?php echo $v1['category_name']; ?>" style="width: 150px;"></td>
				<td><input class="input-common" type="text" fieldid="<?php echo $v1['category_id']; ?>" fieldname="short_name" value="<?php echo $v1['short_name']; ?>" style="width: 150px;"></td>
			...
			<tr class="pid_<?php echo $v1['category_id']; ?>" style="height: 30px;display: none;">
				<td>
					<?php if($v2['child_list'] != array()): ?>
					<a href="javascript:;" onclick="tab_switch(<?php echo $v2['category_id']; ?>)" class="tab_jian_<?php echo $v2['category_id']; ?>" style="display: block;"><i class="fa fa-minus-circle"></i></a>
					<a href="javascript:;" onclick="tab_switch(<?php echo $v2['category_id']; ?>)" class="tab_jia_<?php echo $v2['category_id']; ?>" style="display: none;"><i class="fa fa-plus-circle"></i></a>
					<?php endif; ?>
				</td>
				<td style="text-align: center;"><input type="text" class="sort input-common" fieldid="<?php echo $v2['category_id']; ?>" fieldname="sort"  value="<?php echo $v2['sort']; ?>" size="1"></td>
				<td><span style="color:#ccc;">|——</span> <input type="text" class="input-common" fieldid="<?php echo $v2['category_id']; ?>" fieldname="category_name" value="<?php echo $v2['category_name']; ?>" style="width: 100px;"></td>
				<td><input type="text" class="input-common" fieldid="<?php echo $v2['category_id']; ?>" fieldname="short_name" value="<?php echo $v2['short_name']; ?>" style="width: 150px;"></td>
				...
				<tr class="pid_<?php echo $v2['category_id']; ?> pid_<?php echo $v1['category_id']; ?>" style="height: 30px;display:none;">
					<td></td>
					<td style="text-align: center;"><input type="text" class="sort input-common" fieldid="<?php echo $v3['category_id']; ?>" fieldname="sort"  value="<?php echo $v3['sort']; ?>" size="1"></td>
					<td><span style="color:#ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span> <input class="input-common type="text" fieldid="<?php echo $v3['category_id']; ?>" fieldname="category_name" value="<?php echo $v3['category_name']; ?>" style="width: 100px;"></td>
					<td><input type="text" class="input-common" fieldid="<?php echo $v3['category_id']; ?>" fieldname="short_name" value="<?php echo $v3['short_name']; ?>" style="width: 150px;"></td>
		...
		buttons: {
			"确定": function() {
				...
				$.ajax({
					...
					success : function(data) {
						if(data['code'] > 0){
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/goods/goodscategorylist'); ?>");
						}else{
