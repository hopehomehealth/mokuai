<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\System\moduleList.html";i:1508414555;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tr class="pid_0" style="height: 30px;">
		...
		<td style="text-align: center;">
			<input onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" class="sort input-common" fieldid="<?php echo $v1['module_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>" size="1">
		</td>
		<td>
			<input type="text" fieldid="<?php echo $v1['module_id']; ?>" class="input-common" fieldname="module_name" value="<?php echo $v1['module_name']; ?>">
		</td>
		<td style="text-align: center;"><?php echo !empty($v1['is_menu'])?'是' : '否'; ?></td>
		<td style="text-align: center;">
			<a href="<?php echo __URL('ADMIN_MAIN/system/editmodule','module_id='.$v1['module_id']); ?>">修改</a>
			<a href="javascript:void(0);" onclick="delModule(<?php echo $v1['module_id']; ?>)">删除</a>
		</td>
	</tr>
		...
		<tr class="pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
			<td>
				<?php if($v2['sub_menu'] != array()): ?>
				<a href="javascript:void(0)" onclick="tab_switch(<?php echo $v2['module_id']; ?>)" class="tab_jian_<?php echo $v2['module_id']; ?> tab_jian_<?php echo $v1['module_id']; ?>" style="display: block;"><i class="fa fa-minus-circle"></i></a>
				<a href="javascript:void(0)" onclick="tab_switch(<?php echo $v2['module_id']; ?>)" class="tab_jia_<?php echo $v2['module_id']; ?> tab_jia_<?php echo $v1['module_id']; ?>" style="display: none;"><i class="fa fa-plus-circle"></i></a>
				<?php endif; ?>
			</td>
			<td style="text-align: center;">
				<input onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" class="sort input-common" fieldid="<?php echo $v2['module_id']; ?>" fieldname="sort" value="<?php echo $v2['sort']; ?>" size="1">
			</td>
			<td>
				<span style="color: #ccc;">|——</span>
				<input type="text" fieldid="<?php echo $v2['module_id']; ?>" fieldname="module_name" class="input-common" value="<?php echo $v2['module_name']; ?>">
			</td>
			<td style="text-align: center;"><?php echo !empty($v2['is_menu'])?'是' : '否'; ?></td>
			<td style="text-align: center;">
				<a href="<?php echo __URL('ADMIN_MAIN/system/editmodule','module_id='.$v2['module_id']); ?>">修改</a>
				<a href="javascript:void(0);" onclick="delModule(<?php echo $v2['module_id']; ?>)">删除</a>
			</td>
		</tr>
			...
			<tr class="pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
				<td></td>
				<td style="text-align: center;">
					<input type="text" class="sort input-common" fieldid="<?php echo $v3['module_id']; ?>" fieldname="sort" value="<?php echo $v3['sort']; ?>" size="1">
				</td>
				<td>
					<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span>
					<input type="text" fieldid="<?php echo $v3['module_id']; ?>" class="input-common" fieldname="module_name" value="<?php echo $v3['module_name']; ?>">
				</td>
				<td style="text-align: center;"><?php echo !empty($v3['is_menu'])?'是' : '否'; ?></td>
				<td style="text-align: center;">
					<a href="<?php echo __URL('ADMIN_MAIN/system/editmodule','module_id='.$v3['module_id']); ?>">修改</a>
					<a href="javascript:void(0);" onclick="delModule(<?php echo $v3['module_id']; ?>)">删除</a>
				</td>
			</tr>
				...
				<tr class="pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
					<td></td>
					<td style="text-align: center;">
						<input type="text" class="sort input-common" fieldid="<?php echo $v4['module_id']; ?>" fieldname="sort" value="<?php echo $v4['sort']; ?>" size="1">
					</td>
					<td>
						<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span>
						<input type="text" fieldid="<?php echo $v4['module_id']; ?>" fieldname="module_name" value="<?php echo $v4['module_name']; ?>" class="input-common">
					</td>
					<td style="text-align: center;"><?php echo !empty($v4['is_menu'])?'是' : '否'; ?></td>
					<td style="text-align: center;">
						<a href="<?php echo __URL('ADMIN_MAIN/system/editmodule','module_id='.$v4['module_id']); ?>">修改</a>
						<a href="javascript:void(0);" onclick="delModule(<?php echo $v4['module_id']; ?>)">删除</a>
					</td>
				</tr>
					...
					<tr class="pid_<?php echo $v4['module_id']; ?> pid_<?php echo $v3['module_id']; ?> pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>" style="height: 30px; display: none;">
						<td></td>
						<td style="text-align: center;">
							<input type="text" class="sort input-common" fieldid="<?php echo $v5['module_id']; ?>" fieldname="sort" value="<?php echo $v5['sort']; ?>" size="1">
						</td>
						<td>
							<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span>
							<input type="text" fieldid="<?php echo $v5['module_id']; ?>" class="input-common" fieldname="module_name" value="<?php echo $v5['module_name']; ?>">
						</td>
						<td style="text-align: center;"><?php echo !empty($v5['is_menu'])?'是' : '否'; ?></td>
						<td style="text-align: center;">
							<a href="<?php echo __URL('ADMIN_MAIN/system/editmodule','module_id='.$v5['module_id']); ?>">修改</a>
							<a href="javascript:void(0);" onclick="delModule(<?php echo $v5['module_id']; ?>)">删除</a>
						</td>
					</tr>
...
$(".table-class input").change(function(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/system/modifyfield'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url:"<?php echo __URL('ADMIN_MAIN/system/delmodule'); ?>",
