<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Saleservice\consultList.html";i:1510652716;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		...
		<td style="line-height:33px;">
			...
			咨询类型：
			<select id="ct_id" class="select-common w100">
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					html += '<tr class="tr-title"><td class="td-'+ data["data"][i]["consult_id"]+'"><input value="'
						...
						+ '" name="sub" data-state="'+data["data"][i]["state"]+'" type="checkbox" style="margin-left:15px;"></td>';
