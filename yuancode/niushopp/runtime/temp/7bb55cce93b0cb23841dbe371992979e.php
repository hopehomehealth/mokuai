		...
		<div class="goods-infor">
			<div class="cart-title">
				<h3>
					...
					<a href="javascript:;" class="vivi-blue js-goback-cart"><?php echo lang('back'); ?><?php echo lang('goods_cart'); ?><?php echo lang('edit'); ?></a>
				</h3>
			</div>
