<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Promotion\pointConfig.html";i:1501579282;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<div>
							<input id="integrat_money" class="input-mini input-common" type="number" min="0.01" step="0.01" value="<?php echo $pointconfiginfo['convert_rate']; ?>">元的余额
				...
				<tr>
					...
					<td>
						<div><textarea id="integrat_description" class="input-common" ><?php echo $pointconfiginfo['desc']; ?></textarea></div>
					</td>
				</tr>
			</tbody>
		</table>
...
function SavepointConfig(){
	...
	if(validation){
		$.ajax({
			type:"post",
			url : "<?php echo __URL('ADMIN_MAIN/promotion/pointconfig'); ?>",
			data : {
