<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Goods\attributelist.html";i:1512008311;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function setAttributeField(id, name, e){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/goods/setattributefield'); ?>",
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td style="width:10%;"><input type="number" style="width:50px;text-align:center;" class="input-common" id="sort" value="' + data["data"][i]["sort"] + '" onchange="setAttributeField('+data["data"][i]["attr_id"]+', \'sort\', this);"/></td>';
					if(data["data"][i]["is_use"]){
						html += '<td style="width:10%;"><a href="javascript:;" class="is_use" id="isuse_'+data["data"][i]["attr_id"]+'" is_use="0" onclick="setAttributeField('+data["data"][i]["attr_id"]+', \'is_use\', this)"><img src="ADMIN_IMG/checked.png" alt="" width="15"/></a></td>';
					}else{
						html += '<td style="width:10%;"><a href="javascript:;" class="is_use" id="isuse_'+data["data"][i]["attr_id"]+'" is_use="1" onclick="setAttributeField('+data["data"][i]["attr_id"]+', \'is_use\', this)"><img src="ADMIN_IMG/un_checked.png" alt="" width="15"/></a></td>';
					}
	...
	$("#dialog").dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/goods/deleteattr'); ?>",
					data : { 'attr_id' : attr_id },
					dataType : "json",
					success : function(data) {
						if (data['code'] > 0) {
 							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/goods/attributelist'); ?>");
						}else if(data['code'] == 0){
