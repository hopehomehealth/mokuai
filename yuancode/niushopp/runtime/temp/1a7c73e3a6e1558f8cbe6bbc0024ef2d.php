<?php if (!defined('THINK_PATH')) exit(); /*a:19:{s:39:"template/shop\blue\Goods\goodsList.html";i:1511599934;s:28:"template/shop\blue\base.html";i:1510626415;s:32:"template/shop\blue\urlModel.html";i:1510819885;s:34:"template/shop\blue\controlTop.html";i:1511140622;s:41:"template/shop\blue\controlHeadSerach.html";i:1512114673;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1503280183;s:43:"template/shop\blue\controlHeadGoodType.html";i:1506594225;s:40:"template/shop\blue\controlCommonNav.html";i:1502706001;s:43:"template/shop\blue\controlRightSidebar.html";i:1510626415;s:60:"template/shop\blue\Goods\controlGoodsCategoryConditions.html";i:1506507872;s:46:"template/shop\blue\Goods\controlGoodsLeft.html";i:1506672873;s:45:"template/shop\blue\Goods\controlGoodList.html";i:1511779260;s:59:"template/shop\blue\Goods\controlPopUpGoodsSkuAttribute.html";i:1502679157;s:41:"template/shop\blue\controlCommonPage.html";i:1502679157;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1506668842;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1509523953;s:37:"template/shop\blue\controlBottom.html";i:1512179372;s:36:"template/shop\blue\controlLogin.html";i:1508897749;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- <form action="" method="post" name="theForm"> -->
	...
	<div class="search-wrap" id="attr-list-ul" style="border-top: none;">
		...
		<dl class="selected-attr-dl" style="border-bottom: none;">
			<dt><?php echo lang('goods_selected_condition'); ?>：</dt>
			<dd class="moredd">
				<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist','category_id='.$category_id); ?>"><?php echo lang('goods_revoke_all'); ?></a>
			</dd>
			<dd>
		...
		<dl id="attr-group-dl-brand">
			<dt style="line-height:40px;"><?php echo lang('goods_brand'); ?>：</dt>
			<dd class="moredd">
				<label id="brand-more"></label>
				<label>
					<a href="javascript:void(0)" class="multiple" onclick="showDuoXuan('#attr-group-dl-brand');">
					<font class="duo-b">+</font> <?php echo lang('goods_multiselect'); ?>
					</a>
				</label>
			</dd>
			<dd>
			...
			<?php endif; ?>
				<label>
					...
					<font class="duo-b"></font> <?php echo lang('goods_more'); ?>
					</a>
				</label>
			</dd>	
			<dd class="moredd hide hideover">
				<label>
					...
					<font class="duo-b"></font> <?php echo lang('goods_stop'); ?>
					</a>
				</label>
			</dd>
				...
				<dd>
					...
					<div id="brand-abox-father">
						<ul class="brand-abox-imgul" style="overflow: hidden;">
							...
							<li class="brand <?php if($k >= 9): ?> overli hide<?php endif; ?>" title="<?php echo $value; ?>" data-attr = "attr<?php echo $key; ?>" data-attr_value_id ="<?php echo $vo['attr_value_id']; ?>" data-attr-value="<?php echo $vo['attr_value_name']; ?>" data-attr-value-name="<?php echo $value; ?>" onclick="attrSelect(this);">
								<a href="javascript:;" >
								<?php echo $value; ?>
		...
		<dl>
			<dt><?php echo lang('goods_price'); ?>：</dt>
			<dd class="moredd">&nbsp;</dd>
			<dd>
				<ul>
					...
					<li>
						...
						<a class="select-button" href="javascript:searchConditions();"><?php echo lang('goods_determine'); ?></a>
					</li>
				</ul>
			</dd>
		</dl>
...
<!-- 					<div class="sell-out"></div> -->
					...
					<div class="p-img">
						<a target="_blank" title="<?php echo $goodsinfo['goods_name']; ?>" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goodsinfo['goods_id']); ?>">
							<img src="<?php echo __IMG($goodsinfo['pic_cover_mid']); ?>" >
						</a>
					</div>
					<div class="p-name">
		...
		<form method="get" name="listform" action="" style="position: relative;">
			<div class="fore1">
				...
				<?php if($order=='ng.sales'): ?>
					<dd class="curr">
					<?php if($sort=='asc'): ?>
						<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.sales&sort=desc'.$attr_url); ?>"><?php echo lang('goods_sales_volume'); ?>
						<b style="background-position:-23px -169px"></b>
					<?php else: ?>
						<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.sales&sort=asc'.$attr_url); ?>"><?php echo lang('goods_sales_volume'); ?>
				...
				<?php if($order=='ng.is_new'): ?>
					<dd class="curr">
						<?php if($sort=='asc'): ?>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.is_new&sort=desc'.$attr_url); ?>"><?php echo lang('goods_new'); ?>
							<b style="background-position:-23px -169px"></b>
						<?php else: ?>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.is_new&sort=asc'.$attr_url); ?>"><?php echo lang('goods_new'); ?>
							<b class="icon-order-DESCending"></b>
						<?php endif; else: ?>
						<dd>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.is_new&sort=desc'.$attr_url); ?>"><?php echo lang('goods_new'); ?>
				...
				<?php if($order=='ng.price'): ?>
					<dd class="curr">
						<?php if($sort=='asc' && $order=='ng.price'): ?>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.price&sort=desc'.$attr_url); ?>"><?php echo lang('goods_price'); ?>
							<b style="background-position:-23px -169px"></b>
							
						<?php else: ?>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.price&sort=asc'.$attr_url); ?>"><?php echo lang('goods_price'); ?>
							<b class="icon-order-DESCending"></b>
						<?php endif; else: ?>
					<dd>
							<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist?'.$url_parameter_not_order.'&order=ng.price&sort=desc'.$attr_url); ?>"><?php echo lang('goods_price'); ?>
			...
			<ul class="clearfix">
				<li class="thumb">
					<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goods['goods_id']); ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>">
						<img src="<?php echo __IMG($goods['pic_cover_mid']); ?>" class="pic_img_206" style="display: inline;">
					</a>
				</li>
				<li class="goodsName">
				...
				<li class="list_price"><?php echo lang('goods_market_value'); ?>： <font class="market">￥<?php echo $goods['market_price']; ?></font><br> <?php echo lang('goods_shop_price'); ?>： <font class="shop">￥<?php echo $goods['promotion_price']; ?></font> <br></li>
				<li class="action">
				...
				<div class="item-con">
					...
					<div class="item-pic">
						<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goods['goods_id']); ?>" title="<?php echo $goods['goods_name']; ?>" target="_blank">
							<img src="<?php echo __IMG($goods['pic_cover_mid']); ?>">
						</a>
					</div>
					<div class="item-info">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_24262__=1;$__FOR_END_24262__=$page_count+1;for($i=$__FOR_START_24262__;$i < $__FOR_END_24262__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_16964__=1;$__FOR_END_16964__=$page_num+1;for($i=$__FOR_START_16964__;$i < $__FOR_END_16964__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_24381__=$page_count-$page_num+1;$__FOR_END_24381__=$page_count+1;for($i=$__FOR_START_24381__;$i < $__FOR_END_24381__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_10692__=$page-($page_num-1)/2;$__FOR_END_10692__=$page+($page_num-1)/2+1;for($i=$__FOR_START_10692__;$i < $__FOR_END_10692__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
			...
			<?php endif; ?>
				...
				<div class="p-img">
					<a target="_blank" title="<?php echo $vo['goods_name']; ?>" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$vo['goods_id']); ?>">
						<img alt="" src="<?php echo __IMG($vo['pic_cover_mid']); ?>">
					</a>
					</div>
					<div class="p-name">
			...
			<ul id="history_list" class="history-panel none">
				...
				<?php else: if(is_array($member_histrorys) || $member_histrorys instanceof \think\Collection || $member_histrorys instanceof \think\Paginator): $i = 0; $__LIST__ = $member_histrorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li>
						<div class="p-img">
							<a target="_blank" title="<?php echo $vo['goods_name']; ?>" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$vo['goods_id']); ?>">
								<img alt="<?php echo $vo['goods_name']; ?>" src="<?php echo __IMG($vo['picture_info']['pic_cover_mid']); ?>">
							</a>
						</div>
						<div class="p-name">
							<a target="_blank" title="<?php echo $vo['goods_name']; ?>" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$vo['goods_id']); ?>"><?php echo $vo['goods_name']; ?></a>
