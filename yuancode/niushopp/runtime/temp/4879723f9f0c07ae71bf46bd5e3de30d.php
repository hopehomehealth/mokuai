<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Member\accountList.html";i:1504094702;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __url('ADMIN_MAIN/member/accountlist'); ?>",
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td style="text-align:left;">'+ data["data"][i]["number"] +'</td>';	
					html += '<td style="text-align:left;">'+ data["data"][i]["text"] +'</td>';
