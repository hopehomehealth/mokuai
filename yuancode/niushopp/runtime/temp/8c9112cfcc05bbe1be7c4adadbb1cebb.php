<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Config\uploadType.html";i:1512114660;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<div class="config-box config-data2">
		...
		<dl>
			<dt>Accesskey：</dt>
			<dd>
				<input id="Accesskey" type="text"  value="<?php echo $config_data['data']['qiniu']['Accesskey']; ?>" class="input-common" />
		...
		<dl>
			<dt>Secretkey：</dt>
			<dd>
				<input id="Secretkey" type="text" value="<?php echo $config_data['data']['qiniu']['Secretkey']; ?>" class="input-common" />
		...
		<dl>
			<dt>Bucket：</dt>
			<dd>
				<input id="Bucket" type="text"  value="<?php echo $config_data['data']['qiniu']['Bucket']; ?>" class="input-common" />
		...
		<dl>
			<dt>Url：</dt>
			<dd>
				<input id="QiniuUrl" type="text"  value="<?php echo $config_data['data']['qiniu']['QiniuUrl']; ?>" class="input-common" />
...
function setQiniuConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/config/setQiniuConfig'); ?>",
		data : {
			"Accesskey" : Accesskey,
			'Secretkey' : Secretkey,
			"Bucket" : Bucket,
