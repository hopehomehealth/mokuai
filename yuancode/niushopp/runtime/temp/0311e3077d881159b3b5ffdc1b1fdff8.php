<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\webConfig.html";i:1512023239;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<!-- 	</dl> -->
	...
	<dl>
		...
		<dd>
			...
			<p class="hint" style="color: orange;">伪静态只支持pathinfo模式，如果开启伪静态，请选择pathinfo模式
</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div class="total">
				...
				<label for="navigationtype3"><input type="radio" value="3" name="navigationtype" id="navigationtype3" <?php if($website['web_status'] == 3): ?>checked<?php endif; ?>/>关闭后访问WAP端</label>
			</div>
	...
	<dl>
		...
		<dd>
			<div class="total">
				...
				<label for="waptype3"><input type="radio" value="3" name="waptype" id="waptype3" <?php if($website['wap_status'] == 3): ?>checked<?php endif; ?>/>关闭后访问PC端</label>
			</div>
			<p class="hint">暂时将站点关闭，其他人无法访问，但不影响管理员访问</p>
		</dd>
	</dl>
