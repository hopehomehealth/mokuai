<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Wchat\materialMessage.html";i:1508414473;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<tr>
	<th width="20%" style="text-align: left;">
		<button class="btn-common btn-small" style="margin:0 5px 0 0 !important;" onclick="location.href='<?php echo __URL('ADMIN_MAIN/wchat/addmedia'); ?>';">添加消息</button>
	</th>
	<th width="10%">
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/wchat/materialmessage'); ?>",
		...
		buttons: {
			"确定": function() {
				$(this).dialog('close');
					$.ajax({
						type : "post",
						url : "<?php echo __URL('ADMIN_MAIN/wchat/deleteweixinmedia'); ?>",
						data : {"media_id" : media_id},
						success : function(res){
							if(res>0){
								showMessage('success', "操作成功", "<?php echo __URL('ADMIN_MAIN/wchat/materialmessage'); ?>");
							}else{
