<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"template/adminblue\Config\pictureUploadSetting.html";i:1512114660;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style" style="padding-top:100px;">
	...
	<dl>
		...
		<dd>
			...
			<?php endif; if($info['thumb_type'] == 3): ?>
			...
			<?php endif; if($info['thumb_type'] == 4): ?>
			...
			<?php endif; if($info['thumb_type'] == 6): ?>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/config/pictureUploadSetting'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] > 0){
				showMessage('success', data["message"], "<?php echo __URL('ADMIN_MAIN/config/pictureUploadSetting'); ?>");
			}else{
