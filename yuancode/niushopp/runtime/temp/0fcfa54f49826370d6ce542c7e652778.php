<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\Account\orderAccountCount.html";i:1505282560;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<style  type="text/css">
.total-table{width:80%;margin:40px auto;border:1px solid #e5e5e5;}
.total-table tr td{height:40px;line-height:40px;text-align:center;width:25%;}
</style>
...
<div class="total">
	<table class="total-table">
		...
		<tr>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=day&type=sale'); ?>"><?php echo $account['day']['order_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=day&type=refund'); ?>"><?php echo $account['day']['order_refund_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=day&type=account'); ?>"><?php echo $account['day']['order_account']; ?></a></td>
		</tr>
	</table>
	<table class="total-table">
		<tr>
		...
		<tr>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=week&type=sale'); ?>"><?php echo $account['week']['order_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=week&type=refund'); ?>"><?php echo $account['week']['order_refund_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=week&type=account'); ?>"><?php echo $account['week']['order_account']; ?></a></td>
		</tr>
	</table>
	<table class="total-table">
		<tr>
		...
		<tr>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=month&type=sale'); ?>"><?php echo $account['month']['order_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=month&type=refund'); ?>"><?php echo $account['month']['order_refund_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=month&type=account'); ?>"><?php echo $account['month']['order_account']; ?></a></td>
		</tr>
	</table>
	<table class="total-table">
		<tr>
		...
		<tr>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=all&type=sale'); ?>"><?php echo $account['all']['order_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=all&type=refund'); ?>"><?php echo $account['all']['order_refund_sum']; ?></a></td>
			<td><a href="<?php echo __URL('ADMIN_MAIN/account/orderrecordslist','time=all&type=account'); ?>"><?php echo $account['all']['order_account']; ?></a></td>
		</tr>
	</table>
</div>
