<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:39:"template/shop\blue\Goods\goodsInfo.html";i:1513846980;s:28:"template/shop\blue\base.html";i:1510626415;s:32:"template/shop\blue\urlModel.html";i:1510819885;s:34:"template/shop\blue\controlTop.html";i:1511140622;s:41:"template/shop\blue\controlHeadSerach.html";i:1512114673;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1503280183;s:43:"template/shop\blue\controlHeadGoodType.html";i:1506594225;s:40:"template/shop\blue\controlCommonNav.html";i:1502706001;s:43:"template/shop\blue\controlRightSidebar.html";i:1510626415;s:44:"template/shop\blue\Goods\controlGallery.html";i:1506650621;s:46:"template/shop\blue\Goods\controlStoreRank.html";i:1503280183;s:49:"template/shop\blue\Goods\controlGoodEvaluate.html";i:1510794918;s:45:"template/shop\blue\controlCommonPageAjax.html";i:1502679157;s:55:"template/shop\blue\Goods\controlPurchaseConsulting.html";i:1510281310;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1506668842;s:50:"template/shop\blue\Goods\controlGoodsInfoData.html";i:1513846981;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1509523953;s:37:"template/shop\blue\controlBottom.html";i:1512179372;s:36:"template/shop\blue\controlLogin.html";i:1508897749;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="spec-items">
		...
		<?php if(!(empty($goods_info['sku_picture_list']) || (($goods_info['sku_picture_list'] instanceof \think\Collection || $goods_info['sku_picture_list'] instanceof \think\Paginator ) && $goods_info['sku_picture_list']->isEmpty()))): ?>
			...
			<?php if(is_array($goods_info['sku_picture_list']) || $goods_info['sku_picture_list'] instanceof \think\Collection || $goods_info['sku_picture_list'] instanceof \think\Paginator): if( count($goods_info['sku_picture_list'])==0 ) : echo "" ;else: foreach($goods_info['sku_picture_list'] as $key=>$img): if(is_array($img['album_picture_list']) || $img['album_picture_list'] instanceof \think\Collection || $img['album_picture_list'] instanceof \think\Paginator): if( count($img['album_picture_list'])==0 ) : echo "" ;else: foreach($img['album_picture_list'] as $k=>$p): if($k==0): ?>
					...
					<?php endif; ?>
							<img src="<?php echo __IMG($p['pic_cover_micro']); ?>" data_big_img="<?php echo __IMG($p['pic_cover_big']); ?>" data-picture-id="<?php echo $p['pic_id']; ?>"/>
						</li>
		...
		<!-- 否则显示商品组图 -->
			<?php if(is_array($goods_info['img_list']) || $goods_info['img_list'] instanceof \think\Collection || $goods_info['img_list'] instanceof \think\Paginator): if( count($goods_info['img_list'])==0 ) : echo "" ;else: foreach($goods_info['img_list'] as $k=>$img): if($k==0): ?>
				...
				<li>
				<?php endif; ?>
					<img src="<?php echo __IMG($img['pic_cover_micro']); ?>" data_big_img="<?php echo __IMG($img['pic_cover_big']); ?>" data-picture-id="<?php echo $img['pic_id']; ?>" />
				</li>
			...
			<form action="" method="post" name="formBuyNow" id="formBuyNow">
				...
				<div class="goods-price">
					...
					<div class="prom-gift" >
						...
						<div class="dd">
							<span class="prom-gift-label">
								<em><?php echo $goods_info['max_buy']; ?><?php echo lang('goods_piece'); ?></em>
							</span>
						</div>
					</div>
					...
					<div class="prom-gift" >
						...
						<div class="dd">
							<span class="prom-gift-label">
								<em><?php echo $goods_info['min_buy']; ?><?php echo lang('goods_piece'); ?></em>
							</span>
						</div>
					</div>
	...
	<!-- 						</div> -->
		...
		<!-- 							<span class="title"><?php echo lang('discount'); ?></span>	 -->
									...
									<div class="coupon" style="float: right;">
										<i></i><p><?php echo $vo['money']; ?><?php echo lang('shop_coupon_full'); ?><?php echo $vo['at_least']; ?><?php echo lang('meta_utility'); ?><a href="javascript:;" onclick="coupon_receive(this,<?php echo $vo['coupon_type_id']; ?>)" data-money="<?php echo $vo['money']; ?>" data-at-least="<?php echo $vo['at_least']; ?>" data-start-time="<?php echo date('Y.m.d',$vo['start_time']); ?>"  data-end-time="<?php echo date('Y.m.d',$vo['end_time']); ?>" data-max-fetch="<?php echo $vo['max_fetch']; ?>" data-receive-quantity="<?php echo $vo['receive_quantity']; ?>" class="coupon<?php echo $vo['coupon_type_id']; ?>">  <?php echo lang('receive'); ?></a></p>
									</div>
					...
					<dl class="amount">
						...
						<dd class="dd">
							<span class="amount-widget">
								...
								<span class="amount-unit"><?php echo lang('goods_piece'); ?></span>
							</span>
							<?php if($goods_info['is_stock_visible'] == 1): ?>
							<em class="stock js-goods-number"><?php echo lang('goods_stock'); ?><?php echo $goods_info['stock']; ?><?php echo lang('goods_piece'); ?></em>
							<?php endif; if($goods_info['max_buy']!=0): ?>
							<!-- 限购 -->
							<em style="vertical-align: middle;">(<?php echo lang('goods_restriction_per_person'); ?><?php echo $goods_info['max_buy']; ?><?php echo lang('goods_piece'); ?>)</em>
							<?php endif; if($goods_purchase_restriction['code'] == 0): ?>
							<div style="color:red;"><?php echo lang('goods_restriction_per_person'); ?><?php echo $goods_info['max_buy']; ?><?php echo lang('goods_piece'); ?>，<?php echo lang('goods_exceeded_the_limit_number'); ?></div>
							<?php endif; ?>
						</dd>
					</dl>
					<!-- 限购提示语 -->
			...
			for(var i=0;i<data['data'].length;i++){
				...
				listhtml+='<div class="goods-comment">'
					...
					if(dataitem["user_img"] != "" && dataitem['user_img'] != undefined && dataitem['user_img'] != 0){
						listhtml+='<img src="'+__IMG(dataitem['user_img'])+'">';
					}else{
						listhtml+='<img src="__TEMP__/<?php echo $style; ?>/public/images/default_user_portrait_0.png">';
					}
					listhtml+='</div>'
					+'<div class="name-box">'
					+'<em>'+member_name+'</em>'
	...
	function initSku(){
		...
		for (i = 0; i < parseInt($("#goods_sku_count").val()); i++) {
			...
			if (curr_sku_count == sku_count) {
				...
				$(".js-goods-number").text("<?php echo lang('goods_stock'); ?>"+select_stock+"<?php echo lang('goods_piece'); ?>");
	...
	if($("#hidden_uid").val()==''){
		...
		if(data_max_fetch != 0 && data_receive_quantity>= data_max_fetch){
			layer.open({
				...
				content: '<div class="tip-info"><div class="left"><i class="receiveTip"></i></div><div class="right"><p class="coupon_desc"><?php echo lang('reached_the_limit'); ?>！</p><p class="my_coupon"><?php echo lang('view_the_collar_coupons'); ?>：<a href="SHOP_MAIN/member/vouchers" target="_blank"><?php echo lang('my_discount_information'); ?></a></p></div></div>'
