<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"template/adminblue\Wchat\config.html";i:1510890795;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div style="padding:30px;">
	...
	<div class="binding">
		<div class="input-prepend control-group">
			...
			<input class="span2 input-common" id="appid" placeholder="AppID" value="<?php echo $wchat_config['appid']; ?>" type="text" style="width:150px;">
			<span class="help-inline" id="appiderror" style="color:red;"></span>
		</div>
		<div class="mt8"></div>
		<div class="input-prepend control-group">
			<span class="add-on"><i class="icon-lock"></i></span>
			<input class="span2 input-common" id="appsecret" type="text" placeholder="Appsecret" value="<?php echo $wchat_config['appsecret']; ?>" style="width:150px;">
	...
	<div class="serve">
		<dl>
			<dt>URL:</dt>
			<dd>
				<input class="text" style="background-color: white; border: none;min-width: 400px;display: inline-block;" readonly="readonly" id="empowerUrl" value="<?php echo $call_back_url; ?>">
				<button onclick="JScopy('empowerUrl')" type="button" class="btn">复制</button>
			</dd>
			<dt>Token:</dt>
			<dd>
				<input type="text" class="input-common" style="background-color: white; min-width: 386px;display: inline-block;" id="empowerToken" value="<?php echo $wchat_config['token']; ?>" maxlength="32" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" onpaste="return false">
				<button onclick="JScopy('empowerToken')" type="button" class="btn">复制</button><span class="help-inline" id="tokenerror" style="color:red;"></span>
...
function save() {
	...
	if(appid.length < 100 && appsecret.length < 100){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/wchat/setinstancewchatconfig'); ?>",
