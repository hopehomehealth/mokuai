<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Config\partyLogin.html";i:1512013747;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tbody>
		<tr>
			...
			<?php endif; ?>
			<td style="text-align: center;line-height:59px;">
				<a href="<?php echo __URL('ADMIN_MAIN/config/loginconfig','type=wchat'); ?>">配置</a>
			</td>
		</tr>
		<tr>
			<td>
			...
			<?php endif; ?>
			<td style="text-align: center;line-height:59px;">
				<a href="<?php echo __URL('ADMIN_MAIN/config/loginconfig','type=qq'); ?>">配置</a>
			</td>
		</tr>
	</tbody>
</table>
...
function set_status(type,event){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/setstatus'); ?>",
