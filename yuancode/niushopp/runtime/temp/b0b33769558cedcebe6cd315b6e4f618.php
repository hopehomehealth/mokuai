<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\Config\shopNavigationList.html";i:1508414185;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/addshopnavigation'); ?>';">添加导航栏</button>
</div>
...
//分页数据
 function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/shopnavigationlist'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/config/delshopnavigation'); ?>",
...
function load(){
	$('.num').change(function(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('ADMIN_MAIN/config/modifyshopnavigationsort'); ?>",
