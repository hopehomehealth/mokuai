<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Goods\goodsGroupList.html";i:1512008311;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1506689787;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/goods/addgoodsgroup'); ?>';">添加商品标签</button>
</div>
...
$(".table-class input").live("change",function(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/goods/modifygoodsgroupfield'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url:"<?php echo __URL('ADMIN_MAIN/goods/deletegoodsgroup'); ?>",
					data:{'group_id':group_id},
					dataType : "json",
					success:function (data) {
						if(data['code'] > 0){
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/goods/goodsgrouplist'); ?>");
						}else{
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/goods/goodsGroupList'); ?>",
		data : {
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html +='<td style="text-align: center;"><input type="number" class="sort" fieldid="'+data["data"][i]['group_id']+'" fieldname="sort" value="'+data["data"][i]['sort']+'" size="1"></td>';	
				...
				html += '<tr align="center"><th colspan="3" style="text-align: center;font-weight: normal;background:#ffffff;">';
