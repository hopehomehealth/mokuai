        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>发布文章</h3>
                    </div>
                </div>

<form action="/index.php/Admin/News/tianjia" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <input type="date" class="input-large" name="datetime">-><input type="date" class="input-large" name="endtime">
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <label>
                    <input type="radio" class="ace" name="auth" checked="checked" value="0">
                    <span class="lbl">所有人</span>
                </label>
                <label>
                    <input type="radio" class="ace" name="auth" value="1">
        ...
        <!-- <div class="form-group">
            ...
            <div class="controls pull-left">
                <label>
                    <input type="radio" class="ace" name="is_tui" checked="checked" value="0">
                    <span class="lbl">否</span>
                </label>
                <label>
                ...
                <span class="help-inline red"> * 首页推荐只显示一条, 按排序显示第一条</span>
            </div>
        </div> -->
        <div class="form-group">
        ...
        <div class="controls pull-left">
            <select class="input-medium" name="cat_id">
                ...
                <?php if(is_array($catlist)): foreach($catlist as $key=>$v): if($v["pid"] == 0): ?><option value='<?php echo ($v["cat_id"]); ?>' disabled style="color:#999"><?php echo ($v["cat_name"]); ?></option>
                    <?php else: ?>
                        <option value='<?php echo ($v["cat_id"]); ?>' style="color:black">　　<?php echo ($v["cat_name"]); ?></option><?php endif; endforeach; endif; ?>
            </select>
            <span class="help-inline red"> * </span>
        </div>
    </div>
   ...
   <!-- <div class="form-group">
        ...
        <div class="controls pull-left">
            ...
            <label>
                <input type="radio" class="ace" name="is_lunbo" checked="checked" value="1">
                <span class="lbl">否</span>
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            ...
            <div id="pic_div1"><img id='pic_lunbo' width='100' height='100'></div>
        </div>
    </div>
    <script type='text/javascript'>
        $(function(){
