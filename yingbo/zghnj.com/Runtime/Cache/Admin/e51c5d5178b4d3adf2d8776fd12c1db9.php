        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>产品列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Product/tianjia">添加产品</a></div>
                    </div>
                </div>

                <form class="form-horizontal"  action="/index.php/Admin/Product/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th width="55px"><div align="center">名称</div></th>
                        <th width="55px"><div align="center">图片</div></th>
                        <th width="45px"><div align="center">分类</div></th>
                    ...
                    <?php if(is_array($products)): foreach($products as $k=>$v): ?><tr>
                            <td><div align="center"><?php echo ($v["pdt_id"]); ?></div></td>
                            <td><div align="center"><?php echo ($v["pdt_name"]); ?></div></td>
                            <td><div align="center"><img src="<?php echo ($v["logo"]); ?>" width='50' height='50'/></div></td>
                            <td><div align="center"><a href="<?php echo U('Product/showlist',array('type_id'=>$v['type_id']));?>"> <?php echo ($v["type_name"]); ?></a></div></td>
                            <?php if($v["is_show"] == 1): ?><td><div align="center"><i class="icon-ok bigger-130 green"></i></div> </td>
                                <?php else: ?>
                            ...
                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/index.php/Admin/Product/upd/pdt_id/<?php echo ($v["pdt_id"]); ?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" onclick="return confirm('确定删除？')" href="/index.php/Admin/Product/del/pdt_id/<?php echo ($v["pdt_id"]); ?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </div>
                            </td>
