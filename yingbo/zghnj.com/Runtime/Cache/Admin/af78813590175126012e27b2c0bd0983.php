        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>幻灯片添加</h3>
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="page-content box">
                            ...
                            <form action="/index.php/Admin/Slide/tianjia" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        ...
                                        <span class="help-inline green">  </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <select class="input-medium" name="cat_id">
                                            ...
                                            <?php if(is_array($category)): foreach($category as $key=>$v): ?><option value='<?php echo ($v["cat_id"]); ?>' style="color:black"><?php echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        ...
                                        <div id="pic_div"><img id='pic_img' width='320' height='150'></div>
                                    </div>
                                    
                                    <div class="controls pull-left">
                                        <input type="file" class="input-large" id="picmobile" name="picmobile" ><span class="help-inline red"> * 必填,移动端</span>
                                        <div id="pic_divmobile"><img id='pic_imgmobile' width='320' height='150'></div>
                                    </div>
                                </div>
                                <script type='text/javascript'>
                                    $(function(){
