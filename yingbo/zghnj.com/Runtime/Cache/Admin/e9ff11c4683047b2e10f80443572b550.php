        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>新增管理员</h3>
                    </div>
                </div>
                <form action="/index.php/Admin/Manager/tianjia.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group" id="brand-tab-show">
