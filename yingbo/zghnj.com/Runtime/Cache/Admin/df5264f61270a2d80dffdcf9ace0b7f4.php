    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form action="/index.php/Admin/Member/add_auth" method="post" enctype='multipart/form-data' class="form-horizontal">
            ...
            <span class="help-inline red"> * 添加顶级权限,此处不填</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            ...
                            <label><input type="radio" name="is_menu" value="1" checked>&nbsp;&nbsp;是</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="is_menu" value="0">&nbsp;&nbsp;否</label>
                            </label>
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
