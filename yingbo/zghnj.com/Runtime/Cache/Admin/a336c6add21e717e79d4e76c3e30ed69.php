        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>编辑分类</h3>
                    </div>
                </div>

                <form action="/index.php/Admin/Product/upd_type/type_id/7.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="type_id" value="<?php echo ($info["type_id"]); ?>">
                    <div class="form-group">
                        <label class="control-label">名　　称 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="type_name" value="<?php echo ($info["type_name"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_show" <?php if($v["is_show"] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_show" <?php if($v["is_show"] == 1): ?>checked="checked"<?php endif; ?> value="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="sort" value="<?php echo ($v["sort"]); ?>">
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
