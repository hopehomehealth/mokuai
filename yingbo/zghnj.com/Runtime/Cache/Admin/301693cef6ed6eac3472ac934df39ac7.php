            ...
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>权限列表</h3>
                         <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Member/add_auth">添加权限</a></div>
                    </div>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" ><div align="center">权限ID</div></th>
                        ...
                        <th width="50px"><div align="center">控制器</div></th>
                        <th width="50px"><div align="center">操作方法</div></th>
                        <th width="100px"><div align="center">全路径</div></th>
                        <th width="20px"><div align="center">等级</div></th>
                        <th width="20px"><div align="center">菜单</div></th>
                        <th width="80px"><div align="center">操作</div></th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td><div align="center"><?php echo ($v['is_menu']?"<b style='color:green'>是</b>":"<b style='color:red'>否</b>"); ?></div></td>
                            <td>
                                <div  align="center" class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd_auth',array('auth_id'=>$v['auth_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del_auth',array('auth_id'=>$v['auth_id']));?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
