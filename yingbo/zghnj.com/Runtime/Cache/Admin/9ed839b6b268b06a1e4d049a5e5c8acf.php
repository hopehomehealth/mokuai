        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>新闻类别列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/News/add_type">添加分类</a></div>
                    </div>
                </div>

                <form class="form-horizontal"  action="/index.php/Admin/News/typelist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><div align="center"><?php echo ($v["type_id"]); ?></div></td>

                            <td><div align="center"><?php echo ($v["type_name"]); ?></div></td>
                            ...
                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="green" href="<?php echo U('upd_type',array('type_id'=>$v['type_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del_type',array('type_id'=>$v['type_id']));?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </div>
                            </td>
