        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>角色列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Member/add_role">添加角色</a></div>
                    </div>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="5px"><div align="center">id</div></th>
                        ...
                        <th width="100px">权限ids</th>
                        <th width="100px">权限ac</th>
                        <th width="60px"><div align="center">操作</div></th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><div align="center"><?php echo ($v["role_id"]); ?></div></td>
                            <td><div align="center"><?php echo ($v["role_name"]); ?></div></td>
                            <td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo ($v["role_auth_ids"]); ?>"><?php echo ($v["role_auth_ids"]); ?></td>
                            <td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo ($v["role_auth_ac"]); ?>"><?php echo ($v["role_auth_ac"]); ?></td>
                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;分配权限 </a>
                                    <a class="red detail" href="<?php echo U('del_role',array('role_id'=>$v['role_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </div>
                            </td>
