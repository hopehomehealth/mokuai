        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>新闻类别修改</h3>
                    </div>
                </div>

                <form action="/index.php/Admin/News/upd_type/type_id/2.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="brand_id" value="<?php echo ($info["brand_id"]); ?>">
