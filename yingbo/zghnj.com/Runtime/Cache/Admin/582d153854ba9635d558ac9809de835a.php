        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>添加栏目</h3>
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="page-content box">
                            ...
                            <form action="/index.php/Admin/Category/add" method="post" class="form-horizontal" enctype="multipart/form-data">
                           
                                <div class="form-group">
                                    <label class="control-label">名　　称 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="cat_name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <select name='pid'>
                                            ...
                                            <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><option value='<?php echo ($v["cat_id"]); ?>'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="ctrl">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="action">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <textarea style="width:500px;height:100px" name="introduce"></textarea>
                                        <span class="help-inline red"> </span>
                                    </div>
                                </div>
