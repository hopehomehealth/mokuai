    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form action="/index.php/Admin/News/upd/news_id/40/nowpage/1.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="date" class="input-large" name="datetime" value="<?php echo ($info["datetime"]); ?>">-><input type="date" class="input-large" name="endtime" value="<?php echo ($info["endtime"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="address" value="<?php echo ($info["address"]); ?>">
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="sort" value="<?php echo ($info["sort"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="auth" <?php echo ($info['auth']?"":"checked"); ?> value="0">
                                <span class="lbl">所有人</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="auth" <?php echo ($info['auth']?"checked":""); ?> value="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_show" <?php if($info["is_show"] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_show" <?php if($info["is_show"] == 1): ?>checked="checked"<?php endif; ?> value="1">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_tui" <?php if($info["is_tui"] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                <span class="lbl">否</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_tui" <?php if($info["is_tui"] == 1): ?>checked="checked"<?php endif; ?> value="1">
                                <span class="lbl">是</span>
                            </label>
                        </div>
                    </div> -->
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            ...
                            <div id="pic_div"><img id='pic_img' src='<?php echo (SITE_URL); echo ($info["pic"]); ?>' onerror="this.src='<?php echo (IMG_URL); ?>imgerror.png'" width='100' height='100'></div>
                        </div>
                    </div>
                    <script type='text/javascript'>
                        $(function(){
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <select class="input-medium" name='cat_id'>
                                ...
                                <?php if(is_array($catlist)): foreach($catlist as $key=>$v): if($v["pid"] == 0): ?><option value='<?php echo ($v["cat_id"]); ?>' disabled style="color:#999"><?php echo ($v["cat_name"]); ?></option>
                                    <?php else: ?>
                                        <option value='<?php echo ($v["cat_id"]); ?>' style="color:black" <?php if(($info["cat_id"]) == $v["cat_id"]): ?>selected='selected'<?php endif; ?>>　　<?php echo ($v["cat_name"]); ?></option><?php endif; endforeach; endif; ?>
                            </select>
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
            ...
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
             'preview', 'searchreplace', 'drafts'
               ...
               <!--     <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_lunbo" <?php if($v["is_lunbo"] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_lunbo" <?php if($v["is_lunbo"] == 1): ?>checked="checked"<?php endif; ?> value="1">
                                <span class="lbl">否</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            ...
                            <div id="pic_div1"><img id='pic_lunbo' src='<?php echo (SITE_URL); echo (substr($info["pic_lunbo"],2)); ?>' width='100' height='100'></div>
                        </div>
                    </div>
                    <script type='text/javascript'>
                        $(function(){
