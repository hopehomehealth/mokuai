        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>编辑栏目</h3>
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="page-content box">
                            ...
                            <form action="/index.php/Admin/Category/upd/cat_id/12.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                           
                                <div class="form-group">
                                    <label class="control-label">名　　称 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="cat_name" value="<?php echo ($catinfo["cat_name"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <select name='pid'>
                                            ...
                                            <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><option value='<?php echo ($v["cat_id"]); ?>' <?php if($v['cat_id'] == $catinfo['pid']): ?>selected<?php endif; ?>><?php echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        <span class="help-inline red"> * 子分类必选, 顶级分类不选!!!!!!</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">控制器名 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="ctrl" value="<?php echo ($catinfo["ctrl"]); ?>">
                                        <span class="help-inline red"> 首字母大写 </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">方法名 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="action" value="<?php echo ($catinfo["action"]); ?>">
                                        <span class="help-inline red"> 子栏目必填 </span>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    <label class="control-label">链　　接 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" name="href" value="<?php echo ($catinfo["href"]); ?>" style="width:400px">
                                        <span class="help-inline red">  </span>
                                    </div>
                                </div> -->
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="sort" value="<?php echo ($catinfo["sort"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left" style="padding-top:6px">
                                        <label>
                                            <input type="radio" class="ace" name="is_show" value="1" <?php echo ($catinfo['is_show']?"checked":""); ?>>
                                            <span class="lbl">是</span>
                                        </label>
                                        <label>
                                            <input type="radio" class="ace" name="is_show" value="0" <?php echo ($catinfo['is_show']?"":"checked"); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <textarea style="width:500px;height:100px" name="introduce"><?php echo ($catinfo["introduce"]); ?></textarea>
                                        <span class="help-inline red"> </span>
                                    </div>
                                </div>
