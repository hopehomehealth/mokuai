        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>应用客户</h3>
                         <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/link/add">添加客户</a></div>
                    </div>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr><th width="30px" ><div align="center">链接ID</div></th>
                        <th width="100px"><div align="center">名　称</div></th>
                    ...
                    <tbody>
                    <?php if(is_array($links)): foreach($links as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div  align="center" class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="red detail" href="<?php echo U('del',array('id'=>$v['id']));?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
