        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>幻灯片修改</h3>
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="page-content box">
                            ...
                            <form action="/index.php/Admin/Slide/upd/ad_id/4.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="control-label">栏　　目 : </label>
                                    <div class="controls pull-left">
                                        <select class="input-medium" name="cat_id">
                                            <option value='0'>首页</option>
                                            <?php if(is_array($category)): foreach($category as $key=>$v): ?><option value='<?php echo ($v["cat_id"]); ?>' <?php if($v['cat_id'] == $info['cat_id']): ?>selected<?php endif; ?> style="color:black"><?php echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        <span class="help-inline red"> * </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="file" class="input-large" id="pic" name="pic" ><span class="help-inline red"> * 必填,PC端</span>
                                        <div id="pic_div"><img src="<?php echo (SITE_URL); echo ($info["pic"]); ?>" id='pic_img' width='320' height='150'></div>
                                    </div>
                                    <div class="controls pull-left">
                                        <input type="file" class="input-large" id="picmobile" name="picmobile" >
                                        <span class="help-inline red"> * 必填,移动端</span>
                                        <div id="pic_divmobile"><img src="<?php echo (SITE_URL); echo ($info["picmobile"]); ?>" id='pic_imgmobile' width='320' height='150'></div>
                                    </div>
                                </div>
                                <script type='text/javascript'>
                                    $(function(){
                                        new uploadPreview({ UpBtn: "pic", DivShow: "pic_div", ImgShow: "pic_img" });
                                        new uploadPreview({ UpBtn: "picmobile", DivShow: "pic_divmobile", ImgShow: "pic_imgmobile" });
                                    });
                                </script>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="sort" value="<?php echo ($info["sort"]); ?>">
                                        <span class="help-inline red"> * 请输入整数数字,数字越大越靠前</span>
                                    </div>
                                </div>
                                <div>
                                    <label class="control-label"></label>
                                    <input type="hidden" name="oldpic" value="<?php echo ($info["pic"]); ?>">
                                    <input type="hidden" name="oldpicmobile" value="<?php echo ($info["oldpicmobile"]); ?>">
