    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form action="/index.php/Admin/Member/upd_auth/auth_id/39.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    ...
                    <?php if($info['auth_level'] == 0): ?><div class="form-group">
                            ...
                            <div class="controls pull-left">
                                <input type="text" class="input-large" name="auth_sort" value="<?php echo ($info["auth_sort"]); ?>">
                                <span class="help-inline red"> * 请输入整数数字</span>
                            </div>
                        </div><?php endif; ?>
                    ...
                    <div class="form-group">
                        <label class="control-label">显示到菜单栏 : </label>
                        <div class="controls pull-left">
                            <label class="control-label">
                            <label><input type="radio" name="is_menu" value="1" <?php echo ($info['is_menu']?"checked":""); ?>>&nbsp;&nbsp;是</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="is_menu" value="0" <?php echo ($info['is_menu']?"":"checked"); ?>>&nbsp;&nbsp;否</label>
                            </label>
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
