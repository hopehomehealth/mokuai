        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>修改链接</h3>
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="page-content box">
                            ...
                            <form action="/index.php/Admin/Link/upd/id/1.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                           
                                <div class="form-group">
                                    <label class="control-label">名　　称 : </label>
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="title" value="<?php echo ($linkinfo["title"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        ...
                                        <div id="pic_div"><img id='pic_img' src="<?php echo ($linkinfo["picture"]); ?>" onerror="this.src='<?php echo (IMG_URL); ?>imgerror.png'" width='250' height='100'></div>
                                    </div>
                                </div>
                                <script type='text/javascript'>
                                    $(function(){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="href" style="width:400px" value="<?php echo ($linkinfo["href"]); ?>">
                                        <span class="help-inline red">  </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left">
                                        <input type="text" class="input-medium" name="sort" value="<?php echo ($linkinfo["sort"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls pull-left" style="padding-top:6px">
                                        <label>
                                            <input type="radio" class="ace" name="show" value="1" <?php echo ($linkinfo['show']?"checked":""); ?>>
                                            <span class="lbl">是</span>
                                        </label>
                                        <label>
                                            <input type="radio" class="ace" name="show" value="0" <?php echo ($linkinfo['show']?"":"checked"); ?>>
