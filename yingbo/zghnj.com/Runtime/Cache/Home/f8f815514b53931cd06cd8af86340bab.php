...
<div class="menu-bj">
	...
	<!----banner----><div class="banner">    <?php if(is_array($slides)): foreach($slides as $key=>$slide): ?><img src="<?php echo (substr($slide["pic"],1)); ?>" alt=""><?php endforeach; endif; ?></div><!----bannerend----><!----front----><div class="su-front">    <div class="column-a">        <ul id="0" class="su-front-tit">            <?php if(is_array($category)): foreach($category as $key=>$cateinfo): ?><li <?php if(ACTION_NAME == $cateinfo['action']): ?>class="cur-a"<?php endif; ?>><a href="/index.php/Home/<?php echo ($cateinfo['ctrl']); ?>/<?php echo ($cateinfo['action']); ?>#0"><?php echo ($cateinfo["cat_name"]); ?></a></li><?php endforeach; endif; ?>        </ul>        <div class="su-content pt0">            <p class="fs24 tac ov-h pt60">活动预告</p>            <div class="prolist">                <div class="proleft"></div>                <div class="proright"></div>                <div class="probebox swiper-container-horizontal">                    <ul class="clearfix swiper-wrapper">                        <!--banner-->                      <?php if(is_array($foreshow)): foreach($foreshow as $key=>$info1): ?><li class="swiper-slide">                            <a href="/index.php/Home/News/detail/id/<?php echo ($info1["news_id"]); ?>">                                <img src="<?php echo (substr($info1["pic"],1)); ?>" alt="" onerror="this.src='/Public/Home/images/baiban.png'" />                                <h3><?php echo ($info1["title"]); ?></h3>                            </a>                        </li><?php endforeach; endif; ?>                    </ul>                </div>            </div>        </div>    </div>    <div class="su-deve-list2-bj">          <div class="column-a">              <p class="fs24 tac ov-h pt50 pb40">活动回顾</p>              <div class="su-news-b" id="scrollloading" data-scrollstatus="false" data-end="false">              <?php if(is_array($review)): foreach($review as $key=>$info2): ?><dl class="su-news-a fl">                    <dt><a href="/index.php/Home/News/detail/id/<?php echo ($info2["news_id"]); ?>"><img src="<?php echo (substr($info2["pic"],1)); ?>" alt="" onerror="this.src='/Public/Home/images/baiban.png'"></a></dt>                    <dd>                        <h3><?php echo ($info2["title"]); ?></h3>                        <p class="su-news-a-txt fl">时间：<?php echo (date("Y.m.d",strtotime($info2["datetime"]))); ?><br>                      地点：<?php echo ($info2["address"]); ?></p>                        <p class="su-lear-more fl"><a href="/index.php/Home/News/detail/id/<?php echo ($info2["news_id"]); ?>">查看详情</a></p>                    </dd>                </dl><?php endforeach; endif; ?>          </div>          <p class="news-an">              <a>查看更多</a>          </p>          <!-- <style type="text/css">                .technorati li{float:left;}              </style>          <div class="technorati fl"><?php echo ($page); ?></div> -->      </div>    </div></div><!----frontend----><script src="<?php echo (HJS_URL); ?>layout.js"></script><script type="text/javascript">  function scrollLoading(scrollloading,nowpage){    $.get("/index.php/Home/News/activities/p/"+nowpage,function(data){      if(data.error == 0){        var html = '';        for(var i in data.content){            html += '\              <dl class="su-news-a fl">\                  <dt><a href="/index.php/Home/News/detail/id/'+data.content[i].news_id+'"><img src="'+data.content[i].pic+'" alt="" onerror="this.src=\'/Public/Home/images/baiban.png\'"></a></dt>\                  <dd>\                      <h3>'+data.content[i].title+'</h3>\                      <p class="su-news-a-txt fl">时间：'+data.content[i].datetime+'<br>\                    地点：'+data.content[i].address+'</p>\                      <p class="su-lear-more fl"><a href="/index.php/Home/News/detail/id/'+data.content[i].news_id+'">查看详情</a></p>\                  </dd>\              </dl>\            ';        }        scrollloading.append(html);      }else{        scrollloading.data('end',true);        $(".news-an").html('没有更多');      }      scrollloading.data('scrollstatus',false);    });  }  $(function(){    var scrollloading = $("#scrollloading");//放数据的容器    var scrollstatus = false;    var nowpage = 1;    $(".news-an").click(function () {      nowpage++;      if(!scrollloading.data('end')){        scrollLoading(scrollloading,nowpage);      }    });  });</script>
<!--footer-->
<div class="footer">
    <div class="column">
        <ul class="sumenu fl">
