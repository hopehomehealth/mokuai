...
<div class="menu-bj">
	...
	<!----banner----><div class="banner">    <?php if(is_array($slides)): foreach($slides as $key=>$slide): ?><img src="<?php echo (substr($slide["pic"],1)); ?>" alt=""><?php endforeach; endif; ?></div><!----bannerend----><!----front----><div class="su-front">    <div class="column-a">        <ul id="0" class="su-front-tit">            <?php if(is_array($category)): foreach($category as $key=>$cateinfo): ?><li <?php if((ACTION_NAME == $cateinfo['action']) OR ((ACTION_NAME == 'detail') AND ($cateinfo['action'] == 'product'))): ?>class="cur-a"<?php endif; ?>><a href="/index.php/Home/<?php echo ($cateinfo['ctrl']); ?>/<?php echo ($cateinfo['action']); ?>#0"><?php echo ($cateinfo["cat_name"]); ?></a></li><?php endforeach; endif; ?>        </ul>        <div class="su-content pt0">            <p class="su-deve fs24" style="margin-top:30px"><strong class=""><?php echo ($detail["pdt_name"]); ?></strong></p>            <div class="su-serv-fina fl">                <?php echo ($detail["introduce"]); ?>            </div>        </div>    </div>    <?php if(!empty($photos)): ?><div class="su-deve-list2-bj">          <div class="column-a">              <div class="prolist">                  <div class="proleft"></div>                  <div class="proright"></div>                  <div class="probebox swiper-container-horizontal">                      <ul class="clearfix swiper-wrapper">                          <!--banner-->                          <?php if(is_array($photos)): foreach($photos as $key=>$info): ?><li class="swiper-slide">                                  <a>                                      <img src="<?php echo ($info["url"]); ?>" alt="" />                                  </a>                              </li><?php endforeach; endif; ?>                          <!--banner-->                      </ul>                  </div>              </div>          </div>    </div><?php endif; ?></div><!--frontend--><script src="<?php echo (HJS_URL); ?>layout.js"></script>
<!--footer-->
<div class="footer">
    <div class="column">
        <ul class="sumenu fl">
