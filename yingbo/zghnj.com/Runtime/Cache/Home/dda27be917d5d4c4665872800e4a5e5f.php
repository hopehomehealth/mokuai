...
<div class="menu-bj">
	...
	<!----banner----><div class="banner">    <?php if(is_array($slides)): foreach($slides as $key=>$slide): ?><img src="<?php echo (substr($slide["pic"],1)); ?>" alt=""><?php endforeach; endif; ?></div><!----bannerend----><!----front----><div class="su-front">    <div class="column-a">        <ul id="0" class="su-front-tit">            <?php if(is_array($category)): foreach($category as $key=>$cateinfo): ?><li <?php if(ACTION_NAME == $cateinfo['action']): ?>class="cur-a"<?php endif; ?>><a href="/index.php/Home/<?php echo ($cateinfo['ctrl']); ?>/<?php echo ($cateinfo['action']); ?>#0"><?php echo ($cateinfo["cat_name"]); ?></a></li><?php endforeach; endif; ?>        </ul>        <div class="su-content">            <p class="su-deve"><span class="fs30 pr15">引入权威的缓粘结产品应用检测机构</span></p>            <p class="su-deve-txt">　　缓粘结预应力以产品应用检测为手段，以此验证缓粘结的优异性能，保障缓粘结的技术应用。<br/>　　缓粘结预应力包含钢材、胶粘剂、塑料3类材料性能检测，以及缓粘结预应力混凝土构件性能检测，检测内容项涉及的专业度较高，国内具有上述综合检测资质的机构屈指可数。</p>            <dl class="su-deve-list4" style="padding-top:0;padding-bottom:50px">                <dd>                    <h3>检测项目</h3>                </dd>                <dt><img src="<?php echo (HIMG_URL); ?>img_checkitem.png" alt=""></dt>            </dl>            <div class="su-deve-list3">                <span class="su-deve-list3-img fl"><img src="<?php echo (HIMG_URL); ?>images_62.jpg" alt=""></span>                <span class="su-deve-list3-txt pr10 fr">                    <h3>洁净室净化工程</h3>                     IT、消费类电子、新能源、石油精化、生物医药、食品、日化、汽车制造、航空航天等核心行业。展望未来，公司将立足高端制造业，加强国内外技术合作，不断提升自主研发与生产工艺的核心技术能力，贴近客户需求，助力中国智造，持续为社会提供领先科技、节能环保的高性能新材料与工业洁净环境解决方案服务，致力成为国际领先、以新材料为本<br><br>                     覆盖上下游业务领域的行业综合服务商，创造人类高效、智能、环保的美好生活。T、消费类电子、新能源、石油精化、生物医药、食品、日化、汽车制造、航空航天等核心行业。展望未来，公司将立足高端制造业，加强国内外技术合作，不断提升自主研发与生产工艺的核心技术能力，贴近客户需求，助力中国智造，持续为社会提供领先科技、<br><br>                     节能环保的高性能新材料与工业洁净环境解决方案服务，致力成为国际领先、以新材料为本，覆盖上下游业务领域的行业综合服务商，创造人类高效、智能、环保的美好生活。                </span>            </div>            <div class="su-deve-list3">                <span class="su-deve-list3-img fr"><img src="<?php echo (HIMG_URL); ?>images_62.jpg" alt=""></span>                <span class="su-deve-list3-txt w540 pl35 fl">                     <h3>洁净室净化工程</h3>                     IT、消费类电子、新能源、石油精化、生物医药、食品、日化、汽车制造、航空航天等核心行业。展望未来，公司将立足高端制造业，加强国内外技术合作，不断提升自主研发与生产工艺的核心技术能力，贴近客户需求，助力中国智造，持续为社会提供领先科技、节能环保的高性能新材料与工业洁净环境解决方案服务，致力成为国际领先、以新材料为本<br><br>                     覆盖上下游业务领域的行业综合服务商，创造人类高效、智能、环保的美好生活。T、消费类电子、新能源、石油精化、生物医药、食品、日化、汽车制造、航空航天等核心行业。展望未来，公司将立足高端制造业，加强国内外技术合作，不断提升自主研发与生产工艺的核心技术能力，贴近客户需求，助力中国智造，持续为社会提供领先科技、<br><br>                     节能环保的高性能新材料与工业洁净环境解决方案服务，致力成为国际领先、以新材料为本，覆盖上下游业务领域的行业综合服务商，创造人类高效、智能、环保的美好生活。                 </span>            </div>        </div>    </div></div><!----frontend---->
<!--footer-->
<div class="footer">
    <div class="column">
        <ul class="sumenu fl">
