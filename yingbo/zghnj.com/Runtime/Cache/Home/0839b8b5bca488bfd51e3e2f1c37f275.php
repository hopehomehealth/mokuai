...
<div class="menu-bj">
	...
	<!----banner----><div class="banner">    <?php if(is_array($slides)): foreach($slides as $key=>$slide): ?><img src="<?php echo (substr($slide["pic"],1)); ?>" alt=""><?php endforeach; endif; ?></div><!----bannerend----><!----front----><div class="su-front">    <div class="column-b">        <?php if($detail['cat_id'] != 0): ?><ul id="0" class="su-front-tit">                <?php if(is_array($category)): foreach($category as $key=>$cateinfo): ?><li <?php if($detail['cat_id'] == $cateinfo['cat_id']): ?>class="cur-a"<?php endif; ?>><a href="/index.php/Home/<?php echo ($cateinfo['ctrl']); ?>/<?php echo ($cateinfo['action']); ?>#0"><?php echo ($cateinfo["cat_name"]); ?></a></li><?php endforeach; endif; ?>            </ul>        <?php else: ?>            <ul id="0" class="su-front-tit">                <li class="cur-a"><a>关注热点</a></li>            </ul><?php endif; ?>        <div class="su-content">             <div class="su-news-tit">                 <h1><?php echo ($detail["title"]); ?></h1>                 <span class="su-news-diz"><?php echo (date("Y年m月d日 i:s",$detail["upd_time"])); ?> <?php echo ($author); ?></span>             </div>             <div class="su-news-nrq">                 <?php echo ($detail["content"]); ?>             </div>             <div class="su-news-fhui">                 <p class="news-an">                     <a href="javascript:history.go(-1)">返回</a>                 </p>                 <p class="su-news-qihou">                    <?php if(!empty($prenews)): ?><a class="w40 fl" href="/index.php/Home/News/detail/id/<?php echo ($prenews["news_id"]); ?>"><span class="blue">上一篇：</span><?php echo ($prenews["title"]); ?></a><?php endif; ?>                    <?php if(!empty($nextnews)): ?><a class="w40 tar fr" href="/index.php/Home/News/detail/id/<?php echo ($nextnews["news_id"]); ?>"><span class="blue">下一篇：</span><?php echo ($nextnews["title"]); ?></a><?php endif; ?>                 </p>             </div>        </div>    </div></div><!----frontend---->
<!--footer-->
<div class="footer">
    <div class="column">
        <ul class="sumenu fl">
