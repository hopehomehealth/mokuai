...
<div class="main">
    ...
    <!--*****menuend*****-->
    <!--*****su-con*****-->
    <section class="su-case pt0-45" id="scrollloading" data-scrollstatus="false" data-end="false">
        <?php if(is_array($news)): foreach($news as $key=>$info): ?><dl class="su-anal b-lgray1">
                <?php if(($info['pic'] == './Public/Upd/news/') OR ($info['pic'] == '')): else: ?>
                    <dt><a href="/index.php/Wap/Communicate/detail/id/<?php echo ($info["news_id"]); ?>"><img src="<?php echo (substr($info["pic"],1)); ?>" alt=""></a></dt><?php endif; ?>
                <dd>
                    <h3><?php echo ($info["title"]); ?></h3>
                    <p>
                        <?php echo ($info["content"]); ?>
                    </p>
                    <span class="su-news-more b-bule"><a href="/index.php/Wap/Communicate/detail/id/<?php echo ($info["news_id"]); ?>">查看详情</a></span>
                </dd>
...
<script type="text/javascript">
  function scrollLoading(scrollloading,nowpage){
    $.get("/index.php/Wap/Communicate/analysis/p/"+nowpage,function(data){
      $("#loading").remove();
      if(data.error == 0){
        var html = '';
        for(var i in data.content){
            ...
            if((data.content[i].pic == '/Public/Upd/news/') || (data.content[i].pic == '')){          
                ...
                img = '<dt><a href="/index.php/Wap/Communicate/detail/id/'+data.content[i].news_id+'"><img src="'+data.content[i].pic+'"></a></dt>';
            }
            html += '\
                <dl class="su-anal b-lgray1">'+img+'\
                    <dd>\
                        <h3>'+data.content[i].title+'</h3>\
                        <p>\
                            '+data.content[i].content+'\
                        </p>\
                        <span class="su-news-more b-bule"><a href="/index.php/Wap/Communicate/detail/id/'+data.content[i].news_id+'">查看详情</a></span>\
                    </dd>\
                </dl>\
            ';
        }
