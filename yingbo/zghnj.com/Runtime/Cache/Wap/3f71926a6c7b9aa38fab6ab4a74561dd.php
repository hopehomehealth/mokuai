...
<div class="main">
    ...
    <section class="su-con">
        <div class="su-fron">
            <div class="su-deve">
                <h4>汇集优质的缓粘结材料与机具供应商</h4>
            </div>
            <p class="fs0-28 c-blue">缓粘结预应力以材料为基础，以此实现缓粘结的优异性能，带动缓粘结的技术发展</p>
            <p>　　缓粘结预应力以材料为基础，以此实现缓粘结的优异性能，带动缓粘结的技术发展。<br/>　　缓粘结预应力产品涉及预应力钢绞线、环氧胶粘剂、高密度聚乙烯、锚夹具、张拉机具5大领域，业务范围广、专业跨度大。<br/>　　中国缓粘结网汇集优质的缓粘结材料与机具供应商，形成强大的产业联盟，为客户提供从材料选型到产品应用的一站式专业服务。</p>
            <p><img src="<?php echo (WIMG_URL); ?>images_08.jpg" alt=""></p>
            <p class="fs0-28 c-blue pb0-1">成员企业</p>
            <p class="pt0-15">
                <img src="<?php echo (WIMG_URL); ?>images_09.jpg" alt="">
                <span class="tac d-ib w100 pt0-15">触控行业</span>
            </p>
            <p class="pt0-15">
                <img src="<?php echo (WIMG_URL); ?>images_10.jpg" alt="">
                <span class="tac d-ib w100  pt0-15">行业综合服务商</span>
            </p>
            <p class="pt0-15">
                <img src="<?php echo (WIMG_URL); ?>images_11.jpg" alt="">
                <span class="tac d-ib w100  pt0-15">功能胶带</span>
            </p>
        </div>
