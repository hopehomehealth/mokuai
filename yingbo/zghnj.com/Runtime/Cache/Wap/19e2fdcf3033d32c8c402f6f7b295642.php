...
<div class="main">
    ...
    <section class="su-case b-white" id="scrollloading" data-scrollstatus="false" data-end="false">
        <?php if(is_array($news)): foreach($news as $key=>$info): ?><dl class="su-news">
                ...
                <dd>
                    ...
                    <span class="su-news-more b-bule"><a  href="/index.php/Wap/News/detail/id/<?php echo ($info["news_id"]); ?>">查看详情</a></span>
                </dd>
...
<script type="text/javascript">
  function scrollLoading(scrollloading,nowpage){
    $.get("/index.php/Wap/News/industries/p/"+nowpage,function(data){
      $("#loading").remove();
      if(data.error == 0){
        var html = '';
