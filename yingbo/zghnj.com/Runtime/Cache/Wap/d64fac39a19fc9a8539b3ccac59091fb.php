...
<div class="main">
    ...
    <section class="su-con">
        <div class="su-fron pb0-25">
            <div class="su-deve">
                <h4>引入权威的缓粘结产品应用检测机构</h4>
            </div>
            <p>　　缓粘结预应力以产品应用检测为手段，以此验证缓粘结的优异性能，保障缓粘结的技术应用。<br/>　　缓粘结预应力包含钢材、胶粘剂、塑料3类材料性能检测，以及缓粘结预应力混凝土构件性能检测，检测内容项涉及的专业度较高，国内具有上述综合检测资质的机构屈指可数。</p>
            <p class="fs0-28 c-blue hl0-05 pt0-35">检测项目</p>
            <p><img src="<?php echo (HIMG_URL); ?>img_checkitem.png" alt=""></p>
            <p class="pb0 dan"><img src="<?php echo (WIMG_URL); ?>images_05.jpg" alt=""></p>
            <div class="w100 pt0-35 b-lgray">
                <p class="fs0-28 c-blue hl0-05 plr">中纪委7月连打13虎 连平2项最高纪录</p>
                <p class="plr">至于2015年2月被处分的11人，分别是江西省政协副主席许爱民、广东省政协原主席朱明国、济南市委原书记王敏山西省委原常委陈川平、全国政协原副主席苏荣、山西原副省长杜善学、天津市公安局原局长武长顺、黑龙江省人大常委会原副主任隋凤富、河南省人大常委会原副主任秦玉海山西省委原秘书长聂春玉。<br>
                    至于2015年2月被处分的11人，分别是江西省政协副主席许爱民、广东省政协原主席朱明国、济南市委原书记王敏山西省委原常委陈川平、全国政协原副主席苏荣、山西原副省长杜善学、天津市公安局原局长武长顺、黑龙江省人大常委会原副主省委统战部原部长白云。</p>
