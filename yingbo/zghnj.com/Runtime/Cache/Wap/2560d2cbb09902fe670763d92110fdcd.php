...
<div class="main">
    ...
    <section class="su-con" id="scrollloading" data-scrollstatus="false" data-end="false">
        <?php if(is_array($news)): foreach($news as $key=>$info): ?><dl class="su-lear">
                <dt><a href="/index.php/Wap/Technology/detail/id/<?php echo ($info["news_id"]); ?>"><img src="<?php echo (substr($info["pic"],1)); ?>" alt="" onerror="this.src='/Public/Home/images/baiban.png'"></a></dt>
                <dd>
                    <h3><?php echo ($info["title"]); ?></h3>
                    <?php echo ($info["content"]); ?>
                    <p class="su-lear-more fl">
                        <a href="/index.php/Wap/Technology/detail/id/<?php echo ($info["news_id"]); ?>">查看详情</a>
                    </p>
                </dd>
...
<script type="text/javascript">
  function scrollLoading(scrollloading,nowpage){
    $.get("/index.php/Wap/Technology/academicForum/p/"+nowpage,function(data){
      $("#loading").remove();
      if(data.error == 0){
        var html = '';
        for(var i in data.content){
            html += '\
              <dl class="su-lear"><dt><a href="/index.php/Wap/Technology/detail/id/'+data.content[i].news_id+'"><img src="'+data.content[i].pic+'" alt="" onerror="this.src=\'/Public/Home/images/baiban.png\'"></a></dt>\
                <dd>\
                    <h3>'+data.content[i].title+'</h3>\
                    '+data.content[i].content+'\
                    <p class="su-lear-more fl">\
                        <a href="/index.php/Wap/Technology/detail/id/'+data.content[i].news_id+'">查看详情</a>\
                    </p>\
                </dd>\
            </dl>\
            ';
