    ...
    <section class="su-con">
        <div class="su-fron">
            ...
            <div class="su-news-sx">
                <?php if(!empty($prenews)): ?><p><a href="/index.php/Wap/Technology/detail/id/<?php echo ($prenews["news_id"]); ?>"><span class="c-blue">上一篇：</span><?php echo ($prenews["title"]); ?></a></p><?php endif; ?>
                <?php if(!empty($nextnews)): ?><p><a href="/index.php/Wap/Technology/detail/id/<?php echo ($nextnews["news_id"]); ?>"><span class="c-blue">下一篇：</span><?php echo ($nextnews["title"]); ?></a></p><?php endif; ?>
            </div>
        </div>
