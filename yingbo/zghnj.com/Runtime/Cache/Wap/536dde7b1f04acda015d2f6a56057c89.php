...
<div class="main">
    ...
    <section class="su-con pb0">
        <div class="su-product pb0-25">
            <div class="su-deve">
                <h4><strong><?php echo ($detail["pdt_name"]); ?></strong></h4>
            </div>
            <?php echo ($detail["introduce"]); ?>
        </div>
    </section>
    <?php if(!empty($photos)): ?><section  class="w100 b-lgray1">
        <div class="su-serv-fina">
            <div class="prolist">
