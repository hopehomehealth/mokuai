...
jQuery151.fn.extend({
    calendar: function(c) {
        function r() {
            jQuery151("#" + c.controlId).find(".tabD a").mouseup(function() {
                var a = new Date(jQuery151("#" + c.controlId).find(".currentYear").text() + "/" + jQuery151("#" + c.controlId).find(".currentMonth").text() + "/1");
                if (jQuery151(this).hasClass("prevD")) {
                    a.setMonth(a.getMonth() - 1);
                    a.setDate(jQuery151(this).text());
                    var b = c.speed;
                    c.speed = 0;
                    jQuery151("#" + c.controlId).find(".prevMonth").triggerHandler("mouseup");
                    c.speed = b
                } else if (jQuery151(this).hasClass("nextD")) {
                    a.setMonth(a.getMonth() + 1);
                    a.setDate(jQuery151(this).text());
                    b = c.speed;
                    c.speed = 0;
                    jQuery151("#" + c.controlId).find(".nextMonth").triggerHandler("mouseup");
                    c.speed = b
                }
                var d = jQuery151(this).text();
                a = a.getFullYear() + "-" + (Number(a.getMonth() + 1) < 10 ? "0" + Number(a.getMonth() + 1) : Number(a.getMonth() + 1)) + "-" + (Number(d) < 10 ? "0" + d: d);
                n.val(a);
                jQuery151("#" + c.controlId + " div table a").removeClass("select");
                jQuery151("#" + c.controlId + " .tabD a:contains('" + d + "')").each(function() {
                    d == jQuery151(this).text() && !jQuery151(this).hasClass("prevD") && !jQuery151(this).hasClass("nextD") && jQuery151(this).addClass("select")
                });
                jQuery151("#" + c.controlId).hide();
                c.callback()
            }).hover(function() {
                jQuery151(this).addClass("hover")
            },
            function() {
                jQuery151(this).removeClass("hover")
            })
        }
        function u() {
            jQuery151("#" + c.controlId).find(".tabM a").mouseup(function() {
                var a = s(Number(jQuery151("#" + c.controlId).find(".currentYear").text()), Number(jQuery151(this).attr("val")));
                D(a);
                r();
                jQuery151("#" + c.controlId).find(".currentMonth").text(Number(jQuery151(this).attr("val")) + 1)
            }).hover(function() {
                jQuery151(this).addClass("hover")
            },
            function() {
        ...
        function v() {
            jQuery151("#" + c.controlId).find(".tabY a").mouseup(function() {
                var a = s(Number(jQuery151(this).text()), Number(jQuery151("#" + c.controlId).find(".currentMonth").text()) - 1);
                D(a);
                r();
                jQuery151("#" + c.controlId).find(".currentYear").text(Number(jQuery151(this).text()))
            }).hover(function() {
                jQuery151(this).addClass("hover")
            },
            function() {
        ...
        function B(a) {
            var b = jQuery151("#" + c.controlId).find(".reserve"),
            d = jQuery151("#" + c.controlId).find(".enabled");
            b.stop();
            d.stop();
        ...
        function w() {
            ...
            var a = n.val();
            a = a.replace(re, "jQuery1511/jQuery1513/jQuery1515@").split("@")[0];
            return new Date(a)
        }
        function F(a) {
            var b = [];
        ...
        c = jQuery.extend({
            controlId: jQuery151(this).attr("id") + "Calendar",
            speed: 200,
            complement: true,
            readonly: true,
            upperLimit: NaN,
        ...
        k += "  </div>";
        k += "</div>";
        jQuery151("body").append(k);
        r();
        jQuery151("#" + c.controlId).find(".prevMonth").mouseup(function() {
            if (jQuery151("#" + c.controlId).find(".enabled > .tabD").length > 0) {
                var a = jQuery151("#" + c.controlId).find(".currentYear"),
                b = jQuery151("#" + c.controlId).find(".currentMonth"),
                ...
                r()
            } else if (jQuery151("#" + c.controlId).find(".enabled > .tabM").length > 0) {
                d = z(Number(jQuery151("#" + c.controlId).find(".currentYear").text()) - 1);
                C(d);
                u();
                jQuery151("#" + c.controlId).find(".currentYear").text(Number(jQuery151("#" + c.controlId).find(".currentYear").text()) - 1)
            } else if (jQuery151("#" + c.controlId).find(".enabled > .tabY").length > 0) {
                d = A(Number(jQuery151("#" + c.controlId).find(".currentYear").text()) - 10);
                C(d);
                v();
                jQuery151("#" + c.controlId).find(".currentYear").text(Number(jQuery151("#" + c.controlId).find(".currentYear").text()) - 10)
            }
        });
        jQuery151("#" + c.controlId).find(".nextMonth").mouseup(function() {
            if (jQuery151("#" + c.controlId).find(".enabled > .tabD").length > 0) {
                var a = jQuery151("#" + c.controlId).find(".currentYear"),
                b = jQuery151("#" + c.controlId).find(".currentMonth"),
        ...
        jQuery151("#" + c.controlId).find(".currentMonthText").mouseup(function() {
            if (! (jQuery151("#" + c.controlId).find(".enabled > .tabM").length > 0)) {
                var a = z(Number(jQuery151("#" + c.controlId).find(".currentYear").text()));
                E(a);
                u()
            }
        });
        jQuery151("#" + c.controlId).find(".currentYearText").mouseup(function() {
            if (! (jQuery151("#" + c.controlId).find(".enabled > .tabY").length > 0)) {
                var a = A(Number(jQuery151("#" + c.controlId).find(".currentYear").text()));
                E(a);
                v()
            }
        });
        n.bind("click focus",
        function() {
            if (jQuery151("#" + c.controlId + ":hidden").length != 0) {
                jQuery151(".calendar").hide();
                var a = jQuery151("#" + c.controlId),
                b = F(n[0]),
                ...
                d = jQuery151("#" + c.controlId).width();
                b = jQuery151("#" + c.controlId).height();
                a.width(0);
                a.height(0);
                a.show().animate({
                    width: d + "px",
        ...
        jQuery151(document).mouseup(function(a) {
            if (jQuery151(a.target).attr("id") != n.attr("id") && (jQuery151(a.target).parentsUntil("#" + c.controlId).parent().length == 0 || jQuery151(a.target).parentsUntil("#" + c.controlId).parent()[0].id != c.controlId)) jQuery151("#" + c.controlId).hide()
        })
    }
});