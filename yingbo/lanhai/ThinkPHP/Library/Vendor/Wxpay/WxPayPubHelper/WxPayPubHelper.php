...
class Common_util_pub
{
	...
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	public $SSLCERT_PATH = './cacert/apiclient_cert.pem';
	public $SSLKEY_PATH = './cacert/apiclient_key.pem';
	//=======【JSAPI路径设置】===================================
	...
	function __construct($config) {
		if(isset($config['appid'])){
			...
			if(isset($config['js_api_call_url'])){
				$this->JS_API_CALL_URL = $config['js_api_call_url'];
			}
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			/*$this->APPID = 'wx8feeae09185108a5';
			//受理商ID，身份标识
			$this->MCHID = '1268042901';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = '30z2tnnjefdaecvxtpyhd25nn4ihyfvd';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'eebb5185c1b72d508f0d3376e183b0dc';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
