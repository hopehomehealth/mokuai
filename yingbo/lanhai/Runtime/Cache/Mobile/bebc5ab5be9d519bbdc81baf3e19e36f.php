...
<div class="main">
  ...
  <div class="for-c fl">
    <ul class="for-t fl">
      <li class="cur"><a href="/index.php/Mobile/Bbs/blog">长青博客</a></li>
      <li><a href="/index.php/Mobile/Bbs/bbs">巅峰论剑</a></li>
      <li><a href="/index.php/Mobile/Bbs/mingjia">名家讲坛</a></li>
      <li><a href="/index.php/Mobile/Bbs/renwu">蓝海人物</a></li>
    </ul>
    <div class="for-con cur" id="recordslist">
      <?php if(is_array($articles)): foreach($articles as $key=>$info): ?><dl class="for-list fl">
        <dt><a href="/index.php/Mobile/Blog/myzone/user_id/<?php echo ($info["user_id"]); ?>"><img src="<?php echo ($info["userhead"]); ?>"></a></dt>
        <dd>
          <p class="w100" style="padding-bottom:1.5rem"><a href="/index.php/Mobile/Blog/detail/art_id/<?php echo ($info["art_id"]); ?>"><?php echo ($info["title"]); ?></a></p>
          <p class="w100 fl"><span class="fl w35 t-w"><a href="/index.php/Mobile/Blog/myzone/user_id/<?php echo ($info["user_id"]); ?>" style="color:#004084"><?php echo ($info["username"]); ?></a></span><span class="fl pl1 fs1"><?php echo (date("Y-m-d H:s",$info["add_time"])); ?></span><span class="fr for-list-tb"></span> </p>
        </dd>
...
<script type="text/javascript">
  $(function(){
    ...
    function ajax_request(nowpage){
      ...
      $.get("/index.php/Mobile/Bbs/blog",{'p':nowpage},function(data){
        if(data.error == 0){
          for(var i in data.content){

            html += "<dl class='for-list fl'><dt><a href='/index.php/Mobile/Blog/myzone/user_id/"+data.content[i].user_id+"'><img src='"+data.content[i].userhead+"'></dt><dd><p class='w100' style='padding-bottom:1.5rem'><a href='/index.php/Mobile/Blog/detail/art_id/"+data.content[i].art_id+"'>"+data.content[i].title+"</a></p><p class='w100 fl'><span class='fl w35 t-w'><a href='/index.php/Mobile/Blog/myzone/user_id/"+data.content[i].user_id+"' style='color:#004084'>"+data.content[i].username+"</a></span><span class='fl pl1 fs1'>"+data.content[i].add_time+"</span><span class='fr for-list-tb'></span> </p></dd></dl>";
          }
        }else{
          if(!haveend){
