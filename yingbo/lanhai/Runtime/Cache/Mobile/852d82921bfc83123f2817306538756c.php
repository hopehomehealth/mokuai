...
<li><a href="<?php echo ($v["url"]); ?>"><?php echo ($v["lan_title"]); ?></a></li><?php endif; endforeach; endif; ?>
    ...
    <section>
        <div class="h-l pb1 fl">
            <p class="h-l-tt">专家<span class="d-red">队伍</span></p>
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><dl class="exp-pic fl">
                   <!-- <dt><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"><br>
                        <?php echo ($v["author"]); ?></dt>
                    <dd>-->
                        <?php echo ($v["content"]); ?>
