...
<div class="main">
  ...
  <section>
    <div class="for fl bb-b">
      ...
      <p class="fr pr0-5 fs1"><?php if($_SESSION['flag']== ''): ?><a href="/index.php/Mobile/User/register">注册</a> | <a href="/index.php/Mobile/User/login">登录</a><?php else: ?><a href="/index.php/Mobile/User/ucenter"><b style="text-decoration:underline;color:#004084"><?php echo ($_SESSION['userInfo']['username']); ?></b></a> | <a href="/index.php/Mobile/User/logout">退出</a><?php endif; ?> |
  ...
  <div class="for-c fl">
    <ul class="for-t fl">
      <li><a href="/index.php/Mobile/Bbs/blog">长青博客</a></li>
      <li><a href="/index.php/Mobile/Bbs/bbs">巅峰论剑</a></li>
      <li><a href="/index.php/Mobile/Bbs/mingjia">名家讲坛</a></li>
      <li class="cur"><a href="/index.php/Mobile/Bbs/renwu">蓝海人物</a></li>
    </ul>
    <div class="for-con cur" id="recordslist">
      <?php if(is_array($famous2)): foreach($famous2 as $key=>$info4): ?><dl class="for-fig-pic fl">
        <dt><a href="/index.php/Mobile/Famous/slanders2/f_id/<?php echo ($info4["f_id"]); ?>"><img src="<?php echo ($info4["f_photo"]); ?>"></a></dt>
        <dd>
          <p class="w100 fl t-w"><a href="/index.php/Mobile/Famous/slanders2/f_id/<?php echo ($info4["f_id"]); ?>"><?php echo ($info4["f_name"]); ?></a><span class=" for-fig-gz fr pr0-5"><a href="javascript:void(0)" onclick="follow('/index.php/Mobile/Famous/follow/f_id/'+<?php echo ($info4['f_id']); ?>)"><img src="<?php echo (MIMG_URL); ?>images_22.jpg"></a></span></p>
          <p class="w100 fl l-gray fs1"><span class=" for-fig-tb"><img src="<?php echo (MIMG_URL); ?>tb_29.png"></span><?php echo ($info4["f_province"]); ?></p>
          <p class="w100 fl fs1-2"><span class="l-gray">发表文章：</span><?php echo ($info4["f_artnums"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<span class="l-gray">粉丝：</span><?php echo ($info4["f_fans"]); ?></p>
        </dd>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    function ajax_request(nowpage){
      ...
      $.get("/index.php/Mobile/Bbs/renwu",{'p':nowpage},function(data){
        if(data.error == 0){
          for(var i in data.content){

            html += "<dl class='for-fig-pic fl'><dt style='width:6.5rem;height:6.5rem;overflow:hidden'><a href='/index.php/Mobile/Famous/slanders2/f_id/"+data.content[i].f_id+"'><img style='height:6.5rem;' src='"+data.content[i].f_photo+"'></a></dt><dd><p class='w100 fl t-w'><a href='/index.php/Mobile/Famous/slanders2/f_id/"+data.content[i].f_id+"'>"+data.content[i].f_name+"</a><span class='for-fig-gz fr pr0-5'><a href='javascript:void(0)' onclick='follow(\"/index.php/Mobile/Famous/follow/f_id/"+data.content[i].f_id+"\")'><img src='<?php echo (SITE_URL); ?>/Public/Mobile/images/images_22.jpg'></a></span></p><p class='w100 fl l-gray fs1'><span class='for-fig-tb'><img src='<?php echo (SITE_URL); ?>/Public/Mobile/images/tb_29.png'></span>"+data.content[i].f_province+"</p><p class='w100 fl fs1-2'><span class='l-gray'>发表文章：</span>"+data.content[i].f_artnums+"&nbsp;&nbsp;&nbsp;&nbsp;<span class='l-gray'>粉丝：</span>"+data.content[i].f_fans+"</p></dd></dl>";
          }
        }else{
          if(!haveend){
