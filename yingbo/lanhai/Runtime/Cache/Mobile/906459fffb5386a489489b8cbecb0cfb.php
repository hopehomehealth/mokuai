...
<div class="main">
  ...
  <section>
    <div class="for fl bb-b">
      ...
      <p class="fr pr0-5 fs1"><?php if($_SESSION['flag']== ''): ?><a href="/index.php/Mobile/User/register">注册</a> | <a href="/index.php/Mobile/User/login">登录</a><?php else: ?><a href="/index.php/Mobile/User/ucenter"><?php echo ($_SESSION['userInfo']['username']); ?></a> | <a href="/index.php/Mobile/User/logout">退出</a><?php endif; ?> |
  ...
  <!--*****for-c*****-->
  <div class="for-c fl">
    <div class="for-con cur" id="recordslist" fid="<?php echo ($_GET['f_id']); ?>">
      <?php if(is_array($slanders)): foreach($slanders as $key=>$info): ?><dl class="for-list fl">
        <dd style="width:97%;">
          <p class="w100 t-w" style="padding-bottom:1.5rem"><a href="/index.php/Mobile/Famous/detail/sland_id/<?php echo ($info["sland_id"]); ?>">&nbsp;<?php echo ($info["title"]); ?></a></p>
          <p class="w100 fl"><span class="fl w30 t-w">&nbsp;<?php echo ($info["f_name"]); ?></span><span class="fr pl1"><?php echo (date("Y-m-d H:s",$info["add_time"])); ?></span><span class="fr for-list-tb"></span> </p>
        </dd>
...
<script type="text/javascript">
  $(function(){
    ...
    function ajax_request(fid,nowpage){
      ...
      $.get("/index.php/Mobile/Famous/slanders1/f_id/"+fid,{'p':nowpage},function(data){
        if(data.error == 0){
          var status = '';
          for(var i in data.content){
            html += "<dl class='for-list fl'><dt></dt><dd style='width:97%'><p class='w100 t-w pb3-5' style='padding-bottom:2.5rem'><a href='/index.php/Mobile/Famous/detail/sland_id/"+data.content[i].sland_id+"'>&nbsp;"+data.content[i].title+"</a></p><p class='w100 fl'><span class='fl w30 t-w'>&nbsp;"+data.content[i].f_name+"</span><span class='fr pl1'>"+data.content[i].nadd_time+"</span><span class='fr for-list-tb'></span> </p></dd></dl>";
          }
        }else{
          if(!haveend){
