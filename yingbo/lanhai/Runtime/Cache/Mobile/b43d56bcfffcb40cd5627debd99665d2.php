...
<div class="main">
   <section>
        <div class="nht-xl fl">
            ...
            <ul class="nht-sumenu fr">
               <?php if(is_array($catinfo)): foreach($catinfo as $key=>$v): ?><li><a href="<?php echo U('News/faguilist',array('cat_id'=>$v['cat_id']));?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
        </div>
    </section>
    <script type="text/javascript">
  ...
  <section>
    ...
    <div class="h-l pb1 fl">
      ...
      <p class="h-l-tt"><?php echo (mb_substr($info[0]['name'],0,21,'utf-8')); ?></p>


 <div class="h-l pb1 fl">
            <ul class="news-list fl">
			<div class="news-list fl" id="recordslist" totalPages="<?php echo ($totalPages); ?>">
  <?php if(is_array($info)): foreach($info as $k=>$v): ?><input type='hidden' id='cat_id' value='<?php echo ($v["cat_id"]); ?>'>
                  <li>
                       <a href="<?php echo U('News/detail',array('news_id'=>$v['news_id']));?>"><?php echo ($v["news_title"]); ?></a>
                            <p class="fl fs1 l-gray w100"><?php echo ($v["add_time"]); ?></p>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            function ajax_request(nowpage){
                ...
                $.post("/index.php/Mobile/News/faguilist/p/"+nowpage,{cat_id:cat_id},function(data){
                    if(data.error == 0){
					...
					var news_title='';
						...
						news_title = title.slice(0,21);
                            ...
                            html += "<li><a href='/index.php/Mobile/News/detail/news_id/"+data.content[i].news_id+"'>"+news_title+"</a><p class='fl fs1 l-gray w100'>"+data.content[i].add_time+"</p></li>";
                        }
                    }
