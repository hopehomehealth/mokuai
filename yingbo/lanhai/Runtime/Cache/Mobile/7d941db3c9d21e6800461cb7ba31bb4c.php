...
<div class="main">
  ...
  <div class="for-c fl">
    <ul class="for-t fl">
      ...
      <li class="cur"><a href="/index.php/Mobile/Bbs/bbs">巅峰论剑</a></li>
      <li><a href="/index.php/Mobile/Bbs/mingjia">名家讲坛</a></li>
      <li><a href="/index.php/Mobile/Bbs/renwu">蓝海人物</a></li>
    </ul>
    <div class="for-con cur">
      <?php if(is_array($boards)): foreach($boards as $key=>$info2): ?><dl class="forum-pic fl">
        <dt><a href="/index.php/Mobile/Posts/postlist/board_id/<?php echo ($info2["board_id"]); ?>"><?php if($info2["board_img"] != ''): ?><img src="<?php echo ($info2["board_img"]); ?>"><?php else: ?><img src="<?php echo (MIMG_URL); ?>images_13.png"><?php endif; ?></a></dt>
        <dd><a href="/index.php/Mobile/Posts/postlist/board_id/<?php echo ($info2["board_id"]); ?>"><?php echo ($info2["board_title"]); ?></a>
          <p class="w100 fl l-gray fs1">今日：<?php echo ($info2["todposts"]); ?>　帖数：<?php echo ($info2["posts"]); ?></p>
          <p class="w100 fl l-gray fs1-2 t-w"><a href="/index.php/Mobile/Posts/detail/post_id/<?php echo ($info2["post_id"]); ?>"><?php echo ($info2["topic"]); ?></a>  <?php echo ($info2["ctime"]); ?>  <?php echo ($info2["username"]); ?></p>
        </dd>
