...
<div class="main">
  ...
  <?php if(is_array($catinfo)): foreach($catinfo as $k=>$v): ?><div class="h-l pb1 fl">
      <p class="h-l-tt"><?php echo (mb_substr($v["name"],0,21,'utf-8')); ?><span class="fr pr2 fs1"><a href="<?php echo U('News/faguilist',array('cat_id'=>$v['cat_id']));?>">更多>></a></span></p>
      <?php if(is_array($v["info"])): foreach($v["info"] as $kk=>$vv): ?><div class="h-l pb1 fl">
