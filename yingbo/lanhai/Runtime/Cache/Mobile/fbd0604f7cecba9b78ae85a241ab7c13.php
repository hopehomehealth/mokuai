...
<li><a href="<?php echo ($v["url"]); ?>"><?php echo ($v["lan_title"]); ?></a></li><?php endif; endforeach; endif; ?>
    ...
    <section>
        <p class="abo-banner fl">
            <?php if(is_array($adinfo)): foreach($adinfo as $key=>$v): ?><img src="<?php echo (SITE_URL); echo ($v["pic_big"]); ?>"><?php endforeach; endif; ?></p>
    </section>
    <!--*****h-l*****-->
    <section>
        <div class="h-l pb1 fl">
            <p class="h-l-tt">人才<span  class="d-red">招聘</span></p>
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><div class="rec-nr fl"><span class="fs1-5 fwb"><?php echo ($v["news_title"]); ?></span><br>
                   <?php echo ($v["content"]); ?>
