...
<section>
    <form action="" id="articleform">
        <!-- <div class="post-a fl">
            <a class="post-input fl w50 post-a-img">
                <input type="file" id="selectpic" name="art_img" onchange="javascript:setImagePreview();">
                <img src="<?php echo (MIMG_URL); ?>upload.png"> </a>
            <a style="float:left;max-width:19rem;margin:1rem;height:5.75rem;overflow:hidden;display:none" id="localImag">
                <img style="height:5.75rem;width:auto!important;" id="preview" src="">
            </a>
        </div> -->
        <div class="post-a-con fl" style="min-height:25rem">
            <input name="title" style="padding:0.5rem 0;" class="post-a-tit fl" placeholder="请输入文章标题！" type="text">
            ...
            <textarea name="content" id="content" style="height:auto!important;min-height:17rem;width:100%;padding:0;border:0;" class="fl" placeholder="内容"></textarea><div style="clear:both"></div>
            <button type="button" class="fabu" onclick="subarticleform()">完成</button>
            <div style="clear:both"></div>
        </div>
        <p class="artfoot" style="text-align:center">请遵守 <a style="color:#004084" href="/index.php/Mobile/Sysconfig/gongyue">蓝海长青公约</a> 言论规则，不得违反国家法律法规</p>

    </form>
    <script type="text/javascript">
        var ue = UE.getEditor('content',{toolbars: [['bold', 'italic', 'underline','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','simpleupload']],wordCount:false,elementPathEnabled : false,initialFrameHeight:300});
    </script>
</section>
