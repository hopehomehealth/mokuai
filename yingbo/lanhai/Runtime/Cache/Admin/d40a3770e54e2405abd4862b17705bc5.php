        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>栏目修改</h3>
                    </div>
                </div>
                <form action="/index.php/Admin/Lanmu/upd/lan_id/24.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type='hidden' id='extlanids' value='<?php echo ($extlanids); ?>' />
                    <input type='hidden' name='lan_id' value='<?php echo ($info["lan_id"]); ?>' />
                <input type="hidden" name="path" value='<?php echo ($info["path"]); ?>'>
                <input type="hidden" name="level" value='<?php echo ($info["level"]); ?>'>
                    <input type="hidden" name="is_dan" value='<?php echo ($info["is_dan"]); ?>'>

 <div class="form-group">
                        <label class="control-label">名称 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="lan_title" value="<?php echo ($info["lan_title"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-mini" name="sort" value="<?php echo ($info["sort"]); ?>">
...
<br/><span class="help-inline red"> *  如果是内部链接, 此处不填</span>   </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                                ...
                                <textarea rows="5" cols="30" id='content1' name='content1' style='width:850px;height:350px;'><?php echo ($info["content1"]); ?></textarea>
                        </div>
                    </div> -->
...
<div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <select name='pid'>
                                ...
                                <?php if(is_array($laninfoA)): foreach($laninfoA as $key=>$v): ?><option value='<?php echo ($v["lan_id"]); ?>' <?php if(($info["pid"]) == $v["lan_id"]): ?>selected='selected'<?php endif; ?>>

                                        <?php echo ($v["lan_title"]); ?></option><?php endforeach; endif; ?>
                            </select>
                            <span class="help-inline red"> * 子栏目必选，顶级栏目不选</span>
                        </div>
                    </div>
                      <!--   <div class="form-group">
                        ...
                        <div class="controls pull-left">
                        <input type="text" class="input-large" name="lan_c" value="<?php echo ($info["lan_c"]); ?>">
                        <span class="help-inline red"> * </span>
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="controls pull-left">
                        <input type="text" class="input-large" name="lan_a" value="<?php echo ($info["lan_a"]); ?>">
                        <span class="help-inline red"> * </span>
                        </div>
                        </div>
</if> -->
...
<script type='text/javascript'>
    //主栏目切换显示第一个扩展栏目
    //参数now_lanid  当前商品已经选取的全部的"扩展"栏目信息
    function show_lan1(now_lanid=""){
        //获得当前选取的主栏目id信息
            ...
            $.ajax({
                ...
                success:function(msg){
                    ...
                    $.each(msg,function(){
                        ...
                        if(now_lanid.indexOf(this.lan_id)>=0){
                            s +=  " selected='selected' ";
                        }
    ...
    function show_lan2(now_lanid=""){
        ...
        if(lan_id==0){
            ...
            //让ajax带着lan_id信息，去服务器端获得子级栏目信息
            $.ajax({
                url:"/index.php/Admin/Lanmu/getCatByPid",
                data:{'lan_id':lan_id},
                dataType:'json',
                type:'get',
                async:false,
    ...
    $(function(){
        ...
        show_lan2(extlanids);   //extlanids='5,6'
    });
</script>
