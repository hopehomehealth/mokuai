        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>编辑文章</h3>
                    </div>
                </div>

                <form action="/index.php/Admin/Famous/updslander/sland_id/60.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="control-label">标题 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="title" value="<?php echo ($slander["title"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_show" value="1" <?php if($slander["is_show"] == 1): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_show" value="0"<?php if($slander["is_show"] == 0): ?>checked="checked"<?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_tui" value="1"<?php if($slander["is_tui"] == 1): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_tui" value="0"<?php if($slander["is_tui"] == 0): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">否</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" <?php echo ($slander['is_scroll']?"checked":""); ?> name="is_scroll" value="1">
                                <span class="lbl">是</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" <?php echo ($slander['is_scroll']?"":"checked"); ?> name="is_scroll" value="0">
                                <span class="lbl">否</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group selectpic" <?php if($slander["is_scroll"] == 0): ?>style="display:none"<?php else: endif; ?>>
                        <label class="control-label">文章展示图 : </label>
                        <div class="controls pull-left">
                            <div id="localImag" style="height:100px;position:relative;"><img id="preview" <?php if(($slander["is_scroll"] == '1') AND ($slander["sland_img"] != '')): ?>src="<?php echo ($slander["sland_img"]); ?>"<?php else: ?>src="<?php echo (IMG_URL); ?>qr.png"<?php endif; ?>  style="max-height: 100px;width:auto!important;"><input style="position:absolute;left:0;top:0px;width:100%;height:100%;opacity:0;cursor:pointer" onchange="javascript:setImagePreview();" type="file" id="selectpic" name="sland_img"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <span class="help-inline red">  </span>
                            <textarea rows="5" cols="30" id='content' name='content' style='width:850px;height:350px;'><?php echo ($slander["content"]); ?></textarea>
                        </div>
                    </div>
            ...
            'print', 'preview', 'searchreplace', 'drafts'
                    ...
                    <div>
                        ...
                        <input type="hidden" name="sland_id" value="<?php echo ($_GET['sland_id']); ?>">
