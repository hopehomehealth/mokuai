        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>评论管理</h3>
                    </div>
                </div>
                <form class="form-horizontal" method="get" action="/index.php/Admin/Bgcomment/showlist">
                  <div class="form-group">
                    <label class="control-label" style="width:auto;line-height:28px;padding-top:0"">关键字： </label>        
                    <div class="controls pull-left">
                      <input type="text" class="input-medium" name="search" placeholder="文章名/作者">
                    ...
                    <?php if(is_array($articles)): foreach($articles as $key=>$info): ?><tr>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                <a href="/index.php/Admin/Bgcomment/comment/art_id/<?php echo ($info["art_id"]); ?>">查看全部评论</a>
                            </div>
                        </td>
