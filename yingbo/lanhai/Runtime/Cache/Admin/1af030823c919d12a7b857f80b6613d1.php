            ...
            <div class="page-content box">
                <form action="" method="post" enctype='multipart/form-data' class="form-horizontal">
					<div class="form-group">
                      <label class="control-label">选择消息类型 : </label>
                      <select name="tuwen_id" id="tuwen" class="input-medium">
						  <option value="0">文本回复（文本）</option>
						  <?php if(is_array($tnews)): foreach($tnews as $key=>$info): ?><option value="<?php echo ($info["id"]); ?>" <?php if($info['id'] == $guanzhu['tuwen_id']): ?>selected="selected"<?php endif; ?>><?php echo ($info["title"]); ?>（图文）</option><?php endforeach; endif; ?>
                      </select>
                    </div>
                    <div class="form-group" id="wenben">
                        <label class="control-label">关注时回复语 : </label>
                        <div class="controls pull-left">
                            <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="content" ><?php echo ($guanzhu["content"]); ?></textarea>
                        </div>
                    </div>
