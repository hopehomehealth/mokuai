        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <a href="<?php echo U('showlist');?>"><h3><i class="icon-magic"></i>详情页广告列表</h3></a>
                    </div>
                </div>

                <form class="form-horizontal"  action="/index.php/Admin/Bannerx/showlist" method="post">
                    <div class="form-group">
                        ...
                        <div class="margin_bot_20" align="right">
                            <a href="<?php echo U('Bannerx/tianjia');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>广告添加</a>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="5px"><div align="center"></div></th>
                       <th width="5px"><div align="center">id</div></th>
                        ...
                        <th width="155px"><div align="center">链接地址</div></th>
                        <th width="30px"><div align="center">是否展示</div></th>
                        <th width="32px"><div align="center">添加时间</div></th>
                        <th width="32px"><div align="center">修改时间</div></th>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <?php if($v["is_area"] == 0): ?><td><div align="center"><a href="<?php echo U('Bannerx/dinglist');?>">顶部</a>  </div> </td>
                            <?php elseif($v["is_area"] == 1): ?>
                                <td><div align="center"><a href="<?php echo U('Bannerx/youyilist');?>">右下一 </a> </div> </td>
                                <?php elseif($v["is_area"] == 2): ?>
                                <td><div align="center"><a href="<?php echo U('Bannerx/youerlist');?>">右下二</a> </div> </td>
                                <?php elseif($v["is_area"] == 3): ?>
                                <td><div align="center"><a href="<?php echo U('Bannerx/yousanlist');?>">右下三</a> </div> </td><?php endif; ?>
    ...
    $(function() {
        ...
        $("#zhanshi").click(function () {
            if ($("input[name='banner_id[]']:checked").length >= 1) {
                $("#batches").attr('action', "/index.php/Admin/Bannerx/zhanshi");
                $("#batches").submit();
            } else {
                alert('请选择操作对象');
            }
        ...
        $("#yincang").click(function () {
            if ($("input[name='banner_id[]']:checked").length >= 1) {
                $("#batches").attr('action', "/index.php/Admin/Bannerx/yincang");
                $("#batches").submit();
            } else {
                alert('请选择操作对象');
            }
        ...
        $("#shanchu").click(function () {
            if ($("input[name='banner_id[]']:checked").length >= 1) {
                if (confirm('你确定要永久删除吗')) {
                    $("#batches").attr('action', "/index.php/Admin/Bannerx/del");
                    $("#batches").submit();
                }
            } else {
                alert('请选择操作对象');
