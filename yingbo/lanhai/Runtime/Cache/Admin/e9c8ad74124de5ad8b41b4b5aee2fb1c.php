        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <a href="<?php echo U('showlist');?>"><h3><i class="icon-magic"></i>友情类别</h3></a>
                    </div>
                </div>

                <!--<form class="form-horizontal"  action="/index.php/Admin/Lcat/showlist" method="post">-->
                    <!--<div class="form-group">-->

                        <!--<div class="margin_bot_20" align="right">-->
                            <!--<a href="<?php echo U('Lcat/tianjia');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>类别添加</a>-->
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td><div align="center"><?php echo ($v["cat_name"]); ?></div></td>

                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('cat_id'=>$v['cat_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <!--<a onclick="return confirm('确定要删除吗')" href="<?php echo U('del',array('cat_id'=>$v['cat_id']));?>" class="red detail"> <i class="icon-remove bigger-130"></i>&nbsp;删除 </a>-->
                                </div>
                            </div>
                            </td>
