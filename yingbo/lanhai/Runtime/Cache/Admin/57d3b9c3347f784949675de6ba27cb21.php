            ...
            <div class="page-content box">
                ...
                <div class="breadcrumbs" style="margin-bottom:20px">
                    <ul>
                        ...
                        <li class="active"> <a href="/index.php/Admin/Menu/showlist">自定义菜单 </a></li>
                ...
                <div class="margin_bot_20" style="margin-bottom:10px">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                            <td><div align="left"><?php if($v["pid"] == 0): echo ($v["title"]); else: ?><span style="color:#999">├────</span><?php echo ($v["title"]); endif; ?></div></td>
                            ...
                            <td>
                                ...
                                <?php if(($v["sort"]) == "0"): ?><a href="<?php echo U('tianjia',array('id'=>$v['id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;添加 </a><?php endif; ?>
