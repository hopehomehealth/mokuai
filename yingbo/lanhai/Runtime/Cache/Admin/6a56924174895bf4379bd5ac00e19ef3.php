    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form action="/index.php/Admin/News/upd/news_id/1029.html" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<input type='hidden' name='lanid' value='<?php echo ($info["lan_id"]); ?>' />
                    ...
                    <div class="form-group">
						...
						<span class="help-inline red"> *   图片宽度不大于720px</span>
                            ...
                            <div id="pic_div"><img id='pic_img' src='<?php echo (SITE_URL); ?>/<?php echo (substr($info["pic"],2)); ?>' width='100' height='100'><a class="red detail" href="<?php echo U('del1',array('news_id'=>$info['news_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;删除 </a></div>
    ...
    laydate({
            ...
            format: 'YYYY-MM-DD hh:mm:ss',
                    ...
                    <!--<div class="form-group">-->
                        ...
                        <!--<div class="controls pull-left">-->
                            <!--<input type="text" class="input-small" name="sort" value="<?php echo ($info["sort"]); ?>">-->
