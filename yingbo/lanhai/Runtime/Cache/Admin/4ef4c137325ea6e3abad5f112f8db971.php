    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal" method="get" action="/index.php/Admin/Reply/reply/post_id/<?php echo ($_GET['post_id']); ?>">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($reply)): foreach($reply as $key=>$info): ?><tr>
                        <td><?php echo ($No1++); ?></td>
                        ...
                        <td><?php echo ($info["reply_body"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i",$info["ctime"])); ?></td>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                <a href="javascript:void(0)" class="display" replyid="<?php echo ($info["reply_id"]); ?>" isdisplay="<?php echo ($info["display"]); ?>" class="green"><?php if($info["display"] == '1'): ?>隐藏<?php else: ?>显示<?php endif; ?> </a>
                                
                                <a href="/index.php/Admin/Reply/del/reply_id/<?php echo ($info["reply_id"]); ?>" class="red detail" onclick="return confirm('确定要删除吗')"> <i class="icon-remove bigger-130"></i>&nbsp;删除 </a>
                            </div>
                        </td>
...
$(function(){
    $(".display").click(function(){
        ...
        $.post("/index.php/Admin/Reply/isdisplay",{'display':display,'reply_id':replyid},function(data){
            if(data == 'success'){
                if(display == 1){
                    thisobj.text('显示');
