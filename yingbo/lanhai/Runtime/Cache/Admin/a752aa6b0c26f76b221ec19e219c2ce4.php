        ...
        <div class="row">
            <div class="page-content box">
                <!-- <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>关键词列表</h3>
                        <div class="pull-right">
                                                <a class="btn btn-success btn-sm" href="/index.php/Admin/Keyword/tianjia">添加关键词</a>
                                        </div>

                                        <div class="pull-right" style="margin-right:10px;">
                                                <a class="btn btn-success btn-sm" href="/index.php/Admin/Keyword/tianjia_n">添加关键词未设置时回复</a>
                                        </div>

                                        <div class="pull-right" style="margin-right:10px;">
                                                <a class="btn btn-success btn-sm" href="/index.php/Admin/Keyword/guanzhu">关注时回复</a>
                                        </div>
                    </div>
                </div> -->
                <div class="box-title margin_bot_20">
                ...
                <div class="breadcrumbs" style="margin-bottom:20px">
                    <ul>
                        <li> <a href="/index.php/Admin/Sysconfig/weixin">公众号设置 </a></li>
                        <li> <a href="/index.php/Admin/Menu/showlist">自定义菜单 </a></li>
                        <li class="active"> <a href="/index.php/Admin/Keyword/index">关键词回复 </a></li>
                        <li> <a href="/index.php/Admin/Tnews/index">图文消息回复 </a></li>
                    </ul>
                    <!-- .breadcrumb -->
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Keyword/index" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$v): ?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php if($v["keyword"] == ''): ?><font color="red">未定义时回复</font><?php else: echo ($v["keyword"]); endif; ?></td>
							<td><?php echo ($v["descs"]); ?></td>
                            <!--<td><?php echo ($v["name"]); ?></td>-->
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('id'=>$v['id'],'type'=>3));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('id'=>$v['id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
