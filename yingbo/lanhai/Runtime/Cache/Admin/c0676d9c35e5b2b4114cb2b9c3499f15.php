...
<form action="/index.php/Admin/Famous/upduser/f_id/20" method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <select class="input-medium" name="f_type">
                    ...
                    <option value='1' <?php if($famous["f_type"] == 1): ?>selected='selected'<?php endif; ?> >名家讲坛</option>
                    <option value='2' <?php if($famous["f_type"] == 2): ?>selected='selected'<?php endif; ?> >蓝海人物</option>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="f_name" value="<?php echo ($famous["f_name"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="f_province" value="<?php echo ($famous["f_province"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <div id="localImag" style="position:relative;padding-top:10px"><img id="preview" src="<?php echo ((isset($famous["f_photo"]) && ($famous["f_photo"] !== ""))?($famous["f_photo"]):'/Public/Admin/images/qr.png'); ?>"  style="max-height: 100px;"><input style="position:absolute;left:0;top:10px;width:100px;height:100px;opacity:0;cursor:pointer" onchange="javascript:setImagePreview();" type="file" id="selectpic" name="f_photo" value="">
            </div>
        </div>
    ...
    <div class="form-group">
            ...
            <div class="controls pull-left">
                <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="f_desc"><?php echo ($famous["f_desc"]); ?></textarea>
            </div>
        </div>
    <div>
        <label class="control-label"></label>
        <input type="hidden" name="f_id" value="<?php echo ($famous["f_id"]); ?>">
        <button id="bsubmit" type="submit"  class="btn btn-sm btn-primary">确认修改</button>
    </div>
</form>
            </div>
        </div>
