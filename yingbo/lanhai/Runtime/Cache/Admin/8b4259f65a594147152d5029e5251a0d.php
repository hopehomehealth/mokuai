        ...
        <div class="row">
            <div class="page-content box">
              <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>添加版块</h3>
                    </div>
                </div>
<form action="/index.php/Admin/Boards/tianjia" method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <select class="input-medium" name="pid">
                    ...
                    <?php if(is_array($boards)): foreach($boards as $key=>$bd): if($bd["pid"] == 0): ?><option style="color:black;font-weight:bold" value='<?php echo ($bd["board_id"]); ?>'><?php echo ($bd["board_title"]); ?></option>
                        <?php else: ?>
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="board_title">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <!--<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <!-- <a style="height:28px;width:150px;line-height:28px;background:#428bca;color:white;padding:8px 8px 8px 8px;border-radius:6px;position:relative;text-decoration:none">
              ...
              上传图片</a> -->
            <div id="localImag" style="height:100px;position:relative;"><img id="preview" src="<?php echo (IMG_URL); ?>qr.png"  style="max-height: 100px;"><input style="position:absolute;left:0;top:0px;width:100%;height:100%;opacity:0;cursor:pointer" onchange="javascript:setImagePreview();" type="file" id="selectpic" name="board_img"></div><span class="help-inline red"> 主板块可忽略 </span>
        </div>
    </div>
    <div>
