        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <a href="<?php echo U('showlist');?>"><h3><i class="icon-magic"></i>文章列表</h3></a>
                    </div>
                </div>

                <form class="form-horizontal" method="get" action="/index.php/Admin/Famous/slanders">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($slanders)): foreach($slanders as $k=>$v): ?><tr>
                            <td><div align="center"><input type="checkbox" name="sland_id[]" value="<?php echo ($v["sland_id"]); ?>"></div></td>
                            <td><div align="center"><?php echo ($v["sland_id"]); ?></div></td>
                            <td><div align="center"><?php echo ($v["title"]); ?></div></td>
                            <td><div align="center"><?php echo ($v["f_name"]); ?></div></td>

                            <td><div align="center"><?php if($v["f_type"] == 1): ?>名家讲坛<?php endif; if($v["f_type"] == 2): ?>蓝海人物<?php endif; ?></div></td>
                            <td><div align="center"><?php echo ($v["views"]); ?></div></td>
                            <td><div align="center"><?php echo ($v["comments"]); ?></div></td>
                            <td><div align="center"><?php echo (date('Y-m-d H:i',$v["add_time"])); ?></div></td>
                            <!--<td><div align="center"><?php echo ($v["sort"]); ?></div></td>-->
                            <?php if($v["is_show"] == 0): ?><td><div align="center"><i class="icon-remove bigger-130 red"></i></div> </td>
                                <?php else: ?>
                                <td><div align="center"><i class="icon-ok bigger-130 green"></i></div> </td><?php endif; ?>
							<?php if($v["is_tui"] == 1): ?><td><div align="center" class="green">是</div> </td>
                                <?php else: ?>
                                <td><div align="center" class="red">否</div> </td><?php endif; ?>
                            <?php if($v["is_scroll"] == 1): ?><td><div align="center" class="green">是</div> </td>
                                <?php else: ?>
                                <td><div align="center" class="red">否</div> </td><?php endif; ?>
                            ...
                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="green" href="<?php echo U('updslander',array('sland_id'=>$v['sland_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="green" href="<?php echo U('comments',array('sland_id'=>$v['sland_id']));?>"> <i class="icon-eye-open bigger-130"></i>&nbsp;评论管理 </a>
    ...
    $(function() {
        ...
        $("#zhanshi").click(function () {
            if ($("input[name='sland_id[]']:checked").length >= 1) {
                $("#batches").attr('action', "/index.php/Admin/Famous/slandshow");
                $("#batches").submit();
            } else {
                alert('请选择操作对象');
            }
        ...
        $("#yincang").click(function () {
            if ($("input[name='sland_id[]']:checked").length >= 1) {
                $("#batches").attr('action', "/index.php/Admin/Famous/slandhide");
                $("#batches").submit();
            } else {
                alert('请选择操作对象');
            }
        ...
        $("#shanchu").click(function () {
            if ($("input[name='sland_id[]']:checked").length >= 1) {
                if (confirm('你确定要永久删除吗')) {
                    $("#batches").attr('action', "/index.php/Admin/Famous/delsland");
                    $("#batches").submit();
                }
            } else {
                alert('请选择操作对象');
