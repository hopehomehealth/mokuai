            ...
            <div class="page-content">
                <div class="row">
                    <div class="page-content box">
                        ...
                        <form action="/index.php/Admin/Menu/upd/id/151.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls pull-left">
									<?php if($info["pid"] == 0): ?><input type="text" class="input-mini" value="<?php echo ($info["sort"]); ?>" name="sort">
									<?php else: ?>
									<input type="text" class="input-mini" value="<?php echo ($info["sort"]); ?>" name="sort"><?php endif; ?>
                                    <span class="help-inline red"> * </span>  </div>
                            </div>
                            <div class="form-group">
