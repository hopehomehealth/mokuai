...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="span10">
            <h3><i class="icon-magic"></i>详情页广告添加</h3>
        </div>
    </div>
                <form action="/index.php/Admin/Bannerx/tianjia.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            ...
                            <div id="pic_div"><img id='pic_img' width='600' height='100'></div>
                        </div>
                    </div>
                    <script type='text/javascript'>
                        $(function(){
