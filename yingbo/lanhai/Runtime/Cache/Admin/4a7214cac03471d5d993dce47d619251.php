              ...
              <div class="row">
                  <div class="page-content box">
                      <div class="box-title margin_bot_20">
                          ...
                          <div align="right">
                            <a href="/index.php/Admin/Boards/tianjia" class="btn btn-primary btn-sm"><i class="icon-plus"></i>添加板块</a>
                          </div>
                      </div>
                      ...
                      <table class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                          <?php if(is_array($boards)): foreach($boards as $key=>$info): ?><tr>
                              <td><?php echo ($key + 1); ?></td>
                              <td style="padding-left:20px;text-align:left"><?php if($info["pid"] == 0): ?><b style="color:black"><?php echo ($info["board_title"]); ?></b><?php else: echo ($info["board_title"]); endif; ?></td>

                              <td>张海峰</td>
                              <td><?php if($info["pid"] != 0): ?><button class='btn btn-xs moveup' boardid="<?php echo ($info["board_id"]); ?>">上移</button>&nbsp;<button class='btn btn-xs movedown' boardid="<?php echo ($info["board_id"]); ?>">下移</button><?php endif; ?>
                              </td>
                              <td>
                                  <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                      <a class="green" href="/index.php/Admin/Boards/upd/board_id/<?php echo ($info["board_id"]); ?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                      <a onclick="return confirm('确定要删除吗')" href="/index.php/Admin/Boards/del/board_id/<?php echo ($info["board_id"]); ?>" class="red detail"> <i class="icon-remove bigger-130"></i>&nbsp;删除 </a>
                                  </div>
                              </td>
        ...
        <script type="text/javascript">
          $(function(){
            $(".moveup").click(function(){
              ...
              $.post("/index.php/Admin/Boards/sortboard",{'type':'moveup','board_id':$(this).attr('boardid')},function(data){
                  if(data == 'success'){
            ...
            $(".movedown").click(function(){
              ...
              $.post("/index.php/Admin/Boards/sortboard",{'type':'movedown','board_id':$(this).attr('boardid')},function(data){
                  if(data == 'success'){
