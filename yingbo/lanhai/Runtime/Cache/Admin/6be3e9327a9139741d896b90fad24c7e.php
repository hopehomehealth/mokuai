    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal" method="get" action="/index.php/Admin/Bgcomment/comment/art_id/<?php echo ($_GET['art_id']); ?>">
                    ...
                    <?php if(is_array($comments)): foreach($comments as $key=>$info): ?><tr>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a href="/index.php/Admin/Bgcomment/del/com_id/<?php echo ($info["com_id"]); ?>" class="red detail" onclick="return confirm('确定要删除吗')"> <i class="icon-remove bigger-130"></i>&nbsp;删除 </a>
                            </div>
                        </td>
...
$(function(){
    $(".display").click(function(){
        ...
        $.post("/index.php/Admin/Bgcomment/isdisplay",{'display':display,'com_id':comid},function(data){
            if(data == 'success'){
                if(display == 1){
                    thisobj.text('显示');
