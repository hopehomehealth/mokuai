            ...
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    ...
                    <div class="margin_bot_20" align="right">
                        <a href="<?php echo U('News/tianjia');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>文章添加</a>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="5px"><div align="center"></div></th>
                       <th width="5px"><div align="center">id</div></th>
                        ...
                        <th width="40px"><div align="center">是否推荐<a href="<?php echo U('News/tuilist');?>">推荐列表</a></div></th>                      <th width="100px"><div align="center">添加时间</div></th>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td><div align="center"><?php echo ($v["author"]); ?></div></td>
                               <td><div align="center"><img <?php if($v["picfirst"] == ''): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"<?php elseif($match == 'http'): ?>src="<?php echo ($v["picfirst"]); ?>"<?php elseif($match != 'http'): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>  width='70' height='50'/></div></td>
                            <td><div align="center"><a href="<?php echo U('News/typelist',array('lan_id'=>$v['lan_id']));?>"><?php echo ($v["lan_title"]); ?></a></div></td>
