    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal"  action="/index.php/Admin/Role/showlist" method="post">
                    <div class="form-group">
                        ...
                        <div class="margin_bot_20" align="right">
                            <a href="<?php echo U('Role/tianjia');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>新增角色</a>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td> <div align="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="red detail" href="<?php echo U('del',array('role_id'=>$v['role_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </div>
                            </td>
