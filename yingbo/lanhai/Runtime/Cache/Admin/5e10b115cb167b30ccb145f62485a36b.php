                ...
                <form class="form-horizontal"  action="/index.php/Admin/News/showlist" method="post">
                    <div class="form-group">
                        ...
                        <div class="margin_bot_20" align="right">
                            <a href="<?php echo U('News/tianjia');?>" class="btn btn-primary btn-sm"><i class="icon-plus"></i>文章发布</a>
...
<td><div align="center"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
...
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?> width='70' height='50'/></div></td>
