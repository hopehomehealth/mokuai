    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal"  action="/index.php/Admin/Banner/showlist/banner_id/1/p/2.html" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td><div align="center"><a href="<?php echo U('Banner/typelist',array('lan_id'=>$v['lan_id']));?>"><?php echo ($v["lan_title"]); ?></a> </div></td>
