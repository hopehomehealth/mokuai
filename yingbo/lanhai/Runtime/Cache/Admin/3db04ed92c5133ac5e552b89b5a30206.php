        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-magic"></i>法规政策发布</h3>
                    </div>
                </div>
<form action="/index.php/Admin/Fagui/tianjia.html" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
        ...
        <div class="controls pull-left">
            <select name='cat_id'>
                ...
                <?php if(is_array($catinfo)): foreach($catinfo as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
            </select>
            <span class="help-inline red"> * </span>
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <select id='banner_id' name='ding'>
                    <option value='0'>-请选择-</option>
                    <?php if(is_array($dinginfo)): foreach($dinginfo as $key=>$v): ?><option value="<?php echo ($v["banner_id"]); ?>"><?php echo ($v["banner_title"]); ?></option><?php endforeach; endif; ?>
                </select>
                <span class="help-inline red"> * </span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <select id='banner_id' name='youyi'>
                    <option value='0'>-请选择-</option>
                    <?php if(is_array($youyiinfo)): foreach($youyiinfo as $key=>$v): ?><option value="<?php echo ($v["banner_id"]); ?>"><?php echo ($v["banner_title"]); ?></option><?php endforeach; endif; ?>
                </select>
                <span class="help-inline red"> * </span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <select id='banner_id' name='youer'>
                    <option value='0'>-请选择-</option>
                    <?php if(is_array($youerinfo)): foreach($youerinfo as $key=>$v): ?><option value="<?php echo ($v["banner_id"]); ?>"><?php echo ($v["banner_title"]); ?></option><?php endforeach; endif; ?>
                </select>
                <span class="help-inline red"> * </span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <select id='banner_id' name='yousan'>
                    <option value='0'>-请选择-</option>
                    <?php if(is_array($yousaninfo)): foreach($yousaninfo as $key=>$v): ?><option value="<?php echo ($v["banner_id"]); ?>"><?php echo ($v["banner_title"]); ?></option><?php endforeach; endif; ?>
                </select>
                <span class="help-inline red"> * </span>
            </div>
        </div>
