            ...
            <div class="page-content box">
                ...
                <div class="breadcrumbs" style="margin-bottom:20px">
                    <ul>
                        ...
                        <li class="active"> <a href="/index.php/Admin/Tnews/index">图文消息回复 </a></li>


                    </ul>
                    <!-- .breadcrumb -->
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Tnews/index.html" method="post">
                    <div class="form-group">
                        ...
                        <div class="pull-right">
                                <a class="btn btn-success btn-sm" href="/index.php/Admin/Tnews/tianjia">添加图文消息</a>
                        </div>
                    </div>
                </form>
