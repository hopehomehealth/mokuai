...
<div class="logon">
  <form action="/index.php/Home/User/login" method="post" id="loginform">
    <p class="logon-tit fl">用户登录</p>
    <ul class="logon-list fl">
      <li>
        <p class="logon-list-t fl">用户名：</p>
        <p class="fl">
          <input name="username" type="text" class="logon-list-k" />
          <span class="pl10"><a href="/index.php/Home/User/register">注册会员</a></span></p>
      </li>
      <li>
        <p class="logon-list-t fl">密码：</p>
        <p class="fl">
          <input name="password" type="password" class="logon-list-k" />
          <span class="pl10"><a href="/index.php/Home/Email/getpassword">找回密码</a></span></p>
      </li>
      <li>
      ...
      <li>
        ...
        <p class="fl"><img id="codeimg" src="/index.php/Home/User/verifyImg" onclick="this.src=this.src+'?'+Math.random()" /></p>
      </li>
      <li>
        <p class="logon-list-t fl">&nbsp;</p>
        <p class="fl">
      ...
      <li>
        <p class="logon-list-t fl">&nbsp;</p>
        <p class="fl logon-an"><a id="loginbtn" href="javascript:void(0)">登&nbsp;录</a></p>
      </li>
    </ul>
