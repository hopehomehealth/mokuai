...
<div class="column-c pt10 ser">
    <div class="ser-left fl">
        <p class="ser-tit fl"><a class="bule fwb" href="<?php echo U('Index/index');?>" class="bule fwb">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a target="_blank" href="<?php echo U('News/lanhaizixun');?>">蓝海资讯</a></p>
    </div>
...
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>></a></li><?php endforeach; endif; ?>
    ...
    <!--<div class="coniner fl" id="idTransformView3">
        <ul class="slier slier2" id="idSlider3">
            <?php if(is_array($clickinfo)): foreach($clickinfo as $key=>$v): ?><li><a target="_blank" href="<?php echo U('News/detail',array('news_id'=>$v['news_id']));?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"/></a>
...
<div class="column-c pt5">
    <div class="pt30">
        <div class="view-a pr20 fl">
            <p class="view-a-t fl"><span class="fr"><a target="_blank" href="<?php echo U('News/newslist',array('lan_id'=>$shidianinfo1[0]['lan_id']));?>">更多》</a></span><img src="<?php echo (HIMG_URL); ?>images_22.jpg" alt="蓝海试点" /></p>
            <dl>
