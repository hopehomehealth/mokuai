    ...
    <ul class="set-lis_lb fl">
      <?php if(is_array($slanders)): foreach($slanders as $key=>$info): ?><li>
        <dl class="fam-t fl pt10 pb10">
          ...
          <dd><span class="pr10"><a href="/index.php/Home/Famous/slanders1/f_id/<?php echo ($info["f_id"]); ?>" class="bule"><?php echo ($info["f_name"]); ?></a></span>|&nbsp;&nbsp;<a href="/index.php/Home/Famous/detail/sland_id/<?php echo ($info["sland_id"]); ?>"><?php echo ($info["title"]); ?></a></dd>
        </dl>
        <p class="set-lis-nr fl w100"><?php echo ($info["content"]); ?></p>
