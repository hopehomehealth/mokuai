...
<div class="column-c pt10 ser" style="height:50px">
  <div class="ser-left fl">
    <p class="ser-tit fl"><a href="<?php echo U('Index/index');?>" class="bule fwb">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a href="<?php echo U('Bbs/index',array('lan_id'=>7));?>">长青论坛</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a href="<?php echo U('Famous/character',array('lan_id'=>37));?>">蓝海人物</a></p>
  </div>
...
<div class="column-c pt10 pb30">
  ...
  <div class="set-lis-l fl">
    ...
    <ul class="set-lis_lb fl">
      <?php if(is_array($famous)): foreach($famous as $key=>$info): ?><li>
        <dl class="nhtt fl pt15">
          ...
          <dd><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($info["f_id"]); ?>"><?php echo ($info["f_name"]); ?></a><br />
            <p class="l-gray fs12 fl"><img src="<?php echo (HIMG_URL); ?>images_92.jpg" alt="" />&nbsp;<?php echo ($info["f_province"]); ?></p>
            <p class="fs12 fl"><span class="l-gray">发表文章：</span><?php echo ($info["f_artnums"]); ?> <span class="l-gray pl20">粉丝：</span><?php echo ($info["f_fans"]); ?></p>
            <p class="fl pt10"><a href="javascript:void(0)" onclick="follow('/index.php/Home/Famous/follow/f_id/'+<?php echo ($info['f_id']); ?>)"><img src="<?php echo (HIMG_URL); ?>images_127.jpg" alt="" /></a></p>
          </dd>
        </dl>
        <ul class="nhtt-list1 fl">
<?php if(is_array($info["slanders1"])): foreach($info["slanders1"] as $key=>$subinfo1): ?><li><a href="/index.php/Home/Famous/detail/sland_id/<?php echo ($subinfo1["sland_id"]); ?>"><?php echo ($subinfo1["title"]); ?></a></li><?php endforeach; endif; ?>
          <?php if(is_array($info["slanders"])): foreach($info["slanders"] as $key=>$subinfo): ?><li><a href="/index.php/Home/Famous/detail/sland_id/<?php echo ($subinfo["sland_id"]); ?>"><?php echo ($subinfo["title"]); ?></a></li><?php endforeach; endif; ?>
          <?php if($info["more"] == 1): ?><p class="fl nhtt-more"><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($info["f_id"]); ?>">查看他发表的更多文章 >></a></p><?php endif; ?>
        </ul>
  ...
  <div class="set-lis-r fr">
    ...
    <div class="set-lis-tj fl">
      ...
      <?php if(is_array($tuijianlist)): foreach($tuijianlist as $key=>$info): ?><dl class="nhtt-list fr pt10 pb10">
        <dt><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($info["f_id"]); ?>"><img src="<?php echo ($info["f_photo"]); ?>" alt="" /></a></dt>
        <dd><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($info["f_id"]); ?>"><?php echo ($info["f_name"]); ?></a><br />
