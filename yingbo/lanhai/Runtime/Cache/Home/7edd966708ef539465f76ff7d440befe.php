      ...
      <form action="/index.php/Home/Email/findpwd" method="post" id="form">
        <ul class="log fl pb4">
          ...
          <li><span class="red">*</span>
            ...
            <span class="log-yzm"><img style="height:3.1rem;width:auto;border:1px solid #ccc" onclick="this.src=this.src+'?'+Math.random()" src="/index.php/Home/Email/verifyImg"></span> </li>
          <p class="log-an fl">
