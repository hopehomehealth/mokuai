...
<div class="column-c pt10 ser pb30">
    ...
    <ul class="fl com-lift">
        <li class="cur"><a href="<?php echo U('gongsijianjie');?>">公司简介</a></li>
...
<script type="text/javascript">
    ...
    var sContent ="<h4 class='blue' style='margin:0 0 5px 0;padding:0.2em 0'>田村北路墨蔬院06号</h4>" +
            "<img style='float:right;margin:4px' id='imgDemo' src='http://www.bjlhcq.com/Public/Home/images/ditu.png' width='139' height='104' title='墨蔬院06号'/>" +
