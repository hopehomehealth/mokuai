...
<div class="column-c pt10 pb30">
    <p class="com-tit fl"><img src="<?php echo (HIMG_URL); ?>images_158.jpg" alt="友情链接" /></p>
    <dl class="links-list fl">
        <p class="w100 fs16 pt15 pb10">合作伙伴</p>
         <?php if(is_array($linkinfo1)): foreach($linkinfo1 as $key=>$v): ?><dt><a href="<?php echo ($v["url"]); ?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></a></dt><?php endforeach; endif; ?>
    </dl>
    <dl class="links-list fl">
        <p class="w100 fs16 pt15 pb10">政府军方网站</p>

        <?php if(is_array($linkinfo2)): foreach($linkinfo2 as $key=>$v): ?><dt><a href="<?php echo ($v["url"]); ?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></a></dt><?php endforeach; endif; ?>
    </dl>

    <dl class="links-list fl">
        <p class="w100 fs16 pt15 pb10">知名智库网站</p>
        <?php if(is_array($linkinfo3)): foreach($linkinfo3 as $key=>$v): ?><dt><a href="<?php echo ($v["url"]); ?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></a></dt><?php endforeach; endif; ?>
    </dl>
    <dl class="links-list fl">
        <p class="w100 fs16 pt15 pb10">知名门户网站</p>
        <?php if(is_array($linkinfo4)): foreach($linkinfo4 as $key=>$v): ?><dt><a href="<?php echo ($v["url"]); ?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></a></dt><?php endforeach; endif; ?>
    </dl>
</div>
