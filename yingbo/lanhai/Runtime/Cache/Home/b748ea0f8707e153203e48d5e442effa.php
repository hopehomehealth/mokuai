...
<!-------banner------->
<?php if(!empty($adinfo0)): ?><p class="com-banner">
...
<div class="column-c pt10 ser">
    <div class="ser-left fl">
            ...
            <?php if($pid == 0): ?><p class="ser-tit fl"><a target="_blank" href="<?php echo U('Index/index');?>" class="bule fwb">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" />
                <a target="_blank" href="<?php echo ($daohang["first_url"]); ?>"><?php echo ($daohang["first"]); ?></a> </p>
                <?php else: ?>
                <p class="ser-tit fl"><a target="_blank" href="<?php echo U('Index/index');?>">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" />
        <a target="_blank" href="<?php echo ($daohang["second_url"]); ?>"><?php echo ($daohang["second"]); ?></a>
        <img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" />
        <a target="_blank" href="<?php echo ($daohang["first_url"]); ?>"><?php echo ($daohang["first"]); ?></a></p><?php endif; ?>
...
<div class="column-c pt10 pb30">
    ...
    <div class="set-lis-l fl">
        <!--<p class="nhtt-tit fl"><img src="<?php echo (HIMG_URL); ?>images_141.jpg" alt="蓝海头条" /></p>-->
        <!--****左边第一通栏****-->
        <ul class="set-lis_lb fl">
            <?php if(is_array($info)): foreach($info as $k=>$v): ?><li>
                    <dl class="set-lis-twjh fl pt15">
                        <dt><a target="_blank" href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$pid1));?>"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
...
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>alt="" /></a></dt>
                        <dd>
                            <p class="set-lis-wz fl"><a target="_blank" href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$pid1));?>"><?php echo ($v["news_title"]); ?></a></p>
                            <p class="set-lis-nr fl"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r","&bsp;"),array("","","","","",""),strip_tags($v["content"])),0,88,'utf-8')); ?></p>
