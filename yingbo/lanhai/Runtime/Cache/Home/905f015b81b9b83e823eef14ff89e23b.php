...
<!-------banner------->
<!-------banner------->
<?php if(!empty($adinfo0)): ?><p class="su-banner pt10">
...
<div class="column-c pt10 ser">
    <div class="ser-left fl">
        <p class="ser-tit fl"><a target="_blank" href="<?php echo U('Index/index');?>" class="bule fwb">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a href="<?php echo U('News/junminronghe');?>">军民融合</a></p>
    </div>
...
<div class="coniner fl">
  <ul class="hiSlider hiSlider1">
   <?php if(is_array($clickinfo)): foreach($clickinfo as $key=>$v): ?><li data-title="<?php echo ($v["news_title"]); ?>" class="hiSlider-item"><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img   <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["piclie"]); ?>"
...
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>  /></a></li><?php endforeach; endif; ?>
    ...
    <!--<div class="coniner fl" id="idTransformView3">
        <ul class="slier slier2" id="idSlider3">
            <?php if(is_array($clickinfo)): foreach($clickinfo as $key=>$v): ?><li><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id']));?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"/></a>
...
<div class="column-c pt5">
    <div class="pt30">
        <div class="view-a pr20 fl">
            <p class="view-a-t fl"><span class="fr"><a href="<?php echo U('News/newslist',array('lan_id'=>$lanhaifabuinfo1[0]['lan_id']));?>">更多》</a></span><img src="<?php echo (HIMG_URL); ?>images_59.jpg" alt="蓝海发布" /></p>
            <dl>
                <?php if(is_array($lanhaifabuinfo1)): foreach($lanhaifabuinfo1 as $key=>$v): ?><h5><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></h5>
                    <dt><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == '')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == '')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>/></a></dt>
                    <dd><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["content"])),0,66,'utf-8')); ?></a></dd><?php endforeach; endif; ?>
            </dl>
            <ul>
                <?php if(is_array($lanhaifabuinfo2)): foreach($lanhaifabuinfo2 as $key=>$v): ?><li><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
        </div>
        <div class="view-a pr20 fl">
            <p class="view-a-t fl"><span class="fr"><a href="<?php echo U('News/newslist',array('lan_id'=>$chanyefazhaninfo1[0]['lan_id']));?>">更多》</a></span><img src="<?php echo (HIMG_URL); ?>images_69.jpg" alt="产业发展" /></p>
            <dl>
                <?php if(is_array($chanyefazhaninfo1)): foreach($chanyefazhaninfo1 as $key=>$v): ?><h5><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></h5>
                    <dt><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img  <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == '')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == '')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?> /></a></dt>
            ...
            <ul>
                <?php if(is_array($chanyefazhaninfo2)): foreach($chanyefazhaninfo2 as $key=>$v): ?><li><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
        </div>
        <div class="view-a fl">
            <p class="view-a-t fl"><span class="fr"><a href="<?php echo U('News/newslist',array('lan_id'=>$wenhuachuanmeiinfo1[0]['lan_id']));?>">更多》</a></span><img src="<?php echo (HIMG_URL); ?>images_62.jpg" alt="文化传媒" /></p>
            <dl>
                <?php if(is_array($wenhuachuanmeiinfo1)): foreach($wenhuachuanmeiinfo1 as $key=>$v): ?><h5><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></h5>
                    <dt><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == '')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == '')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>/></a></dt>
            ...
            <ul>
                <?php if(is_array($wenhuachuanmeiinfo2)): foreach($wenhuachuanmeiinfo2 as $key=>$v): ?><li><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
        </div>
    </div>
</div>
...
<div class="column-c pt5">
    <div class="fuse fl">
     <span class="fr"><a href="<?php echo U('News/newslist',array('lan_id'=>$jiaoyupeixuninfo[0]['lan_id']));?>">更多》</a></span>
        <p class="news-tit fl"><img src="<?php echo (HIMG_URL); ?>images_61.jpg" alt="教育培训" /></p>
        <dl class="fuse fl">
            <?php if(is_array($jiaoyupeixuninfo)): foreach($jiaoyupeixuninfo as $key=>$v): ?><dt><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == '')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == '')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>/></a>
    ...
    <div class="view-a fr">
        <p class="view-a-t fl"><span class="fr"><a href="<?php echo U('News/newslist',array('lan_id'=>$anquanluntaninfo1[0]['lan_id']));?>">更多》</a></span><span class="news-tit fl"><img src="<?php echo (HIMG_URL); ?>images_176.jpg" alt="安全与发展论坛" /></span></p>
        <dl>
            <?php if(is_array($anquanluntaninfo1)): foreach($anquanluntaninfo1 as $key=>$v): ?><h5><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></h5>
            <dt><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><img <?php if(($v["pic"] != '') AND ($v["pic"] != './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == '')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] == 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == '')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"
<?php elseif(($v["match"] != 'http') AND ($v["pic"] == './Public/Upl/news/')): ?>src="<?php echo (SITE_URL); echo ($v["picfirst"]); ?>"<?php endif; ?>/></a></dt>
        ...
        <ul class="">
            <?php if(is_array($anquanluntaninfo2)): foreach($anquanluntaninfo2 as $key=>$v): ?><li><a href="<?php echo U('News/detail',array('news_id'=>$v['news_id'],'lan_id'=>$v['lan_id']));?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
        </ul>
    </div>
</div>

<!-------第八通栏------->
<?php if(!empty($adinfo2)): ?><p class="column-c ad1 pb30 pt22">
