...
<div class="column-c pt10 pb30">
  ...
  <div class="set-lis-l fl">
    ...
    <ul class="set-lis_lb fl">
      <?php if(is_array($slanders)): foreach($slanders as $key=>$info): ?><li>
        <p class="set-lis-wz fl"><a href="/index.php/Home/Famous/detail/sland_id/<?php echo ($info["sland_id"]); ?>"><?php echo ($info["title"]); ?></a></p>
        <p class="set-lis-nr fl"><div><?php echo ($info["content"]); ?></div></p>
        <p class="set-lis-plgz fl fs12"><?php echo (date("Y-m-d H:i:s",$info["add_time"])); ?></p>
        <p class="set-lis-plgz fr fs12"><span class="pr15"><img src="<?php echo (HIMG_URL); ?>images_06.png" alt="" /><?php echo ($info["comments"]); ?></span><span class="pr15 fl"><img src="<?php echo (HIMG_URL); ?>images_07.png" alt="" /><?php echo ($info["views"]); ?></span></p>
  ...
  <div class="set-lis-r fr">
    ...
    <dl class="nhtt-list fr pt10 pb10">
      <dt><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($famousinfo["f_id"]); ?>"><img src="<?php echo ($famousinfo["f_photo"]); ?>" alt="" /></a></dt>
      <dd><a href="/index.php/Home/Famous/slanders2/f_id/<?php echo ($famousinfo["f_id"]); ?>"><?php echo ($famousinfo["f_name"]); ?></a><br />
        <span class="l-gray fs12 pb5 pt5 fl"><img src="<?php echo (HIMG_URL); ?>images_92.jpg" alt="" />&nbsp;<?php echo ($famousinfo["f_province"]); ?></span><br />
        <a href="javascript:void(0)" onclick="follow('/index.php/Home/Famous/follow/f_id/'+<?php echo ($famousinfo['f_id']); ?>)"><img src="<?php echo (HIMG_URL); ?>images_127.jpg" /></a></dd>
    </dl>
    <!--****右边第二通栏****-->
