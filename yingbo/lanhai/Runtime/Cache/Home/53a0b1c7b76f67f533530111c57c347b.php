...
<div class="column-c pt10 ser" style="height:50px">
  <div class="ser-left fl">
    <p class="ser-tit fl"><a href="<?php echo U('Index/index');?>" class="bule fwb">首页</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a href="<?php echo U('Bbs/index',array('lan_id'=>7));?>">长青论坛</a><img src="<?php echo (HIMG_URL); ?>images_96.jpg" alt="" /><a href="<?php echo U('Blog/index',array('lan_id'=>34));?>">长青博客</a></p>
  </div>
  <?php if($_SESSION['flag']== ''): ?><p class="fr pt22"><a href="/index.php/Home/User/login">登录</a>｜<a href="/index.php/Home/User/register">注册</a></p>
  <?php else: ?>
  <dl class="set-lis fr">
    <dt><a href="/index.php/Home/User/ucenter"><img src="<?php echo ($_SESSION['userInfo']['userhead']); ?>" alt="" /></a></dt>
    <dd><a href="/index.php/Home/User/ucenter"><?php echo ($_SESSION['userInfo']['username']); ?></a>&nbsp;|&nbsp;<a href="/index.php/Home/User/logout" style="color:#999;cursor:pointer">退出</a><!-- <br />
...
<div class="column-c pt10 pb30">
  ...
  <div class="set-lis-l fl">
    <ul class="set-lis_lb fl">
      <?php if(is_array($articlelist)): foreach($articlelist as $k=>$articleinfo): ?><!--  <li>
           <p class="set-lis-wz fl"><a href="/index.php/Home/Blog/detail/art_id/<?php echo ($articleinfo["art_id"]); ?>"><?php echo ($articleinfo["title"]); ?></a></p>
           <p class="set-lis-nr fl" style="width:100%"><?php echo ($articleinfo["content"]); ?></p>
           <p class="set-lis-plgz fl  fs12"><span class="pr15 bule"><?php echo ($articleinfo["username"]); ?></span> <?php echo (date("Y-m-d H:i:s",$articleinfo["add_time"])); ?></p>
           <p class="set-lis-plgz fr fs12"><span class="pr15"><img src="<?php echo (HIMG_URL); ?>images_06.png" alt="" /><?php echo ($articleinfo["comments"]); ?></span><span class="pr15 fl"><img src="<?php echo (HIMG_URL); ?>images_07.png" alt="" /><?php echo ($articleinfo["views"]); ?></span><a href=""><img src="<?php echo (HIMG_URL); ?>images_08.png" /></a></p>
         </li> -->
          <li>
            <dl class="set-lis-twjh fl pt15">
              <dt style="width:140px;max-height:140px;overflow:hidden;"><a href="/index.php/Home/Blog/detail/art_id/<?php echo ($articleinfo["art_id"]); ?>"><img src="<?php echo ($articleinfo["userhead"]); ?>" alt="" /></a></dt>
              <dd style="width:568px">
                <p class="set-lis-wz fl"><a href="/index.php/Home/Blog/detail/art_id/<?php echo ($articleinfo["art_id"]); ?>"><?php echo ($articleinfo["title"]); ?></a></p>
                <p class="set-lis-nr fl" style="max-height:65px;width:100%"><?php echo ($articleinfo["content"]); ?></p>
                <p class="set-lis-plgz fl  fs12"><span class="pr15 bule"><?php echo ($articleinfo["username"]); ?></span> <?php echo (date("Y-m-d H:i:s",$articleinfo["add_time"])); ?></p>
                <p class="set-lis-plgz fr fs12"><span class="pr15"><img src="<?php echo (HIMG_URL); ?>images_06.png" alt="" /><?php echo ($articleinfo["comments"]); ?></span><span class="pr15 fl"><img src="<?php echo (HIMG_URL); ?>images_07.png" alt="" /><?php echo ($articleinfo["views"]); ?></span></p>
              </dd>
            </dl>
  ...
  <div class="set-lis-r fr">
    ...
    <?php if(($_SESSION['flag']!= '') AND ($_SESSION['userInfo']['is_blog']== 1)): ?><p class="set-lis-tjtt fl"><img src="<?php echo (HIMG_URL); ?>images_160.jpg"  alt=""/></p>
      <dl class="bow-r fl" style="padding-top:10px;padding-bottom:10px">
        <dt><a href="/index.php/Home/Blog/myblog"><img src="<?php echo ($_SESSION['userInfo']['userhead']); ?>" title="点击进入我的博客" alt="" /></a></dt>
        <dd>
          <p class="fs22 pt10"><a href="/index.php/Home/Blog/myblog" title="点击进入我的博客"><?php echo ($_SESSION['userInfo']['username']); ?></a></p>
        </dd>
      </dl>
       <!--****右边第二通栏****-->
    ...
    <div class="set-lis-tj fl">
      ...
      <ul class="set-lis-list fl pt15">
        <?php if(is_array($hotarticle)): foreach($hotarticle as $key=>$info): ?><li><a href="/index.php/Home/Blog/detail/art_id/<?php echo ($info["art_id"]); ?>"><?php echo ($info["title"]); ?></a></li><?php endforeach; endif; ?>
