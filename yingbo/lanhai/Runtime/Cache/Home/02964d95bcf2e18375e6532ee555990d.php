...
<div class="column-c pt10 ser pb30">
    ...
    <ul class="fl com-lift">
        ...
        <li class="cur"><a href="<?php echo U('News/qiyejingshen');?>">企业精神</a></li>
        <li><a href="<?php echo U('News/yewufanwei');?>">业务范围</a></li>
    ...
    <div class="com-con fr pt22">
        ...
        <p class="com-w">公司地址：北京市丰台区富丰路4号工商联大厦A座1902室</p>
...
<script type="text/javascript">
    // 百度地图API功能
    var sContent ="<h4 class='blue' style='margin:0 0 5px 0;padding:0.2em 0'>工商联大厦A座1902室</h4>" +
            "<img style='float:right;margin:4px' id='imgDemo' src='http://www.1lehu.com/Public/Home/images/ditu.png' width='139' height='104' title=''/>" +
            "<p style='margin:0;line-height:1.5;font-size:13px;text-indent:2em'>北京市丰台区富丰路4号工商联大厦A座1902室</p>" +
            "</div>";
    var map = new BMap.Map("l-map");
    var point = new BMap.Point(116.29128,39.841645);
