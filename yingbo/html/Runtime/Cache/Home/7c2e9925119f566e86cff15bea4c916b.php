...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">服务案例</p><p class="about_yw fl">Service&nbsp;Example</p>
    </div>
    <div class="about_zc fl">
        ...
        <div class="news_list_cn fl">
            <h1><?php echo ($info["name"]); ?><br /><span><?php echo (date('Y-m-d H:i:s',$info["input_time"])); ?> </span></h1>
            <p><?php echo ($info["content"]); ?></p>

        </div>
        <div class="about_zc fl">
<span class="tra_c_f">上一篇：
    <a href="<?php echo U('Example/example_list',array('example_id'=>$preshow['example_id']));?>"><?php echo ($preshow['name']); ?></a></span><br />
<span class="tra_c_f">下一篇：
    <a href="<?php echo U('Example/example_list',array('example_id'=>$nextshow['example_id']));?>"><?php echo ($nextshow['name']); ?></a></span>
        </div>
    </div>
</div>
