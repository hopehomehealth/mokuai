...
<div class="sideBar">
    ...
    <div class="about_zc fl">
        ...
        <div class="news_list_cn fl">
            <h1><?php echo ($medicalinfo["title"]); ?><br /><span><?php echo (date('Y-m-d H:i:s',$medicalinfo["input_time"])); ?></span></h1>
            <p><?php echo ($medicalinfo["content"]); ?></p>

        </div>
        <div class="about_zc fl">
<span class="tra_c_f">上一篇：
    <a href="<?php echo U('Medical/med_list',array('medical_id'=>$preshow['medical_id']));?>"><?php echo ($preshow['title']); ?></a></span><br />
<span class="tra_c_f">下一篇：
    <a href="<?php echo U('Medical/med_list',array('medical_id'=>$nextshow['medical_id']));?>"><?php echo ($nextshow['title']); ?></a></span>
        </div>
    </div>
</div>
