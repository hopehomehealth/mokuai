...
<div class="menu">
    <ul id="menu_nr" class="menu_nr">
        ...
        <li <?php if(CONTROLLER_NAME == Product): ?>class="cur"<?php endif; ?>><a href="<?php echo U('Product/showlist');?>">乐护服务</a></li>
...
<script type="text/javascript">
    $(function(){
        ...
        <link href="<?php echo (HCSS_URL); ?>mypage.css" rel="stylesheet" type="text/css"/>
...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">医学知识</p><p class="about_yw fl">Medical&nbsp;Knowledge</p>
    </div>


    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Medical/showlist');?>">护理健康知识</a></li>
        </ul>
        <ul class="med_con fl">
            <?php if(is_array($info)): foreach($info as $k=>$v): ?><li>
                    <p class="med_left fl"><?php echo (date('d',$v["input_time"])); ?><br /><span><?php echo (date('m',$v["input_time"])); ?>月<br /><?php echo (date('Y',$v["input_time"])); ?></span></p>
                    <div class="med_wz fl">
                        <h1><a href="<?php echo U('Medical/med_list',array('medical_id'=>$v['medical_id']));?>"><?php echo ($v["title"]); ?></a></h1>
                        <a href="<?php echo U('Medical/med_list',array('medical_id'=>$v['medical_id']));?>"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["content"])),0,150,'utf-8')); ?>...</a>
                    </div>
                    <p class="med_pic fr"><a href="<?php echo U('Medical/med_list',array('medical_id'=>$v['medical_id']));?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" width="172" height="114" /></a></p>
                </li><?php endforeach; endif; ?>
        </ul>
        <table width="600" align="center">
            <tr class="content" align="center">
                <!--<td colspan="3" bgcolor="#FFFFFF">&nbsp;<?php echo ($page); ?></td>-->
                <td colspan="3" bgcolor="#FFFFFF" align="center"><div class="pages" align="center">
                    <?php echo ($page); ?>
                </div></td>
            </tr>
        </table>
