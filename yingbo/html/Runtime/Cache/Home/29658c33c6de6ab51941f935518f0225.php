...
<div class="news_list_cn fl">

<h1><?php echo ($info["title"]); ?><br /><span><?php echo (date('Y-m-d H:i:s',$info["input_time"])); ?> </span></h1>
   
    <iframe height=675 width=800 src="<?php echo ($info["url"]); ?>" frameborder=0 allowfullscreen></iframe>

</div>
    <div class="about_zc fl">
<span class="tra_c_f">上一篇：
    <a href="<?php echo U('Trailer/trailer_list',array('trailer_id'=>$preshow['trailer_id']));?>"><?php echo ($preshow['title']); ?></a></span><br />
<span class="tra_c_f">下一篇：
    <a href="<?php echo U('Trailer/trailer_list',array('trailer_id'=>$nextshow['trailer_id']));?>"><?php echo ($nextshow['title']); ?></a></span>
    </div>
