...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">关于乐护</p><p class="about_yw fl">about&nbsp;us</p>
    </div>
    ...
    <div class="about_zc fl">
        <ul class="news_list_tit">
            ...
            <li><a href="<?php echo U('About/about');?>">公司简介</a></li>
            <li><a href="<?php echo U('About/qywh');?>">企业文化</a></li>
            <li class="current"><a href="<?php echo U('Trailer/showlist');?>">宣传片</a></li>
        </ul>
        <ul class="xcp_list fl">
            <?php if(is_array($info)): foreach($info as $k=>$v): ?><li>
                <!--<a href="<?php echo ($v["url"]); ?>"><img src="<?php echo (HIMG_URL); ?>images_07.jpg" /><span><img src="<?php echo (HIMG_URL); ?>bfq.png" /></span></a>-->
               <a href="<?php echo U('Trailer/trailer_list',array('trailer_id'=>$v['trailer_id']));?>">

                   <img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>" width="360" height="230"/> <span><img src="<?php echo (HIMG_URL); ?>bfq.png" /></span>
                <p class="xcp_xjt"><?php echo ($v["title"]); ?></p></a>
