...
<span class="tra_c_f">上一篇：
    <a href="<?php echo U('News/news_list',array('news_id'=>$preshow['news_id']));?>"><?php echo ($preshow['title']); ?></a></span><br />
<span class="tra_c_f">下一篇：
    <a href="<?php echo U('News/news_list',array('news_id'=>$nextshow['news_id']));?>"><?php echo ($nextshow['title']); ?></a></span>
</div>
