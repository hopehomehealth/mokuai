...
<script type="text/javascript">
    $(function(){
        ...
        <script type="text/javascript" src="<?php echo (HJS_URL); ?>jquery.SuperSlide.2.1.1.js"></script>
...
<div class="sideBar">
    ...
    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('TeamAssess/showlist');?>">服务团队</a></li>
            <li><a href="<?php echo U('TeamExpert/showlist');?>">专家顾问团队</a></li>
            <li><a href="<?php echo U('TeamManage/showlist');?>">管理团队</a></li>
            <li><a href="<?php echo U('Contact/showlist');?>">联系我们</a></li>
        </ul>
        ...
        <div class="gltd fl">
            <div class="picScroll-left">
                ...
                <div class="bd">
                    <ul class="picList">
                        <?php if(is_array($assessinfo)): foreach($assessinfo as $k=>$v): ?><li>
                            <dl class="gltd_pic fl">
                                <dt><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>"/></dt>
                                <dd><?php echo ($v["title"]); ?></dd>
                                <p class="xj_picw"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["description"])),0,50,'utf-8')); ?></p>
                            </dl>
            ...
            <div class="picScroll-left">
                ...
                <div class="bd">
                    <ul class="picList">
                        <?php if(is_array($nurseinfo)): foreach($nurseinfo as $k=>$v): ?><li>
                            <dl class="gltd_pic fl">
                                <dt><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></dt>
                                <dd><?php echo ($v["title"]); ?></dd>
                                <p class="xj_picw"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["description"])),0,50,'utf-8')); ?></p>
            ...
            <div class="picScroll-left">
                <div class="hd">
                    <p>HCA “Health Care Assistance 健康服务助理”</p>
                    <ul>
                    </ul>
                    <span class="pageState"></span>
                </div>
                <div class="bd">
                    <ul class="picList">
                        <?php if(is_array($healthinfo)): foreach($healthinfo as $k=>$v): ?><li>
                            <dl class="gltd_pic fl">
                                <dt><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" /></dt>
                                <dd><?php echo ($v["title"]); ?></dd>
                                <p class="xj_picw"><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["description"])),0,50,'utf-8')); ?></p>
            ...
            <script type="text/javascript">
                jQuery(".picScroll-left").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftLoop",autoPlay:true,scroll:3,vis:3,easing:"easeOutElastic"});
            </script>
        </div>
    </div>
</div>
