...
<div class="sideBar">
    ...
    <div class="about_zc fl">
        ...
        <div class="news_list_cn fl">
            ...
            <h1><?php echo ($traininfo["china"]); ?><br /><span><?php echo (date('Y-m-d H:i:s',$traininfo["input_time"])); ?></span></h1>
            <?php echo ($traininfo["content"]); ?>

        </div>
        <div class="about_zc fl">
<span class="tra_c_f">上一篇：
    <a href="<?php echo U('Train/train_list',array('train_id'=>$preshow['train_id']));?>"><?php echo ($preshow['china']); ?></a></span><br />
<span class="tra_c_f">下一篇：
    <a href="<?php echo U('Train/train_list',array('train_id'=>$nextshow['train_id']));?>"><?php echo ($nextshow['china']); ?></a></span>
        </div>
