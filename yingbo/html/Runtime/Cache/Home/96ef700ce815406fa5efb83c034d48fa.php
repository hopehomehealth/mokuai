...
<div class="sideBar">
    ...
    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('News/news');?>">新闻中心</a></li>
            <li><a href="<?php echo U('About/about');?>">公司简介</a></li>
            <li><a href="<?php echo U('About/qywh');?>">企业文化</a></li>
            <li><a href="<?php echo U('Trailer/showlist');?>">宣传片</a></li>
        </ul>
        <ul class="news">
            <?php if(is_array($newsinfo)): foreach($newsinfo as $k=>$v): ?><li>
                <p class="news_left fl"><?php echo (date('d',$v["input_time"])); ?><span><?php echo (date('M',$v["input_time"])); ?></span></p>
                <div class="news_right fl">
                    <a href="<?php echo U('News/news_list',array('news_id'=>$v['news_id']));?>"> <h1><?php echo ($v["title"]); ?></h1>
                    <p class="news_right_txt fl">
                        <?php echo ($v["description"]); ?><br /><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>" />
                    </p></a>
                </div>
