...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">乐护培训</p><p class="about_yw fl">Music&nbsp;Nursing&nbsp;Training</p>
    </div>
    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Train/showlist');?>">乐护培训</a></li>
        </ul>

        <ul class="train fl">

            <li id="bbn">
                <?php if(is_array($info)): foreach($info as $k=>$v): ?><div class="tra_pic fl">
                    <p class="tra_txt fl"><a href="<?php echo U('Train/train_list',array('train_id'=>$v['train_id']));?>"><?php echo ($v["china"]); ?></a></p>
                    <p class="tra_js fl"><a href="<?php echo U('Train/train_list',array('train_id'=>$v['train_id']));?>"><?php echo (mb_substr(strip_tags($v["content"]),27,75,'utf-8')); ?>...</a></p>
                    <p class="tra_yw fl"><a href="<?php echo U('Train/train_list',array('train_id'=>$v['train_id']));?>"><?php echo ($v["english"]); ?></a></p>
                    <p class="tra_tu fl"><a href="<?php echo U('Train/train_list',array('train_id'=>$v['train_id']));?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" width="200" height="100"/></a></p>
