...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">服务案例</p><p class="about_yw fl">Service&nbsp;Case</p>
    </div>


    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Example/showlist');?>">服务案例</a></li>
        </ul>
        <ul class="case fl">

        <?php if(is_array($exampleinfo)): foreach($exampleinfo as $k=>$v): ?><li>
                <p class="case_tit fl"><?php echo ($v["name"]); ?></p>
                <dl class="case_pic fl">
                    <dt><a href="<?php echo U('Example/example_list',array('example_id'=>$v['example_id']));?>"><img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>" width="174" height="104" /></a></dt>
                    <dd><?php echo (mb_substr(strip_tags($v["content"]),0,21,'utf-8')); ?>...<br /><br /><span><a href="<?php echo U('Example/example_list',array('example_id'=>$v['example_id']));?>">查看详情 >></a></span></dd>
                </dl>
