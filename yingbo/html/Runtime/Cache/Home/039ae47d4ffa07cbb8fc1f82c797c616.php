...
<div class="head">
    <div class="head_nr">
        <p>乐护服务平台官方网站欢迎您！</p>
        <li><a href="#">网站导航</a>热线电话：010-65811808/806</li></div>
</div>
<div class="sideBar">
...
<div class="menu">
    <ul id="menu_nr" class="menu_nr">
        ...
        <li <?php if(CONTROLLER_NAME == Service): ?>class="cur"<?php endif; ?>><a href="<?php echo U('Service/showlist');?>">乐护服务</a></li>
...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">乐护服务</p><p class="about_yw fl">Le&nbsp;Care&nbsp;Services</p>
    </div>
    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Service/showlist');?>">乐护服务</a></li>
        </ul>
        ...
        <ul class="modpic fl">
             <?php if(is_array($info)): foreach($info as $k=>$v): ?><li><a href="javascript:;" class="modmore"><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>" alt="">
                     ...
                     <p class="ser_erm">
                         <?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["description"])),0,66,'utf-8')); ?>
                         <span class="er"><img src='<?php echo (SITE_URL); echo (substr($v["img"],2)); ?>' id='' width='120' height='120'></span>
                     </p>
