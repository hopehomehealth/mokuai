...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">乐护服务</p><p class="about_yw fl">Le&nbsp;Care&nbsp;Products</p>
    </div>
    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Product/showlist');?>">乐护服务</a></li>
        </ul>

        <ul class="modpic fl">
             <?php if(is_array($info)): foreach($info as $k=>$v): ?><li><a href="javascript:;" class="modmore"><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>" alt="">
                     <p class="ser">
