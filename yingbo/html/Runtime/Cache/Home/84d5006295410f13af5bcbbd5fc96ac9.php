...
<h1><?php echo ($info["title"]); ?><br /><span><?php echo (date('Y-m-d H:i:s',$info["input_time"])); ?> </span></h1>
    <embed src="<?php echo ($info["url"]); ?>" quality="high" width="800" height="500" align="middle" allowScriptAccess="always" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>
