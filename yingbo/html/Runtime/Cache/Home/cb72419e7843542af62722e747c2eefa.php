...
<div class="sideBar">
    <div class="about fl">
        <p class="about_tit fl">合作单位</p><p class="about_yw fl">The&nbsp;Cooperation&nbsp;Unit</p>
    </div>


    <div class="about_zc fl">
        <ul class="news_list_tit">
            <li class="current"><a href="<?php echo U('Link/showlist');?>">合作单位</a></li>
        </ul>

        <ul class="hzdw fl">

            <li>
                <?php if(is_array($info)): foreach($info as $k=>$v): ?><dl class="hzdw_pic fl">
                    <a href="http://<?php echo ($v["url"]); ?>" target="_blank">
                    <dt><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>" width='170' height='70'/></dt>
