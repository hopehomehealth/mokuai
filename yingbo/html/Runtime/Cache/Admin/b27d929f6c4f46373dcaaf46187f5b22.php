...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/TeamAssess/upd">修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/TeamAssess/upd/team_id/1.html" method="post" enctype='multipart/form-data' class="form-horizontal">
