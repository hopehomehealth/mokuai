...
<form action="/index.php/Admin/Basic/<?php echo ($op); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="form-group">
        <label class="control-label">网站名称 : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="name" value="<?php echo ($baseSet["name"]); ?>">
     ...
     <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="weixin" value="<?php echo ($baseSet["weixin"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <!--<div class="form-group">-->
        ...
        <!--<div class="controls pull-left">-->
            <!--<input type="file" class="input-large" name="logo" value="<?php echo ($baseSet["logo"]); ?>">-->
        <!--</div>-->
    <!--</div>-->
    <!--<div class="form-group">-->
        <!--<label class="control-label"></label>-->
        <!--<div class="controls pull-left">-->
            <!--<img src="<?php echo (SITE_URL); ?>/lehu/Public/<?php echo ($baseSet["logo"]); ?>" style="width:200px;height:80px">-->
        <!--</div>-->
    <!--</div>-->
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <textarea name="keyword" style='width:300px;height:100px;' class="textarea"><?php echo ($baseSet["keyword"]); ?></textarea>
            <span class="help-inline red"> * </span>
        </div>
    </div>
     ...
     <div class="form-group">
        ...
        <div class="controls pull-left">
            <textarea name="description" style='width:300px;height:100px;' class="textarea"><?php echo ($baseSet["description"]); ?></textarea>
            <span class="help-inline red"> * </span>
        </div>
    </div>
                    <div class="form-actions">
                        <?php if(!empty($baseSet)): ?><input type="hidden" name="basicid" value="<?php echo ($baseSet["id"]); ?>" />
                        <input type="hidden" name="oldname" value="<?php echo ($baseSet["name"]); ?>" />
                        <input type="hidden" name="oldweixin" value="<?php echo ($baseSet["weixin"]); ?>" />
                        <input type="hidden" name="oldkeyword" value="<?php echo ($baseSet["keyword"]); ?>" />
                        <!--<input type="hidden" name="oldlogo" value="<?php echo ($baseSet["logo"]); ?>" />-->
                        <input type="hidden" name="olddescription" value="<?php echo ($baseSet["description"]); ?>" /><?php endif; ?>
