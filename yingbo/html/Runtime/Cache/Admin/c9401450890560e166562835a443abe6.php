...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Trailer/tianjia">文章修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/Trailer/upd/trailer_id/6.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' name='trailer_id' value='<?php echo ($info["trailer_id"]); ?>' />
                    ...
                    <div class="form-group">
                        <label class="control-label"> 视频展示图片 : </label>
                        <div class="controls pull-left">
