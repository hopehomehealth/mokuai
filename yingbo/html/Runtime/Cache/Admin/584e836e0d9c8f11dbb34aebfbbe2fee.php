    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                选择日期&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" id="assessdate" name="date" style="width:117px;height:34px" placeholder="请选择日期" readonly>
                    ...
                    <?php if(is_array($assessList)): foreach($assessList as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/index.php/Admin/Assess/assess/userid/<?php echo ($v["userid"]); ?>"> <i class="icon-pencil bigger-130"></i>&nbsp;查看详情 </a>
                                </div>
                            </td>
