        ...
        <div class="row">
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align:center">
                    <thead>
                    <tr><th width="75px" style="text-align:center">评估师编号</th>
                        <th width="75px" style="text-align:center">图像</th>
                        ...
                        <th width="50px" style="text-align:center">认证状态</th>
                    ...
                    <?php if(is_array($assessList)): foreach($assessList as $k=>$v): ?><tr>
                            ...
                            <td><?php if($v["photo"] == ''): ?><img src="<?php echo (IMG_URL); ?>pgtu.jpg" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php else: ?><img src="/Public/<?php echo ($v["photo"]); ?>" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php endif; ?></td>
                            ...
                            <td style="text-align:left">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green moreinfo" href="/index.php/Admin/Assess/upd/userid/<?php echo ($v["userid"]); ?>"> <i class="icon-eye-open bigger-130"></i>&nbsp;<span>详细资料</span> <input type="hidden" name="userid" value="<?php echo ($v["userid"]); ?>"></a>
