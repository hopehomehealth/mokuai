...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Link/tianjia">添加链接 </a> </li>
    ...
    <form action="/index.php/Admin/Link/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
