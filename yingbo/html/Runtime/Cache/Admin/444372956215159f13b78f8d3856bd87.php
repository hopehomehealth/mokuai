...
<div class="sidebar" id="sidebar">
    ...
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Auth/tianjia">权限添加 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form action="/index.php/Admin/Auth/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
