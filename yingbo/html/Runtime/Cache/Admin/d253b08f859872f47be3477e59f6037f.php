...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Product/upd">商品修改 </a> </li>
...
<form action="/index.php/admin/product/upd/pro_id/110.html" method="post" class="form-horizontal" enctype="multipart/form-data">
    <input type="hidden" name="pro_id" value="<?php echo ($info["pro_id"]); ?>">
    <div class="form-group">
        <label class="control-label">中文名称 : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="china" value="<?php echo ($info["china"]); ?>">
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="english" value="<?php echo ($info["english"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-medium" name="price" value="<?php echo ($info["price"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
                    <div class="form-group">
    ...
    <div class="controls pull-left">
        <select class="input-medium" name="discount" value="<?php echo ($info["discount"]); ?>">
            <option>无</option>
        </select>
    </div>
</div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <select class="input-medium" name="cat" >

                    <option value='0'>-请选择-</option>
                    <?php if(is_array($catinfoA)): foreach($catinfoA as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>" <?php if($v['cat_id'] == $info['cat_id']): ?>selected<?php else: endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="is_on" <?php echo ($info['is_on']?"":"checked"); ?> value="0">
                                <span class="lbl">上架</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="is_on" <?php echo ($info['is_on']?"checked":""); ?> value="1">
    ...
    <div class="form-group">
        ...
        <div class="controls pull-left">
            ...
            <div id="pic_div"><img src='<?php echo (SITE_URL); echo (substr($info["pic"],2)); ?>' id='pic_img' width='160' height='100'></div>
        </div>
    </div>
    <script type='text/javascript'>
        $(function(){
            new uploadPreview({ UpBtn: "pic", DivShow: "pic_div", ImgShow: "pic_img" });
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="introduce"><?php echo ($info["introduce"]); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <textarea class="input-large" style="margin: 0px; height: 115px; width: 530px;" name="remarks"><?php echo ($info["remarks"]); ?></textarea>
                        </div>
                    </div>
