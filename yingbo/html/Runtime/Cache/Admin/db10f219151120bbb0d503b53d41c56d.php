        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>广告列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Ad/tianjia">添加广告</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Ad/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        <th width="60px">标题</th>
                        <th width="60px">图片</th>
                        <th width="60px">链接地址</th>
                        <th width="60px">所属栏目</th>
                        <th width="60px">状态</th>
                        <!--<th width="60px">上级栏目</th>-->
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('ad_id'=>$v['ad_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('ad_id'=>$v['ad_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
