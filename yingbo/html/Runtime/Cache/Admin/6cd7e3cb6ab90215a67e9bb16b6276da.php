        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>护理师团队图片列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/TeamNurse/tianjia">添加图片</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/TeamNurse/showlist" method="post">
