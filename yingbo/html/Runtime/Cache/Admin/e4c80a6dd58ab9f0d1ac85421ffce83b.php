...
<form action="/index.php/Admin/Basic/<?php echo ($op); ?>" method="post" class="form-horizontal">
    <div class="form-group">
        <label class="control-label">AppID : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="appid" value="<?php echo ($sysSet["appid"]); ?>">
     ...
     <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="appsecret" value="<?php echo ($sysSet["appsecret"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="apid" value="<?php echo ($sysSet["apid"]); ?>">
            <span class="help-inline red"> * </span>
        </div>
    </div>
                    <div class="form-actions">
                        <?php if(!empty($sysSet)): ?><input type="hidden" name="basicid" value="<?php echo ($sysSet["id"]); ?>" />
                        <input type="hidden" name="oldappid" value="<?php echo ($sysSet["appid"]); ?>" />
                        <input type="hidden" name="oldappsecret" value="<?php echo ($sysSet["appsecret"]); ?>" />
                        <input type="hidden" name="oldapid" value="<?php echo ($sysSet["apid"]); ?>" /><?php endif; ?>
