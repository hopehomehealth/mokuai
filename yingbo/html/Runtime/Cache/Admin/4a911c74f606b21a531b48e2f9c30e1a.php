...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Contact/upd">留言修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/admin/contact/upd/contact_id/189.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                ...
                                <input type="radio" class="ace" name="visit" value="0" <?php if(($info["visit"]) == "0"): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">随时</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="visit" value="1"<?php if(($info["visit"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">上班时间</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="visit" value="2" <?php if(($info["visit"]) == "2"): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">下班时间</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="visit" value="3" <?php if(($info["visit"]) == "3"): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">周末</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <label>
                                <input type="radio" class="ace" name="sex" value="0" <?php if(($info["sex"]) == "0"): ?>checked="checked"<?php endif; ?>>
                                <span class="lbl">先生</span>
                            </label>
                            <label>
                                <input type="radio" class="ace" name="sex" value="1" <?php if(($info["sex"]) == "1"): ?>checked="checked"<?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="iphone" value="<?php echo ($info["iphone"]); ?>">
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <textarea class="input-large"  name="content" ><?php echo ($info["content"]); ?></textarea>
                        </div>
                    </div>
