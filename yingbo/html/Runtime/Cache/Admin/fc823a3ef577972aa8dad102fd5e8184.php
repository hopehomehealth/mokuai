...
<form action="<?php echo U('/Admin/Pay/upd');?>" method="post" class="form-horizontal">
    ...
    <?php if(!empty($info["appid"])): ?><div class="form-group">
        <label class="control-label">appid : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="appid" value="<?php echo ($info["appid"]); ?>">
        </div>
    </div><?php endif; ?>
     <?php if(!empty($info["paysignkey"])): ?><div class="form-group">
        <label class="control-label">签名paysignkey : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="paysignkey" value="<?php echo ($info["paysignkey"]); ?>" readonly>
        </div>
    </div><?php endif; ?>
     <?php if(!empty($info["appsecret"])): ?><div class="form-group">
        <label class="control-label">appsecret : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="appsecret" value="<?php echo ($info["appsecret"]); ?>">
        </div>
    </div><?php endif; ?>
     <?php if(!empty($info["partnerid"])): ?><div class="form-group">
     ...
     <?php if(!empty($info["bpaysignkey"])): ?><div class="form-group">
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="bpaysignkey" value="<?php echo ($info["bpaysignkey"]); ?>">
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="payid" value="<?php echo ($_GET['id']); ?>" />
