...
<div class="main-content">
    ...
    <div class="box-title margin_bot_20">
        <div class="span10">
            ...
            <form method="post" action="/index.php/Admin/Assess/upd" enctype="multipart/form-data">
            <table class="table table-striped table-bordered table-moreinfo-assess" style="height:600px">
                <tr>
                    <th>姓名</th><td><input type="text" name="username" value="<?php echo ($assessinfo["username"]); ?>"></td><th>性别</th><td><input type="radio" name="sex" <?php echo ($assessinfo['sex']?"":"checked"); ?> value="0">女&nbsp;<input type="radio" name="sex" <?php echo ($assessinfo['sex']?"checked":""); ?> value="1">男</td><th>年龄</th><td><input type="text" name="age" value="<?php echo ($assessinfo["age"]); ?>"></td><th>照片</th><td><?php if($assessinfo["photo"] == ''): ?><img src="<?php echo (IMG_URL); ?>pgtu.jpg" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php else: ?><img src="/Public/<?php echo ($assessinfo["photo"]); ?>" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php endif; ?><br/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="photo" style="display:inline;width:200px"></td>
                </tr>
                <tr>
                    <th>身份证号</th><td><input type="text" name="number" value="<?php echo ($assessinfo["number"]); ?>"></td><th>工作单位</th><td><input type="text" name="company" value="<?php echo ($assessinfo["company"]); ?>"></td><th>城市</th><td>
                        <select name="province_id" class="province selectarea">
                            <option value=''><?php if($assessinfo["city"] == ''): ?>省<?php else: echo ($assessinfo["city"]); endif; ?></option>
                        ...
                        <input type="hidden" name="city" value="<?php echo ($assessinfo["city"]); ?>"> 
                </td><th>详细地址</th><td><input type="text" name="area" value="<?php echo ($assessinfo["area"]); ?>"></td>
                </tr>
                <tr><input type="hidden" name="userid" value="<?php echo ($_GET['userid']); ?>"></tr>
                <tr><th>学校</th><td><input type="text" name="school" value="<?php echo ($assessinfo["school"]); ?>"></td><th>电话</th><td><input type="text" name="iphone" value="<?php echo ($assessinfo["iphone"]); ?>">
                <input type="hidden" name="oldphoto" value="<?php echo ($assessinfo["photo"]); ?>"></td><th></th><td></td><th></th><td></td>
                </tr>
                <tr>
