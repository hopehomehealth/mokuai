        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>管理员列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Manager/tianjia">添加管理员</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Manager/showlist" method="post">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="red detail" href="<?php echo U('del',array('mg_id'=>$v['mg_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
