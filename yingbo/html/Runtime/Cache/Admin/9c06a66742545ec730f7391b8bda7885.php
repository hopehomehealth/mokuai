...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Service/tianjia">添加服务 </a> </li>
    ...
    <form action="/index.php/Admin/Service/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <textarea class="input-large" style="margin: 0px; height: 115px; width: 360px;" name="description"></textarea>
                <span class="help-inline red"> * </span>
            </div>
        </div>
        <div class="form-group">
        ...
        <!--<div class="form-group">-->
            ...
            <!--<div class="controls pull-left">-->
                ...
                <!--<div id="pic_div2"><img id='pic_img2' width='160' height='100'></div>-->
            <!--</div>-->
        <!--</div>-->
        <script type='text/javascript'>
            $(function(){
