...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Column/upd">栏目修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/admin/column/upd/col_id/10.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' id='extcolids' value='<?php echo ($extcolids); ?>' />
                    <input type='hidden' name='col_id' value='<?php echo ($info["col_id"]); ?>'/>
                    <div class="form-group">
                        <label class="control-label">名称 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="title" value="<?php echo ($info["name"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="keyword" value="<?php echo ($info["keywords"]); ?>">
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
                    <div class="form-group">
