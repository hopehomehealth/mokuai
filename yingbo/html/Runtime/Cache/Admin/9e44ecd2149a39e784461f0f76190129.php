        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>健康服务助理团队列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/TeamHealth/tianjia">添加图片</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/TeamHealth/showlist" method="post">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('team_id'=>$v['team_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('team_id'=>$v['team_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
