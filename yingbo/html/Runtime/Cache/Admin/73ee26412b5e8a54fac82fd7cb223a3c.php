...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Example/tianjia">案例修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/Example/upd/example_id/1.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' name='example_id' value='<?php echo ($info["example_id"]); ?>' />
...
<script type="text/javascript">
    var ue = UE.getEditor('content',{toolbars: [[
        ...
        'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'toupperExample', 'tolowerExample', '|',
