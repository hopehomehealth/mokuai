...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Column/tianjia">栏目添加 </a> </li>
    ...
    <form action="/index.php/Admin/Column/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
        ...
        <div class="form-group">
            <label class="control-label">栏目上级 : </label>
            <div class="controls pull-left">
                <select class="input-medium" name="pid">
                    <option value='0'>-请选择-</option>
                    <?php if(is_array($colinfo)): foreach($colinfo as $key=>$v): ?><option value='<?php echo ($v["col_id"]); ?>'>
                            <?php echo str_repeat('--/',$v['level']); echo ($v["name"]); ?>
        ...
        <div class="controls pull-left">
            <input type="text" class="input-large" name="keywords">
            <span class="help-inline red"> * </span>
        </div>
            </div>
        <div class="form-group">
