    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal" action="/index.php/Admin/Contact/showlist.html" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        ...
                        <th width="60px">回访时间</th>
                        <th width="60px">地址</th>
                        <th width="100px">留言内容</th>
                        <th width="40px">留言时间</th>
                        <th width="100px">操作</th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><?php echo ($v["contact_id"]); ?></td>
                            ...
                            <td>
                            <?php if($v["visit"] == 0): ?>随时
                                <?php elseif($v["visit"] == 1): ?>上班时间
                                <?php elseif($v["visit"] == 2): ?>下班时间
                                <?php else: ?> 周末<?php endif; ?>
                           </td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="green" href="<?php echo U('upd',array('contact_id'=>$v['contact_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('contact_id'=>$v['contact_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
