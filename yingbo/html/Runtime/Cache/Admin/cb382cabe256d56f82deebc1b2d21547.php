        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>登录记录表</h3>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/OperationLog/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        <th width="60px">登录人</th>
                        <th width="100px">登录ip</th>
                        <th width="40px">登录时间</th>
                        <th width="100px">操作</th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><?php echo ($v["operation_id"]); ?></td>
                            <td><?php echo ($v["operation_name"]); ?></td>
                            <td><?php echo ($v["operation_ip"]); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$v["operation_time"])); ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

                               <!--      <a class="green" href="<?php echo U('upd',array('operation_id'=>$v['operation_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a> -->
                                    <a class="red detail" href="<?php echo U('del',array('operation_id'=>$v['operation_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
