        ...
        <div class="row">
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered" style="text-align:center">
                    ...
                    <tr><th>充值前余额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($rechargeinfo["pre_money"]); ?>元</td>
                    </tr>
                    <tr><th>充值金额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($rechargeinfo["amount"]); ?>元</td>
                    </tr>
                    <tr><th>充值后余额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($rechargeinfo["money"]); ?>元</td>
                    </tr>
                    <tr><th>充值状态</th><td><?php echo ($rechargeinfo['status']?"<span style='color:green'>充值成功</span>":"<span style='color:red'>充值失败</span>"); ?></td>
                    </tr>
                </table>
                </form>
            </div>
