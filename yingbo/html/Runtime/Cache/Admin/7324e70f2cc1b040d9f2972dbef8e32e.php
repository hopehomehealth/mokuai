...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Train/tianjia">培训修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/admin/train/upd/train_id/9.html" method="post" enctype='multipart/form-data' class="form-horizontal">
