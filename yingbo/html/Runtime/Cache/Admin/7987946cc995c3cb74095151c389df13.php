    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal" action="<?php echo U('Admin/Recharge/records');?>" method="post">
                    <div class="form-group">
                        <label class="control-label" style="width:80px;">充值单号 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-medium" name="search">
                            <input type="hidden" class="input-medium" name="userid" value="<?php echo ($_GET['userid']); ?>">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="50px">编号</th>
                        <th width="50px">充值单号</th>
                        <th width="100px">充值金额</th>
                        <th width="60px">充值时间</th>
                        <th width="100px">操作</th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($rechargeList)): foreach($rechargeList as $k=>$v): ?><tr>
                            <td><?php echo ($firstno++); ?></td>
                            <td><?php echo ($v["rc_no"]); ?></td>
                            <td><?php echo ($v["amount"]); ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$v["inputtime"])); ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('lookup',array('rc_id'=>$v['rc_id'],'userid'=>$v['userid']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;查看详情 </a>
