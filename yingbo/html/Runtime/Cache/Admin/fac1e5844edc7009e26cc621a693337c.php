        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>商品分类列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Productclass/tianjia">添加分类</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Productclass/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        <th width="100px">商品分类名称</th>
                        <th width="100px">商品分类描述</th>
                        <!--<th width="100px">上级</th>-->
                        <!--<th width="100px">全路径</th>-->
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="red detail" href="<?php echo U('upd',array('cat_id'=>$v['cat_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
