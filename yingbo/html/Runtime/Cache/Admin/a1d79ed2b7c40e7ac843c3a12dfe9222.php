    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                ...
                <form class="form-horizontal" action="<?php echo U('/Admin/Patient/index');?>">
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align:center">
                    <thead>
                    <tr><th width="50px" style="text-align:center">会员编号</th>
                        <th width="100px" style="text-align:center">图像</th>
                        <th width="60px" style="text-align:center">姓名</th>
                        <th width="60px" style="text-align:center">性别</th>
                        <th width="60px" style="text-align:center">年龄</th>
                        <th width="100px" style="text-align:center">城市</th>
                        <th width="100px" style="text-align:center">详细地址</th>
                        <th width="100px" style="text-align:center">联系电话</th>
                        <!-- <th width="60px" style="text-align:center">用户级别</th> -->
                        <th width="100px" style="text-align:center">患者关系</th>
                        <th width="100px" style="text-align:center">账户余额</th>
                        <th width="100px" style="text-align:center">操作</th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($patientList)): foreach($patientList as $k=>$v): ?><tr>
                            <td><?php echo ($firstno++); ?></td>
                            <td><?php if($v["photo"] == ''): ?><img src="<?php echo (IMG_URL); ?>pgtu.jpg" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php else: ?><img src="<?php echo ($v["photo"]); ?>" style="width:75px;height:75px;border-radius:50%;margin:0px"><?php endif; ?></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/index.php/Admin/Patient/upd/userid/<?php echo ($v["userid"]); ?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" onclick="return confirm('确定要删除吗')" href="/index.php/Admin/Patient/del/userid/<?php echo ($v["userid"]); ?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
