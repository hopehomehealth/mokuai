        ...
        <div class="row">
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align:center">
                    <thead>
                    <tr><th width="50px" style="text-align:center">护士编号</th>
                    ...
                    <?php if(is_array($nurseList)): foreach($nurseList as $k=>$v): ?><tr>
                            ...
                            <td style="text-align:left">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green moreinfo" href="/index.php/Admin/Nurse/upd/userid/<?php echo ($v["userid"]); ?>"> <i class="icon-eye-open bigger-130"></i>&nbsp;<span>详细资料</span> <input type="hidden" name="userid" value="<?php echo ($v["userid"]); ?>"></a>
