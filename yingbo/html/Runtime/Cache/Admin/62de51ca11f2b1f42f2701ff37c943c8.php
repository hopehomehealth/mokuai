...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/TeamManage/tianjia">添加图片 </a> </li>
    ...
    <form action="/index.php/Admin/TeamManage/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                <textarea class="input-large" style="margin: 0px; height: 100px; width: 350px;" name="description" ></textarea>
            </div>
        </div>
        <div class="form-group">
