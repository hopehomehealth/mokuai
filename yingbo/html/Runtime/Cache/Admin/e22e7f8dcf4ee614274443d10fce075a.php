...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Keyword/tianjia">图文回复添加 </a> </li>
    ...
    <form action="" method="post" id="postF" enctype='multipart/form-data' class="form-horizontal">
		<input type="hidden" name="t_id" value="<?php echo ($info["id"]); ?>">
        <div class="form-group">
            <label class="control-label">标题 : </label>
            <div class="controls pull-left">
            <input type="text" class="input-large" id="title" value="<?php echo ($info["title"]); ?>" name="title">
        ...
        <div class="form-group">
			...
			<div class="controls pull-left">
				<input type="text" class="input-large" name="keyword"  value="<?php echo ($info["keyword"]); ?>" id = 'keyword'>
				<span class="help-inline red"> * </span>
			</div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="controls pull-left">
                ...
                <div id="pic_div"><img id='pic_img' src="<?php echo ($info["img_url"]); ?>" width='160' height='100'></div>
            </div>
        </div>
        <script type='text/javascript'>
            $(function(){
        ...
        <div class="form-group">
        <label class="control-label">图文外链网址: </label>
        <div class="controls pull-left">
        <input type="text" class="input-large" id="url" name="url"  value="<?php echo ($info["url"]); ?>">
        <span class="help-inline red"> * URL地址: 必须与http:// 或 https://开始 例如：http://www.hlnv.com</span>
        </div>
        </div>
        ...
        <div class="controls pull-left">
        <textarea class="input-large" id="description" style="margin: 0px; height: 115px; width: 530px;" name="description"  ><?php echo ($info["jianjie"]); ?></textarea>
        </div>
        </div>
        ...
        <div class="controls pull-left">
            <textarea rows="5" cols="30" id='content' name='content' style='width:550px;height:260px;'><?php echo ($info["descs"]); ?></textarea>
        </div>
        </div>
