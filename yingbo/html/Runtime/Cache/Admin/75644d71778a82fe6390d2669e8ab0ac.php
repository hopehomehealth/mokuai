        ...
        <div class="row">
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered" style="text-align:center">
                    ...
                    <tr><th>提现前余额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($postalinfo["pre_money"]); ?>元</td>
                    </tr>
                    <tr><th>提现金额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($postalinfo["balance"]); ?>元</td>
                    </tr>
                    <tr><th>提现后余额</th><td style="color:red;font-size:120%;font-weight:bold;"><?php echo ($postalinfo["money"]); ?>元</td>
                    </tr>
                    ...
                    <tr><th>操作(打款成功后操作)</th><td><?php if($postalinfo["status"] == '0'): ?><button class="btn btn-big" style="margin-left:20px;background:green">确认打款</button><?php else: endif; ?></td>
                    </tr>
                </table>
                </form>
            </div>
