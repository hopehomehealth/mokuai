        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>培训列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Train/tianjia">添加培训</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Train/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        ...
                        <th width="80px">展示图片</th>
                        <th width="60px">状态</th>
                        <th width="100px">操作</th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><?php echo ($v["train_id"]); ?></td>
                            <td><?php echo ($v["china"]); ?></td>
                            <td><?php echo ($v["english"]); ?></td>
                            <td><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>"  width='100' height='65'/></td>
                            <td><?php if(($v["is_show"]) == "0"): ?>显示
                                <?php else: ?>
                                隐藏<?php endif; ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('train_id'=>$v['train_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('train_id'=>$v['train_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
