        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>案例列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Example/tianjia">添加案例</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Example/showlist.html" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($exampleinfo)): foreach($exampleinfo as $k=>$v): ?><tr>
                            <td><?php echo ($v["example_id"]); ?></td>
                            <td><?php echo ($v["name"]); ?></td>
                            <td><img src='<?php echo (SITE_URL); echo ($v["pic"]); ?>' alt='图标' width='120' height='65' /></td>
                            <td><?php if(($v["is_show"]) == "0"): ?>显示
                                <?php else: ?>
                                隐藏<?php endif; ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('example_id'=>$v['example_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('example_id'=>$v['example_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
