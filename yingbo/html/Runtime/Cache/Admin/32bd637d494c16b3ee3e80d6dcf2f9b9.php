...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Manager/upd">管理员修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/Manager/upd/mg_id/1.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' name='mg_id' value='<?php echo ($info["mg_id"]); ?>' />
                    <div class="form-group">
                        <label class="control-label">名称 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="mg_name" value="<?php echo ($info["mg_name"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="mg_pwd" value="<?php echo ($info["mg_pwd"]); ?>">
                            <span class="help-inline red"> * </span>
                        </div>
                    </div>
                    <div class="form-group">
