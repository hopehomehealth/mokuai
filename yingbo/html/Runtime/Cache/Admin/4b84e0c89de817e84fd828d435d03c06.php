...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Example/tianjia">文章发布 </a> </li>
    ...
    <form action="/index.php/Admin/Example/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
