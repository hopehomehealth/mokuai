...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/News/tianjia">文章发布 </a> </li>
    ...
    <form action="/index.php/admin/news/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
        ...
        <div class="controls pull-left">
            <textarea rows="5" cols="30" id='content' name='content' style='width:880px;height:500px;'></textarea>
        </div>
        </div>
