        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>预约评估列表</h3>
                    </div>
                </div>
                <form class="form-horizontal" action="<?php echo U('/Admin/Yuyue/index');?>" method="post">
                    <div class="form-group">
                        <label class="control-label" style="width:80px;">预约单号 : </label>
                ...
                <form class="form-horizontal" action="<?php echo U('/Admin/Yuyue/index');?>" method="get">
                    <div class="form-group">
                    ...
                    <?php if(is_array($orderList)): foreach($orderList as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/index.php/Admin/Yuyue/orderinfo/orderid/<?php echo ($v["orderid"]); ?>"> <i class="icon-eye-open bigger-130"></i>&nbsp;查看订单 </a>
