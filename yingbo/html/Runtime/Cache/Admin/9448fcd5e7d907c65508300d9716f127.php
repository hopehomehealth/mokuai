                    ...
                    <?php if(is_array($postalList)): foreach($postalList as $k=>$v): ?><tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('examine',array('cash_id'=>$v['cash_id'],'count_id'=>$v['count_id'],'userid'=>$v['userid']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;审核 </a>
