        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>服务列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Service/tianjia">添加服务</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Service/showlist.html" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr><th width="30px" >ID</th>
                        <th width="100px">中文标题</th>
                        <th width="100px">英文标题</th>
                        <th width="100px">背景图</th>
                        <th width="100px">二维码图</th>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            ...
                            <td><?php echo ($v["china"]); ?></td>
                            <td><?php echo ($v["english"]); ?></td>
                            <td><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>"  width='50' height='50'/></td>
                            <td><img src="<?php echo (SITE_URL); echo (substr($v["img"],2)); ?>"  width='50' height='50'/></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('service_id'=>$v['service_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('service_id'=>$v['service_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
