        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>宣传片列表</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Trailer/tianjia">添加宣传片</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Trailer/showlist" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><?php echo ($v["trailer_id"]); ?></td>
                            <td><?php echo ($v["title"]); ?></td>
                            <td><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>"  width='100' height='50'/></td>
                            <td><a><?php echo ($v["url"]); ?></a></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('trailer_id'=>$v['trailer_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('trailer_id'=>$v['trailer_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
