...
<div class="sidebar" id="sidebar">
    ...
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Role/tianjia">添加角色</a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/Role/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label" align="right">角色名称 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="role_name">
