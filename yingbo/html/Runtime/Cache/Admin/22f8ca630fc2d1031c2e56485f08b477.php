            ...
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align:center">
                    ...
                    <tr><th width="50px">会员ID</th>
                        ...
                        <th width="60px">用户级别</th>
                        <th width="100px">患者关系</th>
                    ...
                    <?php if(is_array($patientList)): foreach($patientList as $k=>$v): ?><tr>
                            ...
                            <td><img src="" style="width:75px;height:75px;border-radius:50%"></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/index.php/Admin/Nurse/upd/userid/<?php echo ($v["id"]); ?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="/index.php/Admin/Nurse/del/userid/<?php echo ($v["id"]); ?>"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
