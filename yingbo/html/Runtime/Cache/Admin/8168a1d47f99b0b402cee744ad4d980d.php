        ...
        <div class="row">
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        <h3><i class="icon-cogs"></i>关于乐护</h3>
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/About/tianjia">发布</a></div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($aboutinfo)): foreach($aboutinfo as $k=>$v): ?><tr>
                            <td><?php echo ($v["about_id"]); ?></td>
                            <td><?php echo ($v["title"]); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$v["input_time"])); ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('upd',array('about_id'=>$v['about_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('about_id'=>$v['about_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
