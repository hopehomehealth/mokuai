            ...
            <div class="page-content box">
                <div class="box-title margin_bot_20">
                    <div class="span10">
                        ...
                        <div class="pull-right"><a class="btn btn-success btn-sm" href="/index.php/Admin/Column/tianjia">添加栏目</a></div>
                    </div>
                </div>
                <form class="form-horizontal" action="/index.php/Admin/Column/showlist" method="post">
                    <div class="form-group">
                        <label class="control-label" style="width:80px;">栏目名称 : </label>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr><th width="30px" ><div align="center">ID</div></th>
                        <th width="100px"><div align="center">栏目名称</div></th>
                        <th width="100px"><div align="center">添加时间</div></th>
                        <th width="100px"><div align="center">修改时间</div></th>
                        <th width="50px"><div align="center">上级</div></th>
                        <th width="70px"><div align="center">栏目全路径</div> </th>
                        <th width="50px"><div align="center">栏目等级</div></th>
                        <!--<th width="40px"><div align="center">状态</div></th>-->
                        <th width="100px"><div align="center">操作</div></th>
                    </tr></thead>
                    <tbody>
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                            <td><div align="center"><?php echo ($v["col_id"]); ?></div></td>
                            <td><div align="left"><?php echo str_repeat('-->',$v['level']); echo ($v["name"]); ?></div></td>
                            <td><div align="center"><?php echo (date('Y-m-d H:i:s',$v["input_time"])); ?></div></td>
                            <td><div align="center"><?php echo (date('Y-m-d H:i:s',$v["update_time"])); ?></div></td>
                            ...
                            <!--<td><div align="center"><?php echo ($v["status"]); ?></div></td>-->
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons" align="center">
                                    <a class="green" href="<?php echo U('upd',array('col_id'=>$v['col_id']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;编辑 </a>
                                    <a class="red detail" href="<?php echo U('del',array('col_id'=>$v['col_id']));?>" onclick="return confirm('是否确认删除？');"> <i class="icon-trash bigger-130"></i>&nbsp;删除 </a>
                                </div>
                            </td>
