...
<form action="/index.php/Admin/Weixin/wxadd" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="form-group">
        <label class="control-label">公众号账号 : </label>
        <div class="controls pull-left">
            <input type="text" class="input-large" name="name" value="">
            <span class="help-inline red"> * </span>
        </div>
    </div>
     <div class="form-group">
        <label class="control-label">公众号密码 : </label>
        <div class="controls pull-left">
            <input type="password" class="input-large" name="weixin" value="">
            <span class="help-inline red"> * </span>
        </div>
    </div>
