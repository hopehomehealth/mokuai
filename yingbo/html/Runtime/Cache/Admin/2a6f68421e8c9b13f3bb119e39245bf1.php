...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Trailer/tianjia">添加宣传片 </a> </li>
    ...
    <form action="/index.php/Admin/Trailer/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
