...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/TeamAssess/tianjia">添加图片 </a> </li>
    ...
    <form action="/index.php/Admin/TeamAssess/tianjia" method="post" enctype='multipart/form-data' class="form-horizontal">
