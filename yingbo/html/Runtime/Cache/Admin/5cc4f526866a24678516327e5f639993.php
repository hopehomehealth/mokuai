            ...
            <div class="page-content box">
                ...
                <div class="aboluo-w-700">
                    ...
                    <div class="aboluo-rightdiv">
                        ...
                        <p class="aboluo-personaltitle"><span>当前日期评估师列表</span></p>
                        <p id="aboluo-personallist">
                        
                        <?php if(is_array($assessList)): foreach($assessList as $key=>$info): ?><div class="base-info">
                            <a href="">
                                <span>排班ID：<?php echo ($info["id"]); ?></span>
                                <span>姓名：<b style="font-size:15px;color:white"><?php echo ($info["username"]); ?></b></span>
                                <span>电话：<?php echo ($info["iphone"]); ?></span>
                                <span>地址：<?php echo ($info["area"]); ?></span>
                            </a>
