...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/Service/tianjia">服务修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/Service/upd/service_id/1.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' name='service_id' value='<?php echo ($info["service_id"]); ?>' />
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <input type="file" class="input-large" id="pic2" name="img" >
                            <div id="pic_div2"><img src='<?php echo (SITE_URL); echo (substr($info["img"],2)); ?>' id='pic_img2' width='160' height='100'></div>
                        </div>
                    </div>
                    <script type='text/javascript'>
                        $(function(){
