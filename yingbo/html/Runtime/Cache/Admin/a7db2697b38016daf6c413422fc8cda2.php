        ...
        <div class="row">
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered table-orderinfo">
                    ...
                    <tr>
                        <th>患者姓名</th><td><?php echo ($orderinfo["username"]); ?></td><th>详细地址</th><td><?php echo ($orderinfo["area"]); ?></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".importnurse").click(function(){
            ...
            $.post("/index.php/Admin/Schedule/nurse",{"year":arr[0],"month":arr[1],"day":arr[2]},function(data){
                if(data.error == 1){
                }else{
        ...
        $('#importassess').click(function(){
            ...
            $.post("/index.php/Admin/Schedule/assess",{"year":arr[0],"month":arr[1],"day":arr[2]},function(data){
                if(data.error == 1){
                }else{
        ...
        $("#btn-assess").click(function(){
            $.post("/index.php/Admin/Order/handleOrder",{"orderid":orderid,"comid":$('#selectassess').val()},function(data){
                if(data.error == 1){
                }else{
