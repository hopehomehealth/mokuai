            ...
            <div class="page-content box">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($postalList)): foreach($postalList as $k=>$v): ?><tr>
                            <td><?php echo ($v["rc_id"]); ?></td>
                            <td><?php echo ($v["rc_no"]); ?></td>
                            <td><?php echo ($v["amount"]); ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$v["inputtime"])); ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo U('lookup',array('rc_id'=>$v['cash_id'],'userid'=>$v['userid']));?>"> <i class="icon-pencil bigger-130"></i>&nbsp;查看详情 </a>
