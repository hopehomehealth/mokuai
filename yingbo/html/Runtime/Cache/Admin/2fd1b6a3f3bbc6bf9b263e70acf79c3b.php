...
<div class="main-content">
    <div class="breadcrumbs">
        <ul>
            <li > <a href="/index.php/Admin/About/upd">文章修改 </a> </li>
    ...
    <div class="page-content">
        <div class="row">
            <div class="page-content box">
                <form action="/index.php/Admin/About/upd/about_id/1.html" method="post" enctype='multipart/form-data' class="form-horizontal">
                    <input type='hidden' name='about_id' value='<?php echo ($aboutinfo["about_id"]); ?>' />
                    <div class="form-group">
                        <label class="control-label">标题 : </label>
                        <div class="controls pull-left">
                            <input type="text" class="input-large" name="title" value="<?php echo ($aboutinfo["title"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls pull-left">
                            <textarea rows="5" cols="30" id='content' name='content' style='width:880px;height:500px;'><?php echo ($aboutinfo["content"]); ?></textarea>
                        </div>
                    </div>
