...
<div id="box" class="indexBox">
    ...
    <div class="main">
        <ul class="caseBox">
            <?php if(is_array($exampleinfo)): foreach($exampleinfo as $key=>$v): ?><li>
                    <a href="<?php echo U('Example/example_list',array('example_id'=>$v['example_id']));?>">
                        <div class="CaseTx">
                            <img src="<?php echo (SITE_URL); echo ($v["pic"]); ?>">
                        </div>
                        <div class="CaseTxT">
                            <strong><?php echo ($v["name"]); ?></strong>
                            <span><?php echo (mb_substr(str_replace(array(" ","　","t","n","r"),array("","","","",""),strip_tags($v["content"])),0,33,'utf-8')); ?>...</span>
                        </div>
                    </a>
