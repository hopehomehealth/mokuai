...
<div id="box" class="indexBox">
    <header>
        ...
        <div class="main">
            <?php if(empty($info["photo"])): ?><div class="tuXTop">
                <span class="tuxiang" style="background-image:url(<?php echo (MBIMG_URL); ?>hs.jpg)"></span>
            </div><?php endif; ?>
            <?php if(!empty($info["photo"])): ?><div class="tuXTop">
                <span class="tuxiang" style="background-image:url(/Public/<?php echo ($info["photo"]); ?>)"></span>
            </div><?php endif; ?>
            <ul class="txNav">
                <li>
            ...
            <ul class="userList borBot">
                <li class="borTop">
                    <a href="/index.php/Mobile/Nurse/allOrder">
                        <i class="ico"></i>
                        我的订单
                        <i class="moreUser"></i>
                    </a>
            ...
            <ul class="userList borBot">
                <li class="borTop">
                    <a href="/index.php/Mobile/Nurse/xinxi">
                ...
                <li class="borTop">
                    <a href="/index.php/Mobile/Nurse/timetable">
                ...
                <!-- <li class="borTop">
                    <a href="/index.php/Mobile/Nurse/pinggu">
            ...
            <ul class="userList borBot">
                <li class="borTop">
                    <a href="/index.php/Mobile/Nurse/cash">
