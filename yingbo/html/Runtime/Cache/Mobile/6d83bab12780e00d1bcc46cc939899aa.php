            ...
            <section>
                <div class="banner swiper-container">
                    ...
                    <ul class="swiper-wrapper">
                        <?php if(is_array($adinfo)): foreach($adinfo as $key=>$v): ?><li class="swiper-slide">
                            <img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>"/>
                        </li><?php endforeach; endif; ?>
                    </ul>
                    <div class="swiper-pagination bannerDote"></div>
                </div>
            </section>
            <section>
                <ul class="navBox navOne borBot">
                    <li>
                        <a href="<?php echo U('Jianjie/jianjie');?>">
                           <img src="<?php echo (MBIMG_URL); ?>nav1.jpg"> 
                           <span>乐护简介</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Example/example');?>">
                           <img src="<?php echo (MBIMG_URL); ?>nav2.jpg"> 
                           <span>服务案例</span>
                        </a>
                    </li>
                </ul>
                <ul class="navBox navTwo borBot">
                    <li>
                        <a href="<?php echo U('Medical/medical');?>">
                           <img src="<?php echo (MBIMG_URL); ?>nav3.jpg"> 
                           <span>医学知识</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Gongyi/showlist');?>">
                           <img src="<?php echo (MBIMG_URL); ?>nav4.jpg"> 
                           <span>乐护公益</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Example/liucheng');?>">
                           <img src="<?php echo (MBIMG_URL); ?>nav5.jpg"> 
                           <span>服务流程</span>
                        </a>
                    </li>
                    <li>
                        <a href="/index.php/Mobile/Product/fuwu">
                           <img src="<?php echo (MBIMG_URL); ?>nav6.jpg"> 
                           <span>选择服务</span>
                        </a>
                    </li>
                </ul>
