...
<div id="box" class="indexBox">
    ...
    <div class="main">
        <div class="zsBanner">
            <?php if(is_array($adinfo)): foreach($adinfo as $key=>$v): ?><img src="<?php echo (SITE_URL); echo (substr($v["pic"],2)); ?>"/><?php endforeach; endif; ?>
        </div>
        <ul class="jjNav">
            <li>
                <a href="<?php echo U('Medical/huli');?>">
                    <img src="<?php echo (MBIMG_URL); ?>zs_nav1.jpg">
                    <span>护理健康知识</span>
                </a>
            </li>
            <!--<li>-->
                <!--<a href="<?php echo U('Medical/yiliao');?>">-->
                    <!--<img src="<?php echo (MBIMG_URL); ?>zs_nav2.jpg">-->
                    <!--<span>相关医疗信息/政策</span>-->
                <!--</a>-->
            <!--</li>-->
            <li>
                <a href="<?php echo U('Example/example');?>">
                    <img src="<?php echo (MBIMG_URL); ?>zs_nav3.jpg">
                    <span>服务案例（往期回顾）</span>
                </a>
            </li>
        </ul>
