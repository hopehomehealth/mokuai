                ...
                if($(this).val() == 'wxpay'){
                  ...
                  $("#payform button").click(function(){
                      $.post(url,parameters,function(data){
                        if(data.error == 1){
                          $("body").append("<div id='bal_err_msg' style='position:absolute;width:20rem;height:2rem;color:red;z-index:999;left:50%;top:50%;margin-left:-10rem;margin-top:-1rem'>"+data.content+"</div>")
                        }else{
                          $("body").append("<div id='bal_err_msg' style='position:absolute;width:20rem;height:2rem;color:green;z-index:999;left:50%;top:50%;margin-left:-10rem;margin-top:-1rem'>"+data.content+"</div>");
