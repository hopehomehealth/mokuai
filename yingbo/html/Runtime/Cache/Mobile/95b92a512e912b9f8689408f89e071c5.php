        ...
        <ul class="jjNav">
            <li>
                <a href="<?php echo U('Company/company');?>">
                    <img src="<?php echo (MBIMG_URL); ?>jj_nav1.jpg">
                    <span>公司介绍</span>
                </a>
            </li>
            <li>
                <a href="<?php echo U('Culture/culture');?>">
                    <img src="<?php echo (MBIMG_URL); ?>jj_nav2.jpg">
                    <span>企业文化介绍</span>
                </a>
            </li>
            <li>
                <a href="<?php echo U('Team/team');?>">
                    <img src="<?php echo (MBIMG_URL); ?>jj_nav3.jpg">
                    <span>团队介绍</span>
                </a>
            </li>
        </ul>
