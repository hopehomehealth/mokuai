            ...
            <ul class="caseBox">
                <li class="pgdet">
                   <a href="#">
                        ...
                        <span>￥<?php echo ($orderinfo["price"]); ?></span>                      
                    </a>
                </li>
                <li>
                  进度
                  <div class="fszx_jd borTop borBot">
                  <p <?php if($orderinfo["status"] == '1'): ?>class="list"<?php endif; if($orderinfo["status"] == '2'): ?>class="list1"<?php endif; if($orderinfo["is_com"] == '1'): ?>class="list2"<?php else: endif; ?>></p>
                  <ul class="fszx_list">
                  <li>已接单&nbsp;&nbsp;&nbsp;&nbsp;</li>
                  <li>上门护理</li>
                  <li>护理结束</li>
                ...
                订单信息
                   ...
                   <li>订单总额：￥<?php echo ($orderinfo["nsum"]); ?></li>
                   </ul>
                </li>
                <?php if($orderinfo["status"] == '0'): ?><li><a href="/index.php/Mobile/Nurse/toServe/orderid/<?php echo ($orderinfo["orderid"]); ?>"><button class="submit updateBtn">上门服务</button></a></li>
                <?php elseif($orderinfo["status"] == '1'): ?>
                  <li><a href="/index.php/Mobile/Nurse/served/orderid/<?php echo ($orderinfo["orderid"]); ?>"><button class="submit updateBtn">服务结束</button></a></li>
                <if condition="$orderinfo.status eq '2'"><?php endif; ?>
