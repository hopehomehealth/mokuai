...
<div id="box" class="indexBox">
    <header>
        <?php if($daohang["first"] == '乐护首页'): ?><div class="headTit"><?php echo ($daohang["first"]); ?></div>
            ...
            <div class="main">
            <form action="/index.php/Mobile/Patient/cash" id="form-cash" method="post" class="cash_z">
                    <div class="form1 cash">
                        <div class="borBot" id="pos-error-msg" style="position:relative;">
                                <span>可提现金额：</span>
                                <p><?php echo ($money); ?>元</p>
                                <span style="position:absolute;right:2rem;top:0.875rem"><a style="color:green;font-size:0.875rem" href="/index.php/Mobile/Patient/records">历史提现记录</a></span>
                        </div>
                        <div class="borBot">
                            <span>金额(元)：</span>
                        ...
                        <div class="borBot">
                            <span></span>
                            <a style="margin-left:0.5rem;color:green" href="/index.php/Mobile/Patient/addCount">添加提现账户</a>
                        </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#sub-cash").click(function(){
                ...
                $.post("/index.php/Mobile/Patient/cash",$("#form-cash").serialize(),function(data){
                    if(data.error == 1){
