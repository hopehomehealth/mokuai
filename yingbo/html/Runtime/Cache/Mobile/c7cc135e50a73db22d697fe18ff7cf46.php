        ...
        <div class="main">
            ...
            <div>
                <div class="orderlist cur"> 
                   <div class="wddd">
                  <ul class="wmc_con">
                  <span style="padding-bottom:0.875rem;color:#00a6d2">预约评估订单</span>
                  ...
                  <span style="padding-bottom:0.875rem;color:#00a6d2">预约服务订单</span>
                  <?php if(is_array($orderList)): foreach($orderList as $key=>$info): if(($info["auserid"] == '') and ($info["shopid"] != '')): ?><a href="/index.php/Mobile/Patient/orderinfo/orderid/<?php echo ($info["orderid"]); ?>/suborderid/<?php echo ($info["suborder"]["orderid"]); ?>">
                    <li>   
                    <p class="wmc_tb wmc_bj"></p>
                    <div class="wmc_list">
                       <p class="wwcd_tit">描述<span><?php echo (date("Y-m-d",$info["inputtime"])); ?></span></p>
                ...
                <div class="orderlist" style="color:red"> 
                  ...
                  <?php if(is_array($assessorder)): foreach($assessorder as $key=>$assessinfo): if($assessinfo["status"] == '1'): ?><li>   
                    ...
                    <?php if(is_array($nurseorder)): foreach($nurseorder as $key=>$nurseinfo): if($nurseinfo["status"] == '1'): ?><a href="/index.php/Mobile/Patient/orderinfo/orderid/<?php echo ($nurseinfo["orderid"]); ?>/suborderid/<?php echo ($nurseinfo["suborder"]["orderid"]); ?>">
                      ...
                      <div class="wmc_list">
                      <p class="wmc_tp"><img src="<?php echo (MBIMG_URL); ?>tx.jpg"></p>
                      <p class="wmc_wz"><?php echo ($nurseinfo["suborder"]["username"]); ?><span class="xinxin"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"></span><br>联系电话：<?php echo ($nurseinfo["suborder"]["iphone"]); ?><br>联系地址：<?php echo ($nurseinfo["suborder"]["area"]); ?></p>
