        ...
        <form action="/index.php/Mobile/Nurse/xinxi" method="post" enctype="multipart/form-data">
            <ul class="userList zrXx">
                ...
                <!--  <li class="borBot">
                   <a href="#">
                       全职or兼职  
                       <span class="xinx"><?php echo ($info["type"]); ?></span>                      
                       <i class="moreUser"></i>
                   </a>
                                </li> -->
                <li class="borBot">
                ...
                <li class="borBot">
                    <a href="#">
                        所属科室   
                        <span><?php echo ($info["departments"]); ?></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        护士证号   
                        <span><?php echo ($info["certificate"]); ?></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                 <li class="borBot">
                ...
                <li class="borBot">
                    <a href="#">
                        护士工龄
                        <span><?php echo ($info["standing"]); ?></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                ...
                <li class="borBot">
                    <a href="#">
                        详细居住地址  
                        <span><input style="text-align:right;color:#636363" type="text" name="area" value="<?php echo ($info["area"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
