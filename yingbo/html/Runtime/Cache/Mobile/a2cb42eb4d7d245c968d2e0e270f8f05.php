            ...
            <div>  
                <div style="color:blue"> 
                  ...
                  <?php if(is_array($assessorder)): foreach($assessorder as $key=>$assessinfo): ?><li>   
                      ...
                      <p class="wmc_wz"><?php echo ($assessinfo["username"]); ?><span class="xinxin"><?php $__FOR_START_1453486104__=0;$__FOR_END_1453486104__=$assessinfo["credit"];for($i=$__FOR_START_1453486104__;$i < $__FOR_END_1453486104__;$i+=1){ ?><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><?php } ?></span><br>联系电话：<?php echo ($assessinfo["iphone"]); ?><br>联系地址：<?php echo ($assessinfo["area"]); ?></p>
                      <p class="jxs_hs gray"><?php echo (date("Y-m-d",$assessinfo["inputtime"])); ?></p>
                      <p class="wmc_an"><a href="/index.php/Mobile/Patient/seelist/orderid/<?php echo ($assessinfo["orderid"]); ?>">去评价</a></p>
                      </div>
                  ...
                  <?php if(is_array($nurseorder)): foreach($nurseorder as $key=>$nurseinfo): ?><li> 
                    ...
                    <p class="wmc_wz"><?php echo ($nurseinfo["username"]); ?><span class="xinxin"><?php $__FOR_START_1005991402__=0;$__FOR_END_1005991402__=$nurseinfo["credit"];for($i=$__FOR_START_1005991402__;$i < $__FOR_END_1005991402__;$i+=1){ ?><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><?php } ?></span><br>联系电话：<?php echo ($nurseinfo["iphone"]); ?><br>联系地址：<?php echo ($nurseinfo["area"]); ?></p>
                    <p class="jxs_hs gray"><?php echo (date("Y-m-d",$nurseinfo["inputtime"])); ?></p>
                    <p class="wmc_an"><a href="/index.php/Mobile/Patient/orderinfo/suborderid/<?php echo ($nurseinfo["orderid"]); ?>/orderid/<?php echo ($nurseinfo["parent_id"]); ?>">去评价</a></p>
                    </div>
                     </li><?php endforeach; endif; ?>
                  </ul>
                  </div>
