...
<div id="box" class="indexBox">
    ...
    <div class="main companyBox">
        <div class="companyBoxIn">
            <?php if(is_array($aboutinfo)): foreach($aboutinfo as $key=>$v): ?><!--    <h4><?php echo ($v["title"]); ?></h4> -->
                <!--<span>时间：2016-03-25 09:50:18  </span>-->
