...
<div id="box" class="indexBox">
        ...
        <div class="main">
            <ul class="pgxq_list">
                ...
                <div class="wmc_list">
                  ...
                  <p class="wmc_wz"><?php echo ($orderinfo["username"]); ?><span class="xinxin"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"><img src="<?php echo (MBIMG_URL); ?>xing.jpg"></span><br>联系电话：<?php echo ($orderinfo["iphone"]); ?><br>联系地址：<?php echo ($orderinfo["area"]); ?></p>
                  <p class="jxs_hs gray"><?php echo (date("Y-m-d",$orderinfo["inputtime"])); ?></p>
                  </div>
                </li>
                 <li>
                 <p class="ywc_hs">客服记录</p>
 ...
 <p class="pgxq_con borTop"><?php echo ($orderinfo["evaluate"]); ?></p>
            ...
            <li><p class="zfan"><a href="">支&nbsp;付</a></p></li>
