...
<div id="box" class="indexBox">
    <header>
        ...
        <div class="main">
            <ul class="caseBox">
                <li class="pgdet">
                   <a href="/index.php/Mobile/Product/detail/pro_id/<?php echo ($orderinfo["pro_id"]); ?>">
                ...
                <li>
                  ...
                  <?php if(!empty($suborderInfo)): ?><p <?php if(($suborderInfo["nurseid"] != '') and ($suborderInfo["status"] == '0')): ?>class="list"<?php endif; if(($suborderInfo["status"] == '1') and ($suborderInfo["is_com"] == '0')): ?>class="list1"<?php endif; if(($suborderInfo["status"] == '2') and ($suborderInfo["is_com"] == '0')): ?>class="list2"<?php endif; if($suborderInfo["is_com"] == 1): ?>class="list3"<?php endif; ?>></p><?php endif; ?>
                  <?php if(empty($suborderInfo)): ?><p></p><?php endif; ?>
                  <ul class="pgdet_list">
                  <li>已下单</li>
                  <li>今日护士</li>
                  <li>上门护理</li>
