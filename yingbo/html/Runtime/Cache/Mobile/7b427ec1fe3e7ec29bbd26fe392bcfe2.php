...
<div id="box" class="indexBox">
 ...
 <head>
    ...
    <title>微信安全支付</title> -->
    <div class="main">
       <span style="float:left;height:2rem;line-height:2rem;margin-left: 0.875rem;width:100%;color: #636363;font-size: 1.2rem;"><b style="color:black">交易类型：</b>账户充值</span>
       ...
       <span style="float:left;height:2rem;line-height:2rem;margin-left: 0.875rem;width:100%;color: #636363;font-size: 1.2rem;"><b style="color:black">充值单号：</b><?php echo ($orderinfo["ordernumber"]); ?></span>
       <span style="float:left;height:2rem;line-height:2rem;margin-left: 0.875rem;width:100%;color: #636363;font-size: 1.2rem;"><b style="color:black">充值金额：</b>￥<?php echo ($orderinfo["ssum"]); ?></span>
    </div>
