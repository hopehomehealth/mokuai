...
<div id="box" class="indexBox">
    <header>
        ...
        <div class="main">
        <form action="/index.php/Mobile/Patient/yuyue" method="post" id="apoint-form">
            <div class="pgTxt">
                <textarea name="casexl" placeholder="描述你的病情"></textarea>
                <div class="btn">
                        <button type="submit" id="apointment">提 交</button>
                </div>
            </div>
		</form>
        </div>
        ...
        $(function(){
            ...
            $("#apointment").click(function(){
                if($("textarea").val() == ''){
                    ...
                    $("textarea").val('请输入病情描述');
                    setTimeout(function(){$("textarea").removeAttr('readonly');$("textarea").css('color','');$("textarea").val('');},1000);
                    return false;
                }
                $.post("/index.php/Mobile/Patient/yuyue",{"casexl":$("textarea").val()},function(data){
                    if(data.error == 1){
