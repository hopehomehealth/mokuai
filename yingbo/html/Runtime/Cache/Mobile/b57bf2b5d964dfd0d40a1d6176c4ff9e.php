...
<div id="box" class="indexBox">
    ...
    <div class="main gyBox">
            ...
            <?php if(is_array($gonginfo)): foreach($gonginfo as $k=>$v): ?><div class="zsBanner" style="padding-bottom: 1rem;">
            <a href="<?php echo U('Gongyi/gongyi_list',array('trailer_id'=>$v['trailer_id']));?>">
