...
<div id="box" class="indexBox">
    ...
    <div class="main detailBox">
        <ul class="teamList">
            <?php if(is_array($teaminfo1)): foreach($teaminfo1 as $key=>$v): ?><li class="borBot">
                    <div class="teamListH">
                        <span class="tx">
                            <img src="<?php echo (MBIMG_URL); ?>teamTu.jpg">
                        </span>
                        <div class="teamListR">
                            <div class="subTit">
                                <span><?php echo ($v["username"]); ?></span>
                                <em><?php echo ($v["school"]); ?></em>
                            </div>
                            <p><?php echo ($v["company"]); ?>专家</p>
                        </div>
                    </div>
                    <!--<p>-->
                        <!--<span>擅长：</span>-->
            ...
            <?php if(is_array($teaminfo2)): foreach($teaminfo2 as $key=>$v): ?><li class="borBot">
                    <div class="teamListH">
                        <span class="tx">
                            <img src="<?php echo (MBIMG_URL); ?>teamTu.jpg">
                        </span>
                        <div class="teamListR">
                            <div class="subTit">
                                <span><?php echo ($v["username"]); ?></span>
                                <em><?php echo ($v["departments"]); ?></em>
                                <em><?php echo ($v["type"]); ?></em>
                            </div>
                            <p>毕业于<?php echo ($v["school"]); ?></p>
                            <p><?php echo ($v["company"]); ?>专家</p>
                        </div>
                    </div>
                    <p>
