...
<div id="box" class="indexBox">
    <header>
        ...
        <div class="main">
        <form action="/index.php/Mobile/Nurse/xinxi" method="post" enctype="multipart/form-data">
            <ul class="userList zrXx">
                <li class="borBot">
                    <a href="#">
                        姓名  
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="username" value="<?php echo ($info["username"]); ?>"></span>                      
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                ...
                <li class="borBot">
                    <a href="#">
                        毕业学校                        
                         <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="school" value="<?php echo ($info["school"]); ?>"></span>    
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                ...
                <li class="borBot">
                   <a href="#">
                       全职or兼职  
                       <span class="xinx"><input type="text" style="color:#636363;font-size:100%;text-align:right" name="type" value="<?php echo ($info["type"]); ?>"></span>                      
                       <i class="moreUser"></i>
                   </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        工作单位   
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="company" value="<?php echo ($info["company"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        所属科室   
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="departments" value="<?php echo ($info["departments"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        护士证号   
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="certificate" value="<?php echo ($info["certificate"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                 <li class="borBot">
                    <a href="#">
                        护士级别                        
                         <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="level" value="<?php echo ($info["level"]); ?>"></span>    
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        护士工龄
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="standing" value="<?php echo ($info["standing"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        职称级别   
                        <span><input type="text" style="color:#636363;font-size:100%;text-align:right" name="grade" value="<?php echo ($info["grade"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        详细居住地址  
                        <span><input style="color:#636363;font-size:100%;text-align:right" type="text" name="area" value="<?php echo ($info["area"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
                <li class="borBot">
                    <a href="#">
                        工作经历   
                        <span><input style="color:#636363;font-size:100%;text-align:right" type="text" name="experience" value="<?php echo ($info["experience"]); ?>"></span>                        
                        <i class="moreUser"></i>
                    </a>
                </li>
            </ul>
