...
<form action="/index.php/Home/Goods/showlist/cat_id/18?search_name=%E6%89%8B%E6%9C%BA" name="serarch" method="get" class="fl">
...
<?php if(empty($_GET['shai_price'])): ?><dl>
	<dt>价格：</dt>
	<dd class="cur"><a href="">不限</a></dd>
	<?php if(is_array($duan_price)): foreach($duan_price as $key=>$v): ?><dd><a href="/index.php/Home/Goods/showlist/cat_id/18?search_name=%E6%89%8B%E6%9C%BA/shai_price/<?php echo ($v); ?>" target="_self"><?php echo ($v); ?></a></dd><?php endforeach; endif; ?>
</dl><?php endif; ?>
...
<?php if(!in_array(($v['attr_id']), is_array($shai_attrids)?$shai_attrids:explode(',',$shai_attrids))): ?><dl>
	...
	<dd class="cur"><a href="">不限</a></dd>
	<?php if(is_array($v["attrval"])): foreach($v["attrval"] as $key=>$vv): ?><dd><a href="/index.php/Home/Goods/showlist/cat_id/18?search_name=%E6%89%8B%E6%9C%BA/attrid_<?php echo ($v["attr_id"]); ?>/<?php echo ($vv); ?>"><?php echo ($vv); ?></a></dd><?php endforeach; endif; ?>
</dl><?php endif; endforeach; endif; ?>
