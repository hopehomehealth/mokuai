...
{
    childWindow = window.open("<?php echo C('SITE_URL');?>/Common/Plugin/qq/oauth/qq_login.php","TencentLogin","width=450,height=320,menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
} 
</script>
