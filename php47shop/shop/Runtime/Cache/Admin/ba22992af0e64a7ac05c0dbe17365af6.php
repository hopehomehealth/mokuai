  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">分类id</span></div></td>
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">分类名称</span></div></td>
        <td width="7%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">分类父级</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <div align="center"><span class="STYLE19"><?php echo ($v["cat_id"]); ?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="left"><?php echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$v['cat_level']); echo ($v["cat_name"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["cat_pid"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["cat_path"]); ?></div></td>        
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["cat_level"]); ?></div></td>
