  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">角色名称</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限ids</span></div></td>
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限ac</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <div align="center"><span class="STYLE19"><?php echo ($v["role_id"]); ?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["role_name"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["role_auth_ids"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["role_auth_ac"]); ?></div></td>

        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="/index.php/Admin/Role/distribute/role_id/<?php echo ($v["role_id"]); ?>">分配权限</a> |
