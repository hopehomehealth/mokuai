  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="7%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">属性数量</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <div align="center"><span class="STYLE19"><?php echo ($v["type_id"]); ?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="left"><?php echo ($v["type_name"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
        <div align="center"><?php echo ($v["attr_num"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        
        <a class='STYLE21' href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>">属性列表</a>
