            ...
            <div class="flowBox">
                ...
                <form id="formCart">
                    <table cellpadding="5" cellspacing="1">
                        <tbody>
                            ...
                            <?php 
                                ...
                                foreach($cart_info as $_k => $_v){ 
                            ?>
                            <tr id="goods<?php echo $_v['goods_id']; ?>">
                                <td><?php echo $i++; ?></td>
                                <td align="center">
                                    <?php echo $_v['goods_name']; ?>
                                </td>
                                <td align="right">￥<?php echo $_v['goods_price']; ?>元</td>
                                <td align="right">￥<?php echo $_v['goods_price']; ?>元</td>
                                <td align="right">

                            <img src="./images/bag_close.gif" width="9" height="9" onclick="change_reduce(<?php echo $_v['goods_id']; ?>)" class="number_change"/>
                            <input name="goods_buy_number" type="text" class="num" id="goods_buy_number<?php echo $_v['goods_id']; ?>" value="<?php echo $_v['goods_buy_number'] ?>" size="8" onchange="change_number(<?php echo $_v['goods_id']; ?>)"/>
                            <img src="./images/bag_open.gif" width="9" height="9" onclick="change_add(<?php echo $_v['goods_id']; ?>)" class="number_change"/>


                                </td>
                                <td align="right">￥<span id="goods_total_price<?php echo $_v['goods_id']; ?>"><?php echo $_v['goods_total_price']; ?></span>元</td>
                                <td align="center">
                                    <a href="javascript:;" class="f6"  onclick="cart_del(<?php echo $_v['goods_id']; ?>)">删除</a>
                                </td>
                            </tr>
                            <?php } }?>
                        </tbody></table>
                    <table cellpadding="5" cellspacing="1">
                        <tbody><tr>
                                <td>
                                    购物金额小计 ￥<span id="total_price"><?php echo $total; ?></span>元</td>
                                <td align="right">
                                    <input value="清空购物车" class="bnt_blue_1"  type="button" onclick="cart_delall()" />
                                </td>
                            </tr>
                        </tbody></table>
                ...
                <table cellpadding="5" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td><a href="./index.php"><img src="./images/continue.gif" alt="continue" /></a></td>
